...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 549.0, 12.0, 509.0, 7.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 549.0, 18.7855224609375, 280.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 107.0, 410.0, 77.0 ],
					"text" : "attributes:\n\n@replace (anything); will replace any non-hexadecimals, i.e. wildcards representing specific data, by the given argument. 0 = no replacement and unaltered output"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "convert hexadecimal symbols to decimal integers",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 997.5, 546.0, 57.0, 20.0 ],
					"text" : "zl slice 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 939.0, 272.0, 24.0, 20.0 ],
					"text" : "t 1",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 939.0, 231.0, 66.5, 20.0 ],
					"text" : "sel 0 bang",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 986.5, 272.0, 30.0, 20.0 ],
					"text" : "t 2 l",
					"textcolor" : [ 0.921568989753723, 0.917647004127502, 0.933332979679108, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 658.5, 492.0, 100.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 830.0, 589.0, 187.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 708.0, 445.0, 30.0, 20.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 549.0, 132.0, 112.0, 20.0 ],
					"text" : "route replace done",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 592.25, 63.0, 139.0, 20.0 ],
					"text" : "patcherargs @replace 0",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 886.0, 231.0, 39.0, 20.0 ],
					"text" : "zl len",
					"textcolor" : [ 0.921568989753723, 0.717647016048431, 0.117646999657154, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 642.0, 276.0, 116.0, 20.0 ],
					"text" : "t l l",
					"textcolor" : [ 0.921568989753723, 0.917647004127502, 0.933332979679108, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 642.0, 231.0, 27.0, 20.0 ],
					"text" : "iter",
					"textcolor" : [ 0.921568989753723, 0.917647004127502, 0.933332979679108, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.290196, 0.309804, 0.301961, 1.0 ],
					"color" : [ 0.152213, 0.521496, 0.588255, 1.0 ],
					"id" : "obj-26",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 658.5, 403.0, 68.5, 20.0 ],
					"text" : "b 2",
					"textcolor" : [ 0.921568989753723, 0.917647004127502, 0.933332979679108, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 691.5, 656.0, 213.5, 20.0 ],
					"text" : "zl group",
					"textcolor" : [ 0.921568989753723, 0.717647016048431, 0.117646999657154, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "" ],
					"patching_rect" : [ 642.0, 189.0, 263.0, 20.0 ],
					"text" : "t l 1 l",
					"textcolor" : [ 0.921568989753723, 0.917647004127502, 0.933332979679108, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 764.0, 546.0, 85.0, 20.0 ],
					"text" : "gate 2",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 756.25, 63.0, 161.0, 20.0 ],
					"text" : "F0 0 1 61 4 15 LL HH CH F7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 642.0, 320.0, 79.0, 20.0 ],
					"text" : "sprintf 0x%s",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 642.0, 363.0, 85.0, 20.0 ],
					"text" : "regexp (.+x.+)",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 691.5, 703.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 549.0, 63.0, 30.0, 30.0 ]
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 701.0, 611.0, 701.0, 611.0 ],
					"source" : [ "obj-1", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 765.75, 107.0, 558.5, 107.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"midpoints" : [ 773.5, 611.5, 701.0, 611.5 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 558.5, 171.0, 948.5, 171.0 ],
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-27", 0 ],
					"midpoints" : [ 717.5, 477.0, 773.5, 477.0 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"midpoints" : [ 839.5, 633.0, 701.0, 633.0 ],
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-31", 0 ],
					"midpoints" : [ 721.75, 107.0, 558.5, 107.0 ],
					"source" : [ "obj-39", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 668.0, 527.5, 839.5, 527.5 ],
					"source" : [ "obj-41", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 1007.0, 486.5, 1007.0, 486.5 ],
					"source" : [ "obj-42", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 996.0, 434.5, 728.5, 434.5 ],
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-33", 1 ],
					"midpoints" : [ 948.5, 434.5, 728.5, 434.5 ],
					"source" : [ "obj-44", 0 ]
				}
