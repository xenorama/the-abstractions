...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 551.0, 553.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 429.0, 364.0, 127.0, 32.0 ],
					"text" : "loadmess ignoreclick 1 @defer 1",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 429.0, 526.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 453.0, 473.0, 60.0, 20.0 ],
					"text" : "dspstate~",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 920.190537214279175, 51.2144775390625, 150.0, 59.0 ],
					"text" : "messages to this object, the console object or a bool (toggle) tode-/activate sounds"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 914.595268607139587, 898.142925977706909, 52.0, 20.0 ],
					"text" : "clip 0. 1.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 945.0, 735.095235288143158, 29.5, 20.0 ],
					"text" : "==",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 585.0, 474.0, 51.0, 20.0 ],
					"text" : "gate 1 1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 617.0, 400.0, 141.0, 20.0 ],
					"text" : "r oni.console.sound_single",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 945.0, 770.0, 143.0, 20.0 ],
					"text" : "s oni.console.sound_single",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 585.0, 320.0, 29.5, 20.0 ],
					"text" : "*",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 585.0, 273.0, 110.0, 20.0 ],
					"text" : "pak 1 #1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1025.095268607139587, 224.5, 19.0, 20.0 ],
					"text" : "t l",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 974.595268607139587, 159.0, 69.5, 20.0 ],
					"text" : "typeroute~",
...
, 			{
				"box" : 				{
					"comment" : "",
					"hint" : "anything; send a bool (0/1) to de-/activate playback of sound or send applicable atributes to the [console] object. @showonlyerrors is active by default",
					"id" : "obj-1",
					"index" : 1,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 885.595268607139587, 69.2144775390625, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 433.0, 997.0, 57.0, 20.0 ],
					"text" : "dac~ 1 2",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 773.0, 474.0, 29.5, 20.0 ],
					"text" : "+ 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 585.0, 364.0, 502.095268607139587, 20.0 ],
					"text" : "switch 2 1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 612.0, 231.0, 22.0, 20.0 ],
					"text" : "t 2",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 585.0, 231.0, 22.0, 20.0 ],
					"text" : "t 1",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 585.0, 195.0, 46.0, 20.0 ],
					"text" : "sel max",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 1025.095268607139587, 273.0, 105.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 433.0, 940.0, 500.595268607139587, 20.0 ],
					"text" : "*~ 1.",
					"textcolor" : [ 0.275282, 0.960371, 0.999055, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 852.595268607139587, 126.0, 141.0, 20.0 ],
					"text" : "route done target vol qlim",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 705.595268607139587, 91.2144775390625, 166.0, 20.0 ],
					"text" : "patcherargs @showonlyerrors 1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 585.0, 553.0, 378.095268607139587, 20.0 ],
					"text" : "qlim 250",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 585.0, 400.0, 22.0, 20.0 ],
					"text" : "t b",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"color" : [ 0.888743, 0.0, 0.022614, 1.0 ],
					"id" : "obj-106",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 826.547634303569794, 273.0, 50.0, 20.0 ],
					"text" : "error #1",
					"textcolor" : [ 0.960784, 0.827451, 0.156863, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 433.0, 898.142925977706909, 43.0, 20.0 ],
					"text" : "*~ 0.3",
					"textcolor" : [ 0.275282, 0.960371, 0.999055, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 722.095268607139587, 810.071433514356613, 43.0, 20.0 ],
					"text" : "*~ 0.8",
					"textcolor" : [ 0.275282, 0.960371, 0.999055, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 585.0, 513.0, 207.0, 20.0 ],
					"text" : "del 251",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 722.095268607139587, 735.095235288143158, 112.0, 20.0 ],
					"text" : "adsr~ 6 10 0.32 30",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 722.095268607139587, 770.0, 139.5, 20.0 ],
					"text" : "*~",
					"textcolor" : [ 0.275282, 0.960371, 0.999055, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 842.595268607139587, 600.5, 73.0, 44.0 ],
					"text" : "cycle~ @frequency 190.1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 585.0, 642.0, 55.0, 20.0 ],
					"text" : "pipe 100",
					"textcolor" : [ 0.717647, 0.141176, 0.239216, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 585.0, 600.5, 156.0, 20.0 ],
					"text" : "t 0 1",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 433.0, 770.0, 170.5, 20.0 ],
					"text" : "*~",
					"textcolor" : [ 0.275282, 0.960371, 0.999055, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "signal", "", "" ],
					"patching_rect" : [ 585.0, 735.095235288143158, 105.0, 20.0 ],
					"text" : "adsr~ 6 10 0.4 60",
					"textcolor" : [ 0.178066, 0.762973, 0.488151, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 433.0, 642.0, 78.0, 44.0 ],
					"text" : "cycle~ @frequency 318.2",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 426.0, 45.0, 410.0, 20.0 ],
					"text" : "…"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 19.0, 408.0, 38.0 ],
					"text" : "oni.console.sound"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 426.0, 6.0, 792.0, 11.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 426.0, 19.0, 792.0, 24.0 ],
					"text" : "info",
					"varname" : "title[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 150.2144775390625, 414.0, 161.0 ],
					"text" : "args:\n\n1 (bool) = active; play sound on error messages in max console\n\n@target (symbol) = \"max\" reports all errors in max console. otherwise can be treated as a [console] object with all its arguments and attributes; default: max\n\n@vol (float) = volume of sound (clipped between 0. -1.); default = 1.\n\n@qlim (int) = interval between sonic reports; default = 250"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 6.2144775390625, 408.0, 11.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 63.2144775390625, 410.0, 79.0 ],
					"text" : "imitate and play the macOS «Funk.aiff» sound on receiving errors in the max console\n\nto be used as abstraction"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 892.595268607139587, 162.5, 594.5, 162.5 ],
					"source" : [ "obj-156", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 953.595268607139587, 338.5, 782.5, 338.5 ],
					"order" : 1,
					"source" : [ "obj-156", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1004.295268607139633, 225.5, 836.047634303569794, 225.5 ],
					"order" : 0,
					"source" : [ "obj-5", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 1 ],
					"midpoints" : [ 1004.295268607139633, 225.5, 685.5, 225.5 ],
					"order" : 1,
					"source" : [ "obj-5", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-93", 0 ],
					"midpoints" : [ 731.595268607139587, 863.607179746031761, 442.5, 863.607179746031761 ],
					"source" : [ "obj-82", 0 ]
				}
