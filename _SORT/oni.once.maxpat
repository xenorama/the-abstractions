...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"comment" : "",
					"hint" : "information not passed",
					"id" : "obj-1",
					"index" : 1,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 568.0, 322.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 459.0, 66.0, 94.0, 18.0 ],
					"text" : "criteria to be met"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 657.0, 66.0, 150.0, 18.0 ],
					"text" : "information to be passed"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 568.0, 110.0, 52.0, 20.0 ],
					"text" : "sel #1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 568.0, 164.0, 22.0, 20.0 ],
					"text" : "t 2",
...
, 			{
				"box" : 				{
					"comment" : "",
					"hint" : "passed information",
					"id" : "obj-13",
					"index" : 2,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 618.0, 322.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 618.0, 260.0, 29.5, 20.0 ],
					"text" : "t l 1",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 568.0, 221.0, 69.0, 20.0 ],
					"text" : "gate 2 1",
...
, 			{
				"box" : 				{
					"comment" : "",
					"hint" : "<anything>; allows pass through of information in right inlet",
					"id" : "obj-10",
					"index" : 1,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 568.0, 60.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					"comment" : "",
					"hint" : "<anything>; information to be passed through once",
					"id" : "obj-9",
					"index" : 2,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 618.0, 60.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 434.0, 4.7855224609375, 410.0, 8.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 434.0, 14.7855224609375, 280.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 103.0, 410.0, 48.0 ],
					"text" : "args:\n\n#1 (anything); single element to watch out for"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 59.0, 410.0, 42.0 ],
					"text" : "pass information once when certain criteria is received in inlet 1",
					"varname" : "title"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 638.0, 292.0, 560.75, 292.0, 560.75, 210.0, 577.5, 210.0 ],
					"source" : [ "obj-12", 1 ]
				}
