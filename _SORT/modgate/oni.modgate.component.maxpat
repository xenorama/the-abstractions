...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 42.0, 288.5, 68.0, 44.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 42.0, 206.5, 155.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 42.0, 159.0, 67.0, 20.0 ],
					"text" : "patcherargs",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 42.0, 576.60723876953125, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "clear" ],
					"patching_rect" : [ 117.0, 288.0, 124.0, 20.0 ],
					"text" : "t l clear",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.0, 360.0, 68.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 42.0, 545.2144775390625, 142.0, 20.0 ],
					"text" : "i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 117.0, 360.0, 57.0, 20.0 ],
					"text" : "append 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 117.0, 322.0, 25.0, 20.0 ],
					"text" : "iter",
					"textcolor" : [ 0.921568989753723, 0.917647004127502, 0.933332979679108, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 42.0, 254.0, 94.0, 20.0 ],
					"text" : "zl slice 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 117.0, 495.2144775390625, 50.5, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 42.0, 442.0, 142.0, 20.0 ],
					"text" : "t b i 0",
					"textcolor" : [ 0.921568989753723, 0.917647004127502, 0.933332979679108, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.0, 400.0, 44.0, 20.0 ],
					"text" : "receive",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "oni.modgate_mod.component",
					"varname" : "title[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 106.7855224609375, 509.0, 7.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 115.7855224609375, 280.0, 24.0 ],
					"text" : "fill coll with arguments",
					"varname" : "title[1]"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "abstraction to monitor numeric states of receive ports",
					"varname" : "title"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 113.0, 478.10723876953125, 126.5, 478.10723876953125 ],
					"source" : [ "obj-40", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 51.5, 389.5, 51.5, 389.5 ],
					"source" : [ "obj-58", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-42", 0 ],
					"midpoints" : [ 231.5, 477.10723876953125, 126.5, 477.10723876953125 ],
					"source" : [ "obj-63", 1 ]
				}
