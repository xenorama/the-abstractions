...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 901.0, 140.0, 95.0, 20.0 ],
					"text" : "route purge done",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1095.5, 267.0, 51.0, 20.0 ],
					"text" : "gate 1 1",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 959.333333333333258, 491.0, 116.0, 18.0 ],
					"text" : "output if not matched"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1229.333333333333258, 491.0, 78.0, 18.0 ],
					"text" : "list if matched"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 544.0, 47.0, 51.0, 18.0 ],
					"text" : "input list"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 721.0, 42.0, 73.0, 18.0 ],
					"text" : "list argument"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 228.0, 405.0, 5.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 234.7855224609375, 280.0, 24.0 ],
					"text" : "list input",
					"varname" : "title[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 104.7855224609375, 410.0, 91.0 ],
					"text" : "args:\n\nlist (anything); list which must not be passed through\n\n@purge (bool) = will search only in current list and ignores entries from previous list (default: 1)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 63.0, 410.0, 24.0 ],
					"text" : "define a list which must not be matched to be output",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					"comment" : "anything; list which must not be matched to be output",
					"id" : "obj-38",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 687.0, 36.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "anything; list if it matches arguments",
					"id" : "obj-24",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1194.333333333333258, 485.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "anything; list if it does not match arguments",
					"id" : "obj-23",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1077.333333333333258, 485.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1095.5, 383.0, 24.0, 20.0 ],
					"text" : "t 2",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1077.333333333333258, 437.0, 136.0, 20.0 ],
					"text" : "gate 2",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 977.0, 204.0, 169.5, 20.0 ],
					"text" : "t l l 1 clear",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"comment" : "list; list which must not match arguments to be output from outlet #1",
					"id" : "obj-11",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.0, 41.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 800.0, 140.0, 74.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 800.0, 41.0, 120.0, 20.0 ],
					"text" : "patcherargs @purge 1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1095.5, 342.0, 43.0, 20.0 ],
					"text" : "match",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 809.5, 326.5, 1105.0, 326.5 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 519.5, 98.0, 910.5, 98.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 986.5, 309.5, 1203.833333333333258, 309.5 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 1036.666666666666742, 326.5, 1105.0, 326.5 ],
					"source" : [ "obj-12", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"midpoints" : [ 1105.0, 420.5, 1086.833333333333258, 420.5 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 696.5, 129.5, 809.5, 129.5 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 910.5, 181.0, 1105.0, 181.0 ],
					"source" : [ "obj-5", 0 ]
				}
