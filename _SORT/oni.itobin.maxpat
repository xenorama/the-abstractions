...
,
		"classnamespace" : "box",
		"rect" : [ -1472.0, 195.0, 1006.0, 761.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 708.0, 256.7855224609375, 100.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 708.0, 578.0, 34.0, 20.0 ],
					"text" : "zl rev",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 545.0, 516.7855224609375, 167.0, 20.0 ],
					"text" : "gate 2 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 767.166666666666629, 203.7855224609375, 29.5, 20.0 ],
					"text" : "+ 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 665.0, 657.7855224609375, 304.0, 20.0 ],
					"text" : "0 0 0 0 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 579.0, 656.7855224609375, 75.0, 18.0 ],
					"text" : "binary output"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 734.5, 66.0, 63.0, 18.0 ],
					"text" : "decimal int"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 907.0, 129.7855224609375, 90.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 18.7855224609375, 408.0, 38.0 ],
					"text" : "oni.itobin",
					"varname" : "title[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 107.0, 410.0, 133.0 ],
					"text" : "args:\n\nint; number of expected output bytes; default = 7\n@rev (bool) = reverse the list on output (default: 0)\n\nattributes:\n\n@bytes (int) = number of expected output bytes\n@rev (bool) = reverse the list on output (default: 0)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 12.0, 408.0, 5.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 63.0, 410.0, 24.0 ],
					"text" : "translate integers to binary lists",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 508.0, 337.7855224609375, 339.0, 20.0 ],
					"text" : "gate 1 1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 659.5, 256.7855224609375, 28.0, 20.0 ],
					"text" : "abs",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 638.5, 203.7855224609375, 29.5, 20.0 ],
					"text" : "i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 638.5, 291.7855224609375, 40.0, 20.0 ],
					"text" : "clip 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 869.0, 123.7855224609375, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 736.5, 128.7855224609375, 111.0, 20.0 ],
					"text" : "route bytes rev done",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 638.5, 90.7855224609375, 117.0, 20.0 ],
					"text" : "patcherargs 7 @rev 0",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 638.5, 419.7855224609375, 74.0, 20.0 ],
					"text" : "prepend size"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 508.0, 383.7855224609375, 72.0, 57.0 ],
					"text" : "flagmode 1, set $1, flagmode 0, bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 463.0, 11.7855224609375, 509.0, 8.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 463.0, 18.7855224609375, 173.0, 24.0 ],
					"text" : "decimal input"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 545.0, 650.7855224609375, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 508.0, 516.7855224609375, 18.0, 114.0 ],
					"size" : 7,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 800.5, 60.0, 30.0, 30.0 ]
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 776.666666666666629, 485.7855224609375, 554.5, 485.7855224609375 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 554.5, 551.7855224609375, 959.5, 551.7855224609375 ],
					"order" : 0,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-43", 1 ],
					"midpoints" : [ 717.5, 624.39276123046875, 959.5, 624.39276123046875 ],
					"order" : 0,
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 717.5, 623.89276123046875, 554.5, 623.89276123046875 ],
					"order" : 1,
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 648.0, 462.7855224609375, 517.5, 462.7855224609375 ],
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 1.0, 0.984314, 0.870588, 0.318974579510703 ],
					"destination" : [ "obj-2", 1 ],
					"midpoints" : [ 517.5, 506.2855224609375, 702.5, 506.2855224609375 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 648.0, 324.2855224609375, 517.5, 324.2855224609375 ],
					"order" : 1,
					"source" : [ "obj-79", 0 ]
				}
