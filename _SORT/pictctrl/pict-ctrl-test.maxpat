...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"id" : "obj-20",
					"maxclass" : "pictctrl",
					"name" : "turntable_power-button_ctrl-02.png",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1240.0, 710.0, 107.0, 105.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1103.0, 704.0, 111.0, 111.0 ],
					"range" : 10,
					"trackvertical" : 1,
					"varname" : "pictctrl[4]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 1503.0, 51.0, 127.0, 20.0 ],
					"restore" : 					{
						"button" : [ 0.0 ],
						"button[3]" : [ 0.0 ],
						"button[4]" : [ 0.0 ],
						...
						"textbutton" : [ -1 ],
						"textbutton[1]" : [ -1 ],
						"textedit" : [ "turntable_power-button_ctrl.png" ],
						"toggle" : [ 0 ],
						"toggle[1]" : [ 0 ],
						"toggle[2]" : [ 0 ],
						"toggle[3]" : [ 0 ]
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 942.0, 700.0, 121.0, 121.0 ],
					"range" : 10,
					"trackvertical" : 1,
					"varname" : "pictctrl[3]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1313.0, 237.0, 150.0, 18.0 ],
					"text" : "anchor y (0.-1.)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1313.0, 200.0, 150.0, 18.0 ],
					"text" : "anchor x (0.-1.)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1257.5, 237.0, 50.0, 20.0 ],
					"varname" : "number[5]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1257.5, 200.0, 50.0, 20.0 ],
					"varname" : "number[4]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 830.0, 395.0, 24.0, 24.0 ],
					"varname" : "button[4]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 595.0, 305.0, 24.0, 24.0 ],
					"varname" : "button[3]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 667.5, 335.0, 83.0, 39.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 933.0, 478.0, 150.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1309.5, 362.0, 178.0, 18.0 ],
					"text" : "display preview in jit.pwindow only"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1313.0, 267.0, 177.0, 18.0 ],
					"text" : "alpha (1 = opaque, 0 = black bg)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1313.0, 163.7855224609375, 150.0, 18.0 ],
					"text" : "picture name (.png)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1313.0, 121.0, 150.0, 18.0 ],
					"text" : "degrees offset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1313.0, 87.0, 150.0, 18.0 ],
					"text" : "degrees covered"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1313.0, 52.0, 150.0, 18.0 ],
					"text" : "size (dial steps 0-[n-1])"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1313.0, 17.0, 150.0, 18.0 ],
					"text" : "dim (x/y)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1039.0, 261.5, 53.0, 20.0 ],
					"text" : "tosymbol",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1039.0, 163.7855224609375, 268.5, 23.0 ],
					"text" : "turntable_power-button_ctrl.png",
					"varname" : "textedit"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1039.0, 214.0, 56.0, 20.0 ],
					"text" : "route text",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1283.5, 267.0, 24.0, 24.0 ],
					"varname" : "toggle[3]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1257.5, 52.0, 50.0, 20.0 ],
					"varname" : "number[3]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1257.5, 17.0, 50.0, 20.0 ],
					"varname" : "number[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 785.0, 307.0, 463.5, 20.0 ],
					"text" : "pak 200 50 360. 0. <filename>.png 0.5 0.5 0",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 635.0, 809.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 635.0, 761.0, 24.0, 24.0 ],
					"varname" : "toggle[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 635.0, 724.174757361412048, 35.0, 20.0 ],
					"text" : "> 45",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 634.0, 598.0, 100.0, 99.0 ],
					"range" : 10,
					"trackvertical" : 1,
					"varname" : "pictctrl[2]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 2126.0, 395.0, 24.0, 24.0 ],
					"varname" : "toggle[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 2126.0, 358.174757361412048, 35.0, 20.0 ],
					"text" : "> 45",
					"textcolor" : [ 0.8, 0.839216, 0.709804, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1283.5, 359.0, 24.0, 24.0 ],
					"varname" : "toggle"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1283.5, 423.0, 88.0, 20.0 ],
					"text" : "preview-only $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1257.5, 121.0, 50.0, 20.0 ],
					"varname" : "number[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2136.5, 49.0, 30.0, 20.0 ],
					"text" : "50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2126.0, 118.89276123046875, 40.0, 20.0 ],
					"text" : "join 3",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2304.0, 371.5, 532.0, 32.0 ],
					"text" : "\"Macintosh HD:/Users/Oni/Documents/Max 8/Xenorama/XEN_Control-Setups/20-05_BHS_Bharatiya-Sangeet/bhs_pictures/turntable-ctrl-03.png\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 2335.0, 285.0, 33.0, 42.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2126.0, 162.7855224609375, 500.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1257.5, 87.0, 50.0, 20.0 ],
					"varname" : "number"
				}
...
, 			{
				"box" : 				{
					...
					"mode" : 2,
					"multiplier" : 1,
					"name" : "turntable-ctrl-03.png",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 2126.0, 243.0, 91.0, 91.0 ],
					"range" : 50,
					"trackvertical" : 1,
					"varname" : "pictctrl[1]"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 900.0, 549.0, 640.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 635.0, 598.0, 100.0, 99.0 ],
					"range" : 50,
					"trackvertical" : 1,
					"varname" : "pictctrl"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 634.0, 131.0, 24.0, 24.0 ],
					"varname" : "button"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 634.0, 193.0, 100.0, 100.0 ],
					"pic" : "turntable-power-button_center.png"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 785.0, 346.0, 429.0, 20.0 ],
					"text" : "dim $1, size $2, degrees $3, offset $4, filename $5, ancx $6, ancy $7, alpha $8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "jit_matrix" ],
					"patching_rect" : [ 634.0, 472.0, 285.0, 32.0 ],
					"text" : "oni.pictctrl @preview-only 1",
					"textcolor" : [ 0.932247996330261, 0.523831248283386, 0.769339203834534, 1.0 ],
					"varname" : "oni.pictctrl"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1267.0, 148.25, 985.0, 148.25 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1267.0, 44.25, 794.5, 44.25 ],
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1267.0, 77.75, 858.0, 77.75 ],
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1293.0, 299.5, 1239.0, 299.5 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1048.5, 214.89276123046875, 1048.5, 214.89276123046875 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1267.0, 111.25, 921.5, 111.25 ],
					"source" : [ "obj-59", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1267.0, 228.5, 1112.0, 228.5 ],
					"source" : [ "obj-82", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1267.0, 282.5, 1175.5, 282.5 ],
					"source" : [ "obj-83", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../../XEN_Miscellaneous/COL_Colour-Dict",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "oni.pictctrl.maxpat",
...
, 			{
				"name" : "turntable_power-button_ctrl.png",
				"bootpath" : "~/Documents/Max 8/Xenorama/XEN_Control-Setups/20-05_BHS_Bharatiya-Sangeet/bhs_pictures",
				"patcherrelativepath" : ".",
				"type" : "PNG",
				"implicit" : 1
			}
, 			{
				"name" : "oni.print.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/ONI_custom-abstractions",
				"patcherrelativepath" : "../../../../Packages/ONI_custom-abstractions",
				"type" : "JSON",
				"implicit" : 1
...
, 			{
				...
				"bootpath" : "~/Documents/Max 8 Projects/20-06_HIF_High-Fidelity/High Fidelity/media",
				"patcherrelativepath" : "../../../../../Max 8 Projects/20-06_HIF_High-Fidelity/High Fidelity/media",
				"type" : "PNG",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "turntable-power-button_center.png",
				"bootpath" : "~/Documents/Max 8/Xenorama/XEN_Control-Setups/20-05_BHS_Bharatiya-Sangeet/bhs_pictures",
				"patcherrelativepath" : ".",
				"type" : "PNG",
				"implicit" : 1
