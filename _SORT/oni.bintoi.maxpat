...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 679.0, 513.7855224609375, 215.5, 20.0 ],
					"text" : "t i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 631.0, 474.0, 39.0, 44.0 ],
					"text" : "zl 31 slice 31",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 972.0, 619.39276123046875, 29.5, 20.0 ],
					"text" : "31"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 934.0, 586.7855224609375, 57.0, 20.0 ],
					"text" : "split 1 31",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 972.0, 652.0, 79.0, 20.0 ],
					"text" : "t i b",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1032.0, 725.7855224609375, 57.0, 20.0 ],
					"text" : "onebang",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1032.0, 762.571044921875, 240.0, 20.0 ],
					"text" : "maximum of 31 bytes allowed. input truncated"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1032.0, 795.7855224609375, 80.0, 20.0 ],
					"text" : "print oni.bintoi",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 934.0, 549.7855224609375, 155.0, 20.0 ],
					"text" : "t i b",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 663.0, 381.0, 34.0, 20.0 ],
					"text" : "zl rev"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 631.0, 348.0, 51.0, 20.0 ],
					"text" : "gate 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 631.0, 318.0, 29.5, 20.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 679.0, 669.0, 98.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 679.0, 622.7855224609375, 67.0, 20.0 ],
					"text" : "zl 31 reg",
					"textcolor" : [ 0.921569, 0.717647, 0.117647, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 679.0, 587.7855224609375, 22.0, 20.0 ],
					"text" : "t b",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 679.0, 549.7855224609375, 45.0, 20.0 ],
					"text" : "change",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 679.0, 474.0, 52.0, 20.0 ],
					"text" : "zl 31 len",
					"textcolor" : [ 0.921569, 0.717647, 0.117647, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 631.0, 429.7855224609375, 115.0, 20.0 ],
					"text" : "t l l l",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 665.0, 735.7855224609375, 188.5, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 699.0, 782.0, 83.0, 18.0 ],
					"text" : "decimal output"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 586.0, 97.7855224609375, 63.0, 18.0 ],
					"text" : "binary list"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1135.0, 65.0, 90.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 107.0, 410.0, 105.0 ],
					"text" : "args:\n\nint; number of expected input bytes; default = 7\n\nattributes:\n\n@bytes = number of expected input bytes"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "translate binary lists to integers",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 934.0, 513.7855224609375, 28.0, 20.0 ],
					"text" : "abs",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 787.5, 587.7855224609375, 29.5, 20.0 ],
					"text" : "i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 787.5, 622.7855224609375, 54.0, 20.0 ],
					"text" : "clip 1 63",
					"textcolor" : [ 0.207843, 0.243137, 0.392157, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1097.0, 59.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 796.5, 148.2855224609375, 143.0, 20.0 ],
					"text" : "route bytes rev adapt done",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 695.5, 96.7855224609375, 120.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 787.5, 668.7855224609375, 74.0, 20.0 ],
					"text" : "prepend size"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 665.0, 776.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 631.0, 735.7855224609375, 18.0, 498.0 ],
					"size" : 31,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 652.0, 91.7855224609375, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 688.5, 711.89276123046875, 640.5, 711.89276123046875 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-42", 0 ],
					"midpoints" : [ 797.0, 711.7855224609375, 640.5, 711.7855224609375 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 1.0, 0.984314, 0.870588, 0.270498853211009 ],
					"destination" : [ "obj-53", 0 ],
					"midpoints" : [ 640.5, 725.2855224609375, 674.5, 725.2855224609375 ],
					"source" : [ "obj-42", 0 ]
				}
