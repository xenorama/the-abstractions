...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1161.0, 216.0, 66.0, 20.0 ],
					"text" : "route mode"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 751.0, 87.0, 29.5, 22.0 ],
									"text" : "+ 1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 784.0, 324.0, 44.0, 22.0 ],
									"text" : "sel 1 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 784.0, 176.0, 29.5, 22.0 ],
									"text" : "!= 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 751.0, 126.0, 52.0, 22.0 ],
									"text" : "gate 2 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 50.0, 324.0, 427.0, 20.0 ],
									"text" : "routepass #1 #2",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 254.0, 404.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 890.0, 307.0, 223.0, 32.0 ],
...
,
					"text" : "p mode (0 = expects defined ON velocity\\; 1 = anything other than zero)",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 302.7855224609375, 410.0, 63.0 ],
					"text" : "output to DAW:\n\n64 = toggle on/off\n0 = ignored"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 122.0, 410.0, 105.0 ],
					"text" : "args:\n\nint 1; expected and output ON velocity (default = 64)\nint 2; expected and output OFF velocity (default = 0)\nint 3; time in miliseconds before note turns momentary when held (On velocity resent)\nint 4 (bool): 0 = expect exact ON velocity; 1 = anything but 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 63.0, 410.0, 61.0 ],
					"text" : "provide momentary options for MIDI note input to a DAW when held down for a defined time, interpret note length as momentary notes",
					"varname" : "title[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 668.200000000000045, 160.0, 240.799999999999955, 20.0 ],
					"text" : "bondo",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1103.0, 932.5, 46.0, 18.0 ],
					"text" : "velocity"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1008.0, 932.5, 36.0, 18.0 ],
					"text" : "pitch "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 875.0, 932.5, 89.0, 18.0 ],
					"text" : "pitch  + velocity"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 917.0, 63.0, 101.0, 18.0 ],
					"text" : "velocity only"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 647.0, 123.25, 72.0, 20.0 ],
					"text" : "typeroute~",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 938.0, 584.0, 31.5, 20.0 ],
					"text" : "64",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1094.0, 421.0, 22.0, 20.0 ],
					"text" : "t b",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 462.0, 9.0, 509.0, 8.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 462.0, 16.0, 122.0, 24.0 ],
					"text" : "midi transform"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 890.0, 216.0, 36.0, 20.0 ],
					"text" : "t i 1",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 668.0, 216.0, 172.0, 20.0 ],
					"text" : "t l 0",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 821.0, 697.0, 88.0, 20.0 ],
					"text" : "gate",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 900.5, 265.0, 49.0, 30.0 ],
					"text" : "velocity input"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1094.0, 584.0, 29.5, 20.0 ],
					"text" : "64",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1010.0, 584.0, 29.5, 20.0 ],
					"text" : "0",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1073.5, 929.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 981.0, 929.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1361.0, 650.0, 158.0, 30.0 ],
					"text" : "0 velocity is sent and pitch banged afterwards"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1361.0, 700.0, 175.0, 30.0 ],
					"text" : "velocity then is packed with the button's pitch value"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1361.0, 534.0, 192.0, 55.0 ],
					"text" : "OFF (0) will be let through only if 300ms have not passed since button was pressed, otherwise 64 is sent again to toggle off"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1361.0, 479.0, 168.0, 30.0 ],
					"text" : "pipe delays the opening of the gate by 300ms"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1361.0, 353.0, 231.0, 79.0 ],
					"text" : "ON sends\n1. 64 through\n2. stops the current delay of last press\n3. bang\n   a) 0 to close the gate\n   b) 1 to open the gate after set time (300)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1243.0, 60.0, 158.0, 30.0 ],
					"text" : "ON OFF TIME \ndefault: 64 0 300"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 958.0, 216.0, 155.25, 20.0 ],
					"text" : "unpack i i i i",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1361.0, 315.0, 147.0, 30.0 ],
					"text" : "64 when held down\n0 when released"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 689.0, 60.0, 100.0, 42.0 ],
					"text" : "note input:\nsingle pitch, velocity or both"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 958.0, 160.0, 222.0, 20.0 ],
					"text" : "patcherargs 64 0 300 0 @mode 0",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 890.0, 655.0, 63.0, 20.0 ],
					"text" : "t b i",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 668.0, 801.0, 29.5, 20.0 ],
					"text" : "64"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 960.0, 484.0, 206.5, 20.0 ],
					"text" : "pipe #3",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 960.0, 421.0, 69.0, 20.0 ],
					"text" : "t 2 1",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1010.0, 548.0, 103.0, 20.0 ],
					"text" : "gate 2 1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 890.0, 358.0, 67.0, 20.0 ],
					"text" : "t b stop b",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 668.0, 888.0, 105.0, 20.0 ],
					"text" : "pack i i",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 668.0, 270.0, 61.0, 20.0 ],
					"text" : "unpack i i",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 647.0, 60.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 668.0, 929.0, 25.0, 25.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 899.5, 393.5, 969.5, 393.5 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 923.5, 455.0, 969.5, 455.0 ],
					"source" : [ "obj-12", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"midpoints" : [ 969.5, 521.0, 1019.5, 521.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 830.5, 749.5, 677.5, 749.5 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 677.5, 848.5, 990.5, 848.5 ],
					"order" : 0,
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 943.5, 697.0, 1083.0, 697.0 ],
					"order" : 0,
					"source" : [ "obj-21", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 1 ],
					"midpoints" : [ 943.5, 807.0, 763.5, 807.0 ],
					"order" : 1,
					"source" : [ "obj-21", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 0 ],
					"midpoints" : [ 916.5, 260.0, 830.5, 260.0 ],
					"source" : [ "obj-25", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 1.0, 0.984314, 0.870588, 0.081539973159509 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1019.5, 635.0, 899.5, 635.0 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-21", 0 ],
					"midpoints" : [ 1103.5, 635.0, 899.5, 635.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-21", 0 ],
					"midpoints" : [ 947.5, 635.0, 899.5, 635.0 ],
					"source" : [ "obj-61", 0 ]
				}
