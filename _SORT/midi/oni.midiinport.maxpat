...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 603.0, 275.0, 30.0, 20.0 ],
					"text" : "t b s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 603.0, 230.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 315.0, 616.0, 177.0, 20.0 ],
					"text" : "zl 1 reg #1"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "checks if a desired MIDI input device is available and updates all connected nodes.",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 741.0, 1189.5, 31.0, 20.0 ],
					"text" : "gate",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 449.45001220703125, 466.0, 118.0, 20.0 ],
					"text" : "autopollcontrollers $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 753.0, 975.0, 42.0, 20.0 ],
					"text" : "midiin",
...
, 			{
				"box" : 				{
					"comment" : "midievent; all MIDI input from given port if available",
					"id" : "obj-3",
					"index" : 3,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 741.0, 1228.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "controllers", "bang", "int" ],
					"patching_rect" : [ 211.0, 568.0, 227.0, 20.0 ],
					"text" : "t controllers b 0",
					"textcolor" : [ 0.921568989753723, 0.917647004127502, 0.933332979679108, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 608.0, 357.0, 74.0, 20.0 ],
					"text" : "patcherargs",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 256.75, 775.0, 150.0, 20.0 ],
					"text" : "regexp",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 612.5, 346.5, 321.25, 346.5 ],
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 331.5, 1134.0, 750.5, 1134.0 ],
					"order" : 0,
					"source" : [ "obj-41", 0 ]
				}
