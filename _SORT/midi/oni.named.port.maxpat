...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 109.5, 388.0, 119.0, 20.0 ],
					"text" : "substitute symbol port"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 109.5, 336.0, 219.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 51.0, 439.0, 45.0, 20.0 ],
					"text" : "midiout",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 51.0, 242.0, 28.0, 20.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 241.0, 388.0, 119.0, 20.0 ],
					"text" : "substitute symbol port"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 241.0, 439.0, 38.0, 20.0 ],
					"text" : "midiin",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 391.5, 242.0, 55.0, 20.0 ],
					"text" : "loadbang",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 391.5, 282.0, 56.0, 20.0 ],
					"text" : "thispoly~",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 391.5, 388.0, 114.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 391.5, 336.0, 235.0, 20.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 241.0, 504.0, 50.0, 20.0 ],
					"text" : "prepend"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 241.0, 548.0, 35.0, 20.0 ],
					"text" : "out 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 171.0, 410.0, 20.0 ],
					"text" : "•"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 136.7855224609375, 410.0, 8.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 146.7855224609375, 280.0, 24.0 ],
					"text" : "concept",
					"varname" : "title[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 103.0, 410.0, 20.0 ],
					"text" : "args:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 59.0, 410.0, 24.0 ],
					"text" : "info~",
					"varname" : "title"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 401.0, 371.5, 250.5, 371.5 ],
					"order" : 1,
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 401.0, 484.0, 250.5, 484.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 401.0, 318.5, 119.0, 318.5 ],
					"order" : 1,
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"midpoints" : [ 119.0, 423.0, 60.5, 423.0 ],
					"source" : [ "obj-22", 0 ]
				}
