...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 844.0, 635.0, 69.0, 22.0 ],
					"text" : "raw MIDI"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 980.0, 635.0, 78.0, 22.0 ],
					"text" : "port active"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 609.0, 635.0, 116.0, 22.0 ],
					"presentation_linecount" : 2,
					"text" : "connect to umenu"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 572.0, 631.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1064.0, 631.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 724.0, 531.0, 78.0, 22.0 ],
					"text" : "port active"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 891.0, 141.0, 145.0, 20.0 ],
					"text" : "prepend autopollcontrollers"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 810.0, 631.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 810.0, 107.0, 33.0, 20.0 ],
					"text" : "sel 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 810.0, 70.0, 181.0, 20.0 ],
					"text" : "route loadbang autopoll",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 810.0, 531.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 810.0, 590.0, 50.0, 20.0 ],
					"text" : "gate",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 841.0, 533.0, 38.0, 20.0 ],
					"text" : "midiin",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 810.0, 141.0, 67.0, 20.0 ],
					"text" : "t controllers",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 922.5, 461.0, 40.0, 20.0 ],
					"text" : "zl sum",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 922.5, 430.0, 48.0, 20.0 ],
					"text" : "zl group",
					"textcolor" : [ 0.921568989753723, 0.717647016048431, 0.117646999657154, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 841.0, 384.0, 31.0, 20.0 ],
					"text" : "t s 1",
					"textcolor" : [ 0.921568989753723, 0.917647004127502, 0.933332979679108, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 572.0, 31.7855224609375, 257.0, 20.0 ],
					"text" : "patcherargs \"to Max 1\" @autopoll 1 @loadbang 1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 841.0, 344.0, 75.0, 20.0 ],
					"text" : "routepass #1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 922.5, 384.0, 47.0, 20.0 ],
					"text" : "0, bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 922.5, 262.5, 41.0, 20.0 ],
					"text" : "del 50",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "" ],
					"patching_rect" : [ 810.0, 221.75, 244.0, 20.0 ],
					"text" : "t l b l",
					"textcolor" : [ 0.921568989753723, 0.917647004127502, 0.933332979679108, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 810.0, 262.5, 50.0, 20.0 ],
					"text" : "sel clear",
					"textcolor" : [ 0.862744987010956, 0.870588004589081, 0.878431022167206, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 841.0, 303.0, 75.0, 20.0 ],
					"text" : "route append",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 810.0, 184.0, 48.0, 20.0 ],
					"text" : "midiinfo",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 443.0, 11.7855224609375, 69.0, 20.0 ],
					"text" : "r colour-dict",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 150.7855224609375, 280.0, 24.0 ],
					"text" : "domain~",
					"varname" : "title[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 443.0, 107.0, 80.0, 20.0 ],
					"text" : "oni.colour-dict",
					"textcolor" : [ 0.937255024909973, 0.764706015586853, 0.301961004734039, 1.0 ],
					"varname" : "pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 443.0, 77.9521484375, 72.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 443.0, 46.9521484375, 71.0, 20.0 ],
					"text" : "universal 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1044.5, 334.875, 581.5, 334.875 ],
					"source" : [ "obj-15", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-22", 0 ],
					"midpoints" : [ 862.5, 416.5, 932.0, 416.5 ],
					"source" : [ "obj-21", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 932.0, 505.5, 819.5, 505.5 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 819.5, 571.5, 1073.5, 571.5 ],
					"order" : 0,
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 900.5, 172.0, 819.5, 172.0 ],
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Documents/Max 8/Projects/2019_COL_Colour-Dict",
				"patcherrelativepath" : "../../../Projects/2019_COL_Colour-Dict",
				"type" : "JSON",
				"implicit" : 1
			}
 ],
