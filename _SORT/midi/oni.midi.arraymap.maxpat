...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 875.75, 165.5, 53.0, 20.0 ],
					"text" : "tosymbol",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 875.75, 199.5, 30.0, 20.0 ],
					"text" : "t b s",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 980.0, 129.0, 44.0, 20.0 ],
					"text" : "#0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 886.75, 247.2144775390625, 111.0, 20.0 ],
					"text" : "in $1_in, out $1_out"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 886.75, 280.2144775390625, 229.0, 20.0 ],
					"text" : "script replace $1 newex 0 0 100 12 coll $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 886.75, 310.2144775390625, 64.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "clear" ],
					"patching_rect" : [ 462.0, 424.0, 97.0, 20.0 ],
					"text" : "t l clear",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 483.0, 171.0, 44.0, 20.0 ],
					"text" : "pack i i",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 462.0, 86.5, 40.0, 20.0 ],
					"text" : "t b l",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 483.0, 129.0, 94.0, 20.0 ],
					"text" : "unpack i i i s",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 760.666666666666629, 665.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 743.916666666666629, 193.5, 60.0, 32.0 ],
					"text" : "offset $1, bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 678.0, 193.5, 68.0, 32.0 ],
					"text" : "dim $1 $2, bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 760.666666666666629, 598.0, 100.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"precision" : 6
					}
,
					"text" : "coll livid-code_in",
					"varname" : "in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 941.666666666666629, 598.0, 104.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"precision" : 6
					}
,
					"text" : "coll livid-code_out",
					"varname" : "out"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 760.666666666666629, 420.0, 200.0, 20.0 ],
					"text" : "gate 2 2",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 797.666666666666629, 372.0, 30.0, 20.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 760.666666666666629, 372.0, 30.0, 20.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 760.666666666666629, 342.0, 93.0, 20.0 ],
					"text" : "sel in out",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 716.0, 57.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 678.0, 129.0, 282.666666666666629, 20.0 ],
					"text" : "route dim offset target coll",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 462.0, 57.0, 235.0, 20.0 ],
					"text" : "patcherargs @dim 8 8 @offset 0 @target in",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 700.0, 548.0, 34.0, 20.0 ],
					"text" : "zl rev",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 462.0, 496.0, 73.0, 20.0 ],
					"text" : "vexpr $i1 * 1",
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.170078, 0.180957, 0.176656, 1.0 ],
					"color" : [ 0.805207, 0.588318, 0.729696, 1.0 ],
					"id" : "obj-29",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 462.0, 458.0, 40.0, 20.0 ],
					"text" : "jit.iter",
					"textcolor" : [ 0.914889, 0.504707, 0.579132, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 462.0, 267.0, 121.0, 20.0 ],
					"text" : "jit.matrix 2 float32 8 8",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 133.0, 357.0, 50.0, 20.0 ],
									"text" : "+ offset"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 133.0, 314.0, 43.5, 20.0 ],
									"text" : "+"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 214.0, 188.0, 28.0, 20.0 ],
									"text" : "+ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 157.5, 274.0, 29.5, 20.0 ],
									"text" : "*"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 70.0, 357.0, 50.0, 20.0 ],
									"text" : "+ offset"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 367.0, 20.0, 82.0, 20.0 ],
									"text" : "param offset 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 261.0, 188.0, 28.0, 20.0 ],
									"text" : "+ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 94.5, 274.0, 29.5, 20.0 ],
									"text" : "*"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 70.0, 314.0, 43.5, 20.0 ],
									"text" : "+"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 214.0, 66.5, 34.0, 20.0 ],
									"text" : "- 1 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 70.0, 400.0, 81.0, 20.0 ],
									"text" : "vec 0 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 132.0, 113.0, 37.0, 20.0 ],
									"text" : "swiz y"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 70.0, 188.0, 29.5, 20.0 ],
									"text" : "*"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 70.0, 113.0, 37.0, 20.0 ],
									"text" : "swiz x"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 261.0, 113.0, 37.0, 20.0 ],
									"text" : "swiz y"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 214.0, 113.0, 37.0, 20.0 ],
									"text" : "swiz x"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 214.0, 20.0, 27.0, 20.0 ],
									"text" : "dim"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 70.0, 20.0, 34.0, 20.0 ],
									"text" : "norm"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 70.0, 424.0, 35.0, 20.0 ],
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 462.0, 376.0, 92.0, 20.0 ],
					"text" : "jit.gen @offset 1",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 18.0, 408.0, 38.0 ],
					"text" : "oni.midi.arraymap"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 106.2144775390625, 410.0, 231.0 ],
					"text" : "args:\n\n1 (int) = x dimension of grid\n2 (int) = y dimension of grid\n3 (int) = offset\n4 (symbol) = target mode\n\n@dim (list) = x, y dimensions of layout (default: 8x8)\n@offset (int) = first value to increment accordingly\n@target (symbol) = in (default): value to use in Max; out: midi mapping as per controller\n@coll (symbol) = will create two [coll] objects which can be used in the Max environment thereafter, and populates them:\n\n(name)_out = translates rows to columns (often standard in MIDI)\n(name)_in = translates columns to rows (standard in Max)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 5.2144775390625, 408.0, 11.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 62.2144775390625, 410.0, 24.0 ],
					"text" : "map logical array layouts for midi assignments"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 989.5, 226.75, 896.25, 226.75 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 471.5, 531.5, 709.5, 531.5 ],
					"order" : 1,
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 471.5, 531.5, 951.166666666666629, 531.5 ],
					"order" : 0,
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 709.5, 582.5, 770.166666666666629, 582.5 ],
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 951.166666666666629, 207.5, 951.166666666666629, 207.5 ],
					"source" : [ "obj-38", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 951.166666666666629, 641.0, 770.166666666666629, 641.0 ],
					"source" : [ "obj-47", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-47", 0 ],
					"midpoints" : [ 549.5, 490.5, 951.166666666666629, 490.5 ],
					"order" : 0,
					"source" : [ "obj-5", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-48", 0 ],
					"midpoints" : [ 549.5, 490.5, 770.166666666666629, 490.5 ],
					"order" : 1,
					"source" : [ "obj-5", 1 ]
				}
