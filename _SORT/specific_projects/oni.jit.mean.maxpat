...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 405.66666666666606, 673.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 504.66666666666606, 673.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 784.0, 407.908159025013447, 39.0, 20.0 ],
					"text" : "pow 2",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 784.0, 353.018588591367006, 73.0, 20.0 ],
					"text" : "loadmess #1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 485.0, 6.89276123046875, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 504.66666666666606, 621.720540925860405, 56.0, 20.0 ],
					"text" : "zl median",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 504.66666666666606, 590.720540925860405, 52.0, 20.0 ],
					"text" : "zl slice 3",
					"textcolor" : [ 0.921569, 0.717647, 0.117647, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 505.0, 532.720540925860405, 55.0, 20.0 ],
					"text" : "vexpr $i1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 661.0, 455.564349975436926, 142.0, 20.0 ],
					"text" : "!/ 256.",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 661.5, 155.279459074139595, 121.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 485.0, 120.0, 195.5, 20.0 ],
					"text" : "t l l",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 661.5, 353.018588591367006, 43.0, 20.0 ],
					"text" : "t b i",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 661.5, 239.220540925860405, 97.5, 20.0 ],
					"text" : "t l b",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 740.0, 353.018588591367006, 34.0, 20.0 ],
					"text" : "set 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 661.0, 407.908159025013447, 68.0, 20.0 ],
					"text" : "accum",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 661.5, 318.408159025013447, 31.0, 20.0 ],
					"text" : "!= 0",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 505.0, 500.408159025013447, 175.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 661.5, 194.720540925860405, 71.0, 20.0 ],
					"text" : "jit.> @val 0.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 661.5, 272.720540925860405, 43.0, 20.0 ],
					"text" : "jit.iter",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 485.0, 70.0, 121.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 485.0, 194.720540925860405, 78.0, 20.0 ],
					"text" : "jit.3m @mean",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 269.0, 410.0, 34.0 ],
					"text" : "get the mean colour of an input matrix and their darkness scale, ignoring black pixels"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 220.0, 410.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 243.0, 410.0, 24.0 ],
					"text" : "info",
					"varname" : "title[1]"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "args:\n\n#1 = x/y resolution of calculation"
				}
