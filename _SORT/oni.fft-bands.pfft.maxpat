...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 596.0, 176.89276123046875, 29.5, 20.0 ],
					"text" : "+ 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 558.0, 134.0, 57.0, 20.0 ],
					"text" : "unpack i i",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 558.0, 90.0, 98.0, 20.0 ],
					"text" : "loadmess #1 #2",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 596.0, 219.7855224609375, 116.0, 20.0 ],
					"text" : "gate~ 2",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 596.0, 408.0, 35.0, 20.0 ],
					"text" : "out 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 596.0, 340.0, 102.0, 20.0 ],
					"text" : "framesnap~ #1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 693.0, 262.0, 65.0, 20.0 ],
					"text" : "normalize~",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 693.0, 134.0, 59.0, 20.0 ],
					"text" : "cartopol~",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 693.0, 90.0, 99.0, 20.0 ],
					"text" : "fftin~ 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 434.0, -1.2144775390625, 562.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 434.0, 21.7855224609375, 562.0, 24.0 ],
					"text" : "signal to frequency multislider",
					"varname" : "title[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 103.0, 410.0, 77.0 ],
					"text" : "args:\n\n#1 (int) = sampleinterval (ms)\n\n@normalize (bool) = normalise list floats"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 2.0, 408.0, 11.0 ],
					"saved_attribute_attributes" : 					{
						"linecolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"text" : "output frequency bands from an incoming signal using fast fourier transform within a pfft~"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 567.5, 293.5, 688.5, 293.5 ],
					"source" : [ "obj-24", 0 ]
				}
