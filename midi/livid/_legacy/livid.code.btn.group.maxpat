...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 188.833333333333343, 466.0, 75.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 175.833333333333343, 400.0, 32.0, 22.0 ],
					"text" : "t b 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 112.5, 270.25, 50.0, 22.0 ],
					"text" : "buddy",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 112.5, 197.5, 50.0, 22.0 ],
					"text" : "t l b",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.5, 235.0, 117.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "livid.device.id",
						"parameter_enable" : 0
					}
,
					"text" : "js livid.device.id poly",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.5, 302.0, 259.0, 22.0 ],
					"text" : "pv device.name livid.cntrlr.button.group.maxpat",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 422.5, 400.0, 189.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 239.166666666666686, 400.0, 75.0, 44.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 626.75, 627.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 626.75, 453.0, 93.0, 22.0 ],
									"text" : "pv device.name",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 626.75, 498.0, 227.0, 22.0 ],
									"text" : "zl change livid.cntrlr.button.group.maxpat",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 251.0, 627.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.75, 569.0, 50.0, 22.0 ],
									"text" : "route -1",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.75, 488.0, 31.0, 22.0 ],
									"text" : "qlim",
									"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 50.75, 530.0, 90.5, 22.0 ],
									"text" : "-1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 501.5, 453.0, 37.0, 22.0 ],
									"text" : "zl len",
									"textcolor" : [ 0.921569, 0.717647, 0.117647, 1.0 ]
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 84.0, 307.0, 88.0, 22.0 ],
													"text" : "offset $1, bang"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 177.5, 380.0, 57.0, 22.0 ],
													"text" : "list.group",
													"textcolor" : [ 0.921569, 0.717647, 0.117647, 1.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "int", "int" ],
													"patching_rect" : [ 84.0, 232.0, 47.0, 22.0 ],
													"text" : "unpack",
													"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 83.5, 347.0, 113.0, 22.0 ],
													"text" : "uzi 0 0",
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 177.5, 274.0, 29.5, 22.0 ],
													"text" : "+ 1",
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 84.0, 164.0, 125.0, 22.0 ],
													"text" : "list.sort @zlmaxsize 2",
													"textcolor" : [ 0.921569, 0.717647, 0.117647, 1.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 177.5, 232.0, 29.5, 22.0 ],
													"text" : "!-"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 84.0, 196.0, 112.5, 22.0 ],
													"text" : "t l l",
													"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 195.5, 40.0, 39.0, 22.0 ],
													"text" : "16-31"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 5,
													"outlettype" : [ "", "", "", "", "" ],
													"patching_rect" : [ 50.0, 121.0, 155.0, 22.0 ],
													"text" : "regexp (\\\\d+)\\\\s?\\\\-\\\\s?(\\\\d+)",
													"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 152.0, 483.0, 30.0, 30.0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 187.0, 318.0, 225.0, 318.0 ],
													"order" : 0,
													"source" : [ "obj-17", 0 ]
												}
...
,
									"patching_rect" : [ 251.0, 214.0, 49.0, 22.0 ],
									"saved_object_attributes" : 									{
										"accentcolor" : [ 0.482352941176471, 0.454901960784314, 0.450980392156863, 1.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 617.0, 297.0, 91.0, 22.0 ],
									"saved_object_attributes" : 									{
										"embed" : 0,
										"parameter_enable" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 617.0, 265.0, 95.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 617.0, 206.0, 165.0, 22.0 ],
									"text" : "routepass modifier banks info",
									"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 251.0, 435.5, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 251.0, 177.0, 38.0, 22.0 ],
									"text" : "zl reg",
									"textcolor" : [ 0.921569, 0.717647, 0.117647, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 376.25, 453.0, 87.0, 22.0 ],
									"text" : "pack 0 1 0 127",
									"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 251.0, 402.0, 31.0, 22.0 ],
									"text" : "qlim",
									"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 505.0, 100.0, 131.0, 22.0 ],
									"text" : "route done midi default",
									"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 376.25, 488.0, 87.0, 22.0 ],
									"saved_object_attributes" : 									{
										"embed" : 0,
										"precision" : 6
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "list" ],
									"patching_rect" : [ 376.25, 399.0, 66.0, 22.0 ],
									"text" : "listfunnel 1",
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 251.0, 367.0, 394.75, 22.0 ],
									"text" : "t b l l b",
									"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 81.75, 627.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 501.5, 627.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 551.833333333333371, 437.5, 431.083333333333314, 437.5 ],
									"source" : [ "obj-12", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 514.5, 154.0, 260.5, 154.0 ],
									"source" : [ "obj-12", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 589.166666666666629, 270.0, 131.75, 270.0 ],
									"source" : [ "obj-12", 2 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 723.833333333333371, 246.0, 626.5, 246.0 ],
									"source" : [ "obj-17", 2 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-22", 0 ],
									"midpoints" : [ 675.166666666666629, 246.0, 626.5, 246.0 ],
									"source" : [ "obj-17", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 260.5, 477.25, 60.25, 477.25 ],
									"order" : 1,
									"source" : [ "obj-19", 0 ]
								}
...
,
					"patching_rect" : [ 112.5, 344.0, 209.0, 22.0 ],
					"saved_object_attributes" : 					{
						"accentcolor" : [ 0.482352941176471, 0.454901960784314, 0.450980392156863, 1.0 ],
						"bgcolor" : [ 0.258823529411765, 0.235294117647059, 0.223529411764706, 1.0 ],
						"color" : [ 1.0, 0.9843137264, 0.870588243, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 562.0, 164.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 305.5, 667.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 329.5, 484.5, 67.0, 22.0 ],
					"text" : "mousefilter",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 329.5, 513.0, 52.0, 22.0 ],
					"text" : "open $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 329.5, 456.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 329.5, 400.0, 75.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 112.5, 164.0, 209.0, 22.0 ],
					"text" : "patcherargs",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 49.0, 667.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 49.0, 605.0, 532.0, 22.0 ],
					"text" : "poly~ livid.cntrlr.button.group @target 0 @args #0",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.523824896131373, 7.999991178512573, 482.0, 116.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 432.0, 569.5, 58.5, 569.5 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 1 ],
					"midpoints" : [ 185.333333333333343, 536.0, 315.0, 536.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 339.0, 569.0, 58.5, 569.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 198.333333333333343, 569.5, 58.5, 569.5 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"midpoints" : [ 312.0, 376.5, 432.0, 376.5 ],
					"source" : [ "obj-35", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 248.666666666666686, 384.0, 339.0, 384.0 ],
					"order" : 0,
					"source" : [ "obj-35", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 122.0, 482.5, 58.5, 482.5 ],
					"source" : [ "obj-35", 0 ]
				}
