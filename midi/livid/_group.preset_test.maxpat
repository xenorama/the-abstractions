...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 840.0, 664.0, 50.0, 35.0 ],
					"text" : "recall 2 8 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 892.0, 572.5, 46.0, 22.0 ],
					"text" : "route 0",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 919.0, 616.0, 85.0, 22.0 ],
					"text" : "prepend recall"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 976.0, 486.0, 91.0, 22.0 ],
					"text" : "livid.cntrlr.ctl 32",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 941.25, 394.0, 29.5, 22.0 ],
					"text" : "+ 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 892.0, 532.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 941.25, 328.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 941.25, 360.0, 211.0, 22.0 ],
					"text" : "livid.cntrlr.btn.group 32-39 @midi 1 16",
					"textcolor" : [ 0.258823529411765, 0.235294117647059, 0.223529411764706, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 723.25, 160.0, 143.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 679.25, 221.0, 209.0, 22.0 ],
					"restore" : [ 2 ],
...
,
					"text" : "pattr last_preset @invisible 1 @thru 0",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"varname" : "last_preset"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 664.0, 81.0, 79.0, 22.0 ],
					"text" : "the.rgb.patch",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 679.25, 388.0, 29.5, 22.0 ],
					"text" : "+ 1",
					"textcolor" : [ 0.392137, 0.95897, 0.351168, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 679.25, 324.0, 29.5, 22.0 ],
					"text" : "- 1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 659.25, 160.0, 50.0, 22.0 ],
					"varname" : "number[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 679.25, 360.0, 224.0, 22.0 ],
					"text" : "livid.cntrlr.btn.group 16-23 @midi 126 32",
					"textcolor" : [ 0.258823529411765, 0.235294117647059, 0.223529411764706, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 659.0, 266.0, 100.0, 19.0 ],
					"pattrstorage" : "params"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 919.0, 684.0, 116.0, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 413.0, 199.0, 135.0, 22.0 ],
					"restore" : 					{
						"button" : [ 0.0 ],
						"dial" : [ 109 ],
						"dial[1]" : [ 69 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 301.0, 335.0, 24.0, 24.0 ],
					"varname" : "button"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 698.875, 486.0, 50.0, 22.0 ],
					"varname" : "number[1]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 638.25, 486.0, 50.0, 22.0 ],
					"varname" : "number"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 577.625, 486.0, 40.0, 40.0 ],
					"varname" : "dial[1]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 517.0, 486.0, 40.0, 40.0 ],
					"varname" : "dial"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 456.375, 486.0, 20.0, 140.0 ],
					"varname" : "slider[3]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 395.75, 486.0, 20.0, 140.0 ],
					"varname" : "slider[2]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 335.125, 486.0, 20.0, 140.0 ],
					"varname" : "slider[1]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 274.5, 486.0, 20.0, 140.0 ],
					"varname" : "slider"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 274.5, 453.0, 504.0, 22.0 ],
					"text" : "unjoin 8",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 274.5, 422.0, 72.0, 22.0 ],
					"text" : "mc.makelist",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 301.0, 369.0, 292.0, 22.0 ],
					"text" : "mc.gen @expr out1=(noise()*0.5+0.5)*127 @chans 8",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 2 ],
					"midpoints" : [ 583.5, 406.0, 337.0, 406.0 ],
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 950.75, 384.0, 927.0, 384.0, 927.0, 324.0, 950.75, 324.0 ],
					"order" : 1,
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 668.75, 223.5, 668.5, 223.5 ],
					"order" : 1,
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 688.75, 420.0, 616.75, 420.0, 616.75, 149.0, 668.75, 149.0 ],
					"order" : 1,
					"source" : [ "obj-29", 0 ]
				}
