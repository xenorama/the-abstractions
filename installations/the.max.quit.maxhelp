...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 433.0, 164.0, 76.0, 20.0 ],
					"text" : "the.max.quit"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 189.0, 275.0, 137.0, 20.0 ],
					"text" : "loadmess resize 771 704"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 434.0, 402.0, 75.0, 25.0 ],
									"text" : "quit Max",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 403.0, 402.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 403.0, 360.0, 58.0, 23.0 ],
									"text" : "relaunch"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 403.0, 237.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 403.0, 290.0, 117.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 434.0, 229.0, 176.0, 40.0 ],
									"text" : "reopen previous windows upon relaunch",
									"textcolor" : [ 0.129412, 0.129412, 0.129412, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 193.5, 250.0, 141.0, 23.0 ],
									"text" : "prepend crashrecovery"
								}
...
, 							{
								"box" : 								{
									...
									"bgfillcolor_type" : "gradient",
									"id" : "obj-11",
									"items" : [ "Ask", ",", "Always", ",", "Never" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 153.0, 217.0, 100.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 257.0, 290.0, 138.0, 25.0 ],
									"text" : "cause Max to crash",
									"textcolor" : [ 0.129412, 0.129412, 0.129412, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 59.0, 164.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 59.0, 217.0, 58.0, 23.0 ],
									"text" : "clean $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 213.0, 290.0, 40.0, 23.0 ],
									"text" : "crash"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 59.0, 481.0, 399.0, 23.0 ],
									"text" : "the.max.quit @restorewindows 1 @crashrecovery Always @clean 0"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 89.0, 156.0, 101.0, 40.0 ],
									"text" : "do not ask for saving",
									"textcolor" : [ 0.129412, 0.129412, 0.129412, 1.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 189.0, 313.0, 160.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "helpstarter.js",
						"parameter_enable" : 0
					}
,
					"text" : "js helpstarter.js xen.max.quit"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 266.5999755859375, 57.599853515625 ]
				}
...
,
					"patching_rect" : [ 155.0, 230.0, 50.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
