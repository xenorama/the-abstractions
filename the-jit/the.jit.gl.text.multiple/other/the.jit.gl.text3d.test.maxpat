...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 598.0, 142.0, 87.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 759.0, 519.0, 137.0, 22.0 ],
					"text" : "fontsize 44, text magmø"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 754.0, 586.0, 53.0, 22.0 ],
					"text" : "jit.gl.text"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 656.0, 438.0, 60.0, 22.0 ],
					"text" : "jit.gl.node"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 656.0, 394.0, 69.0, 22.0 ],
					"text" : "jit.gl.handle"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 252.0, 174.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 456.5, 542.0, 41.0, 22.0 ],
					"text" : "abs 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 456.5, 512.0, 33.0, 22.0 ],
					"text" : "* 9."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 178.0, 600.0, 459.0, 22.0 ],
					"presentation_linecount" : 3,
					"text" : "position -0.5 0.5 0, text \"centepedes in narrow space commit heavenly suicide\", bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 178.0, 555.0, 240.0, 22.0 ],
					"text" : "position 0.7 0.7 0, text \"alma magma\", bang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 422.0, 312.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 637.5, 604.5, 77.0, 22.0 ],
					"text" : "route symbol"
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 637.5, 572.0, 66.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 751.5, 277.475727915763855, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 917.749997854232788, 344.475727915763855, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 751.5, 311.475727915763855, 320.0, 24.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 415.0, 26.0, 553.0, 22.0 ],
									"text" : "nature control reason arrogance mechanics storage science illusion masses solidarity ignorance piety"
								}
...
,
					"patching_rect" : [ 751.5, 344.475727915763855, 129.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 583.0, 207.0, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 222.0, 453.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 547.0, 507.0, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 547.0, 475.0, 49.0, 22.0 ],
					"text" : "$1 $2 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 637.5, 637.0, 75.0, 22.0 ],
					"text" : "prepend text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 456.5, 572.0, 29.5, 22.0 ],
					"text" : "i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 456.5, 477.0, 47.0, 22.0 ],
					"text" : "zl nth 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "", "" ],
					"patching_rect" : [ 422.0, 444.0, 88.0, 22.0 ],
					"text" : "t b l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 422.0, 410.0, 40.0, 22.0 ],
					"text" : "jit.iter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 422.0, 346.0, 136.0, 22.0 ],
					"text" : "jit.matrix 3 float32 12 12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 422.0, 378.0, 193.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 422.0, 624.0, 129.0, 22.0 ],
					"text" : "jit.gl.text3d @scale 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 298.0, 257.0, 80.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 252.0, 206.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ -8.476175103868627, 128.0, 142.0, 322.0 ]
				}
...
, 			{
				...
				"bootpath" : "~/Documents/Max 8/Packages/the-package/abstractions/the.jit.gl.text.ar",
				"patcherrelativepath" : "../the.jit.gl.text.ar",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
