...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.0, 263.0, 93.0, 22.0 ],
					"text" : "the.mc.live.rec~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 335.600006103515625, 57.599853515625 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 241.5, 270.0, 200.0, 24.0 ],
									"tabs" : [ "record", "stop", "play" ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 716.0, 308.0, 36.0, 23.0 ],
									"text" : "write"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 401.5, 243.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "3",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 265.5, 243.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "2",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 127.0, 437.0, 87.0, 22.0 ],
									"sig" : 0.0
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 311.0, 505.5, 264.5, 71.0 ],
									"size" : 1.0,
									"thickness" : 50.0
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 315.25, 508.5, 256.0, 64.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 634.0, 308.0, 50.0, 23.0 ],
									"text" : "size $1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 566.0, 270.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 566.0, 308.0, 51.0, 23.0 ],
									"text" : "loop $1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 589.5, 450.0, 158.0, 259.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 34.0, 653.0, 45.0, 45.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 1,
									"patching_rect" : [ 34.0, 587.0, 137.0, 47.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "float" ],
									"patching_rect" : [ 221.0, 437.0, 85.0, 22.0 ],
									"sig" : 0.0
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 127.0, 471.0, 71.0, 28.0 ],
									"range" : [ 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 34.0, 505.5, 184.0, 66.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 34.0, 270.0, 184.0, 66.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 34.0, 204.0, 45.0, 45.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 34.0, 167.0, 77.0, 23.0 ],
									"text" : "startwindow"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 122.5, 167.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "1",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-9", 0 ],
									"midpoints" : [ 489.5, 360.5, 43.5, 360.5 ],
									"source" : [ "obj-11", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-9", 0 ],
									"midpoints" : [ 341.5, 361.0, 43.5, 361.0 ],
									"source" : [ "obj-20", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-9", 0 ],
									"midpoints" : [ 575.5, 360.5, 43.5, 360.5 ],
									"source" : [ "obj-21", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-9", 0 ],
									"midpoints" : [ 643.5, 360.5, 43.5, 360.5 ],
									"source" : [ "obj-27", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 137.0, 425.0, 136.5, 425.0 ],
									"order" : 0,
									"source" : [ "obj-9", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 417.5, 430.75, 599.0, 430.75 ],
									"source" : [ "obj-9", 4 ]
								}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-10",
					"ignoreclick" : 1,
					"jsarguments" : [ "oni.streamfunnel" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 358.447998046875, 57.599853515625 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-6::obj-25" : [ "mc.live.gain~[1]", "mc.live.gain~", 0 ],
			"parameterbanks" : 			{
