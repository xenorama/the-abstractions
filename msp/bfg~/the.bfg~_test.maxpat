...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 173.0, 399.0, 87.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 164.0, 156.0, 122.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 417.0, 225.0, 43.0, 22.0 ],
					"text" : "sel init",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 152.5, 717.0, 85.0, 22.0 ],
					"text" : "harmonic 45 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 86.0, 717.0, 58.0, 22.0 ],
					"text" : "loadbang",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 637.0, 224.0, 151.0, 22.0 ],
					"text" : "loadmess fractal.multi.rigid",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 471.0, 161.0, 80.0, 22.0 ],
					"text" : "loadmess 2.3",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 86.0, 749.0, 84.0, 22.0 ],
					"text" : "deviate 0.7 45"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 65.0, 1060.5, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 86.0, 781.0, 136.0, 22.0 ],
					"text" : "mc.cycle~ 95 @chans 3",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 65.0, 845.5, 164.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 65.0, 878.0, 55.0, 22.0 ],
					"text" : "mc.dup~",
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 65.0, 914.5, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					"border" : 0,
					"embedstate" : [ [ "layout", 1 ], [ "fontname", "Lato" ], [ "justification", 0 ], [ "outline", 0 ], [ "textcolor", "bgcolor" ], [ "offcolor", "elementcolor" ], [ "off_alpha", 0.66 ], [ "hovercolor", "accentcolor" ], [ "width", 43 ], [ "text", "sign" ], [ "orientation", 1 ], [ "bg_alpha", 0.24 ], [ "bg_width", 0 ], [ "oncolor", "color" ], [ "fontsize", 12 ], [ "multi_line", 0 ], [ "blob_size", 0.67 ] ],
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 182.0, 500.0, 88.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 182.0, 534.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 65.0, 813.0, 40.0, 22.0 ],
					"text" : "mc.*~",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 545.0, 700.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 424.0, 769.0, 363.0, 93.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 424.0, 726.0, 172.0, 22.0 ],
					"text" : "jit.graph @mode 2 @rangelo 0",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 611.0, 18.0, 33.0, 22.0 ],
					"text" : "* 0.5",
					"textcolor" : [ 0.275282, 0.960371, 0.999055, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 562.0, 18.0, 20.0, 140.0 ],
					"size" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 761.0, 178.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 761.0, 212.0, 150.0, 22.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									"code" : "Param edge_fade(0.000977);\r\nParam mode(0);\r\n\r\nif (norm.x >= (1-edge_fade)) {\r\n\txfade = 1-norm.x;\r\n\tbegin = (mode)\r\n\t\t? nearest(in1,0,norm.y)\r\n\t\t: nearest(in1,vec(xfade,norm.y));\r\n\tout1 = mix(begin,in1,xfade*(1/edge_fade));\r\n\t}\r\nelse out1 = in1;",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 12.0,
									"id" : "obj-3",
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 87.0, 804.0, 240.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 439.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 371.0, 472.0, 49.0, 22.0 ],
					"text" : "jit.gl.pix",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 313.0, 502.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 611.0, 50.0, 182.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 611.0, 82.0, 237.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 466.0, 534.0, 454.0, 16.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 622.0, 166.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 167.0, 278.0, 55.0, 22.0 ],
					"text" : "$1 $1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 167.0, 310.0, 119.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 65.0, 445.0, 245.0, 22.0 ],
					"text" : "mc.sig~ @chans 3 @initialvalues 0.1 0.3 0.7",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 637.0, 256.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 101.0, 591.0, 198.0, 101.0 ]
				}
...
,
							...
							"boxes" : [ 								{
									"box" : 									{
										...
										"numoutlets" : 1,
										"outlettype" : [ "" ],
										"patching_rect" : [ 255.0, 662.0, 61.0, 22.0 ],
										"numinlets" : 3
									}
...
, 								{
									"box" : 									{
										...
										"numoutlets" : 1,
										"outlettype" : [ "" ],
										"patching_rect" : [ 372.0, 599.0, 23.0, 22.0 ],
										"numinlets" : 1
									}
...
, 								{
									"box" : 									{
										...
										"numoutlets" : 1,
										"outlettype" : [ "" ],
										"patching_rect" : [ 372.0, 567.0, 23.0, 22.0 ],
										"numinlets" : 1
									}
...
, 								{
									"box" : 									{
										...
										"numoutlets" : 1,
										"outlettype" : [ "" ],
										"patching_rect" : [ 262.0, 486.5, 26.0, 22.0 ],
										"numinlets" : 1
									}
...
, 								{
									"box" : 									{
										...
										"numoutlets" : 2,
										"outlettype" : [ "", "" ],
										"patching_rect" : [ 262.0, 529.0, 129.0, 22.0 ],
										"numinlets" : 2
									}
...
, 								{
									"box" : 									{
										...
										"numoutlets" : 1,
										"outlettype" : [ "" ],
										"patching_rect" : [ 262.0, 446.0, 79.0, 22.0 ],
										"numinlets" : 0
									}
...
, 								{
									"box" : 									{
										...
										"numoutlets" : 1,
										"outlettype" : [ "" ],
										"patching_rect" : [ 372.0, 414.0, 45.0, 22.0 ],
										"numinlets" : 2
									}
...
, 								{
									"box" : 									{
										...
										"numoutlets" : 1,
										"outlettype" : [ "" ],
										"patching_rect" : [ 560.0, 414.0, 111.0, 22.0 ],
										"numinlets" : 0
									}
...
, 								{
									"box" : 									{
										"maxclass" : "newobj",
										"text" : "wave bfg @interp linear",
										"id" : "obj-5",
										"numoutlets" : 2,
										"outlettype" : [ "", "" ],
										"patching_rect" : [ 372.0, 446.0, 207.0, 22.0 ],
										"numinlets" : 4
									}
...
, 								{
									"box" : 									{
										...
										"outlettype" : [ "" ],
										"fontname" : "<Monospaced>",
										"patching_rect" : [ 50.0, 67.0, 533.0, 312.0 ],
										"fontface" : 0,
										"numinlets" : 1,
										"code" : "Buffer bfg(\"bfg\");\r\n\r\nParam freq(1/1024);\r\n\r\nval = wave(bfg,3,phasor(freq),0,dim(bfg)-1,mc_channel-1);\r\nout1 = val;"
									}
...
, 								{
									"box" : 									{
										...
										"id" : "obj-4",
										"numoutlets" : 0,
										"patching_rect" : [ 262.0, 698.0, 35.0, 22.0 ],
										"numinlets" : 1
									}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 622.0, 391.0, 55.0, 22.0 ],
					"text" : "pipe 500",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 371.0, 607.375, 296.0, 22.0 ],
					"text" : "jit.matrix 3 float32 1024 1 @adapt 0 @planemap 1 2 3",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 242.0, 749.0, 129.0, 22.0 ],
					"text" : "loadmess samps 1024",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 371.0, 878.0, 102.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 358.0, 335.0, 32.0, 22.0 ],
					"text" : "t 1 b",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 358.0, 301.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 371.0, 565.25, 29.5, 22.0 ],
					"text" : "t l 0",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 622.0, 441.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 325.0, 138.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 391.0, 639.5, 147.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 371.0, 682.0, 454.0, 16.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 371.0, 516.0, 89.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 371.0, 391.0, 145.0, 22.0 ],
					"text" : "jit.gl.texture @dim 1024 2",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 584.0, 302.0, 91.0, 22.0 ],
					"text" : "get_gl3_shader"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 471.0, 224.5, 50.0, 22.0 ],
					"text" : "$1 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 471.0, 256.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 325.0, 193.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 371.0, 441.0, 236.0, 22.0 ],
					"text" : "jit.gl.bfg @basis noise.simplex @colorize 1",
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 631.5, 489.0, 380.5, 489.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 391.0, 597.25, 789.75, 597.25, 789.75, 375.0, 631.5, 375.0 ],
					"source" : [ "obj-24", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-31", 0 ],
					"midpoints" : [ 367.5, 375.0, 631.5, 375.0 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 426.5, 273.5, 367.5, 273.5 ],
					"source" : [ "obj-3", 0 ]
				}
