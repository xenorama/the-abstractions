...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 552.0, 442.0, 95.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 468.5, 561.0, 150.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 36.0, 630.0, 244.0, 23.0 ],
					"text" : "mc.gen~ the.ef",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 298.5, 561.0, 150.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 686.0, 407.0, 172.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 550.0, 702.0, 58.0, 23.0 ],
					"text" : "sel bang",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 907.0, 137.0, 250.536514282226562, 114.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 992.0, 258.0, 165.107025146484375, 189.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 261.0, 402.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 204.523824896131373, 402.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 149.25, 402.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "" ],
					"patching_rect" : [ 302.0, 266.0, 366.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 36.0, 205.0, 285.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 636.5, 611.5, 98.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 881.0, 266.0, 71.0, 23.0 ],
					"text" : "route done",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 636.5, 561.0, 179.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 298.5, 407.0, 357.0, 23.0 ],
					"text" : "route up down makeup clip postclip interval mode sigcheck",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 686.0, 138.0, 186.0, 23.0 ],
					"text" : "patcherargs 1 4000 15 1 100 1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 550.0, 776.0, 30.0, 23.0 ],
					"text" : "1, 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 550.0, 732.0, 63.0, 23.0 ],
					"text" : "t b 0",
...
, 			{
				"box" : 				{
					"comment" : "the.mc.ef~: (voice) Voice Number",
					"id" : "obj-66",
					"index" : 3,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 550.0, 901.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 261.0, 811.0, 268.0, 23.0 ],
					"text" : "mc.target",
...
,
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 261.0, 849.0, 308.0, 23.0 ],
					"text" : "mc.gen @t getlistpeaks @hot 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"wrapper_uniquekey" : "u297005895"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "setvalue", "int" ],
					"patching_rect" : [ 550.0, 811.0, 63.0, 23.0 ],
					"text" : "mc.target",
					"textcolor" : [ 0.996078, 0.207843, 0.690196, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 550.0, 611.5, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 261.0, 772.0, 268.0, 23.0 ],
					"text" : "mc.peakamp~ 100",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 261.0, 901.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 36.0, 901.0, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 862.5, 262.0, 890.5, 262.0 ],
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 270.5, 712.0, 270.5, 712.0 ],
					"source" : [ "obj-10", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 101.5, 535.0, 101.75, 535.0 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 787.299999999999955, 514.5, 270.5, 514.5 ],
					"source" : [ "obj-27", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 756.700000000000045, 499.5, 214.25, 499.5 ],
					"source" : [ "obj-27", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 726.100000000000023, 484.5, 158.0, 484.5 ],
					"source" : [ "obj-27", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 1 ],
					"midpoints" : [ 695.5, 469.5, 101.75, 469.5 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 817.899999999999977, 671.5, 519.5, 671.5 ],
					"source" : [ "obj-27", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 848.5, 529.5, 308.0, 529.5 ],
					"source" : [ "obj-27", 5 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 942.5, 358.0, 308.0, 358.0 ],
					"source" : [ "obj-34", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 178.5, 309.0, 45.5, 309.0 ],
					"source" : [ "obj-37", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"midpoints" : [ 45.5, 285.5, 45.5, 285.5 ],
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 311.5, 262.0, 311.5, 262.0 ],
					"source" : [ "obj-37", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 2 ],
					"midpoints" : [ 158.75, 550.0, 158.0, 550.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 3 ],
					"midpoints" : [ 214.023824896131373, 565.0, 214.25, 565.0 ],
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 4 ],
					"midpoints" : [ 270.5, 580.0, 270.5, 580.0 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 4 ],
					"midpoints" : [ 478.0, 606.5, 270.5, 606.5 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 4 ],
					"midpoints" : [ 308.0, 608.0, 270.5, 608.0 ],
					"source" : [ "obj-53", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 4 ],
					"midpoints" : [ 434.75, 514.5, 270.5, 514.5 ],
					"source" : [ "obj-6", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 3 ],
					"midpoints" : [ 392.5, 499.5, 214.25, 499.5 ],
					"source" : [ "obj-6", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 2 ],
					"midpoints" : [ 350.25, 484.5, 158.0, 484.5 ],
					"source" : [ "obj-6", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 1 ],
					"midpoints" : [ 308.0, 469.5, 101.75, 469.5 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-23", 1 ],
					"midpoints" : [ 519.25, 671.0, 519.5, 671.0 ],
					"source" : [ "obj-6", 5 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-53", 0 ],
					"midpoints" : [ 477.0, 529.5, 308.0, 529.5 ],
					"source" : [ "obj-6", 4 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"midpoints" : [ 600.666666666666742, 330.0, 45.5, 330.0 ],
					"source" : [ "obj-7", 5 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"midpoints" : [ 542.833333333333371, 330.0, 45.5, 330.0 ],
					"source" : [ "obj-7", 4 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"midpoints" : [ 485.0, 330.0, 45.5, 330.0 ],
					"source" : [ "obj-7", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"midpoints" : [ 427.166666666666686, 330.0, 45.5, 330.0 ],
					"source" : [ "obj-7", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"midpoints" : [ 369.333333333333371, 330.0, 45.5, 330.0 ],
					"source" : [ "obj-7", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"midpoints" : [ 311.5, 330.0, 45.5, 330.0 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 658.5, 358.0, 308.0, 358.0 ],
					"source" : [ "obj-7", 6 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 561.5, 546.0, 478.0, 546.0 ],
					"source" : [ "obj-8", 0 ]
				}
