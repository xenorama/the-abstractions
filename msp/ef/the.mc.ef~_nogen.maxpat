...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 195.0, 520.0, 67.0, 23.0 ],
					"text" : "mc.*~ 500",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 713.0, 769.0, 92.0, 23.0 ],
					"text" : "route sigcheck"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 92.0, 777.0, 150.0, 23.0 ]
				}
...
, 								{
									"box" : 									{
										...
										"outlettype" : [ "" ],
										"id" : "obj-8",
										"patching_rect" : [ 353.0, 24.0, 28.0, 22.0 ],
										"numinlets" : 0,
										"numoutlets" : 1
									}
...
, 								{
									"box" : 									{
										...
										"fontname" : "<Monospaced>",
										"id" : "obj-7",
										"patching_rect" : [ 35.0, 73.0, 337.0, 160.0 ],
										"fontface" : 0,
										"numinlets" : 2,
										"numoutlets" : 2,
										"fontsize" : 12.0,
										"code" : "Param postclip(1);\r\n\r\nclip = abs(in2);\r\n\r\nval = clip ? clip(in1,0,clip) : in1;\r\nout1 = val;\r\nout2 = postclip ? val : in1;"
									}
...
, 								{
									"box" : 									{
										...
										"text" : "out 2",
										"id" : "obj-5",
										"patching_rect" : [ 353.0, 261.0, 35.0, 22.0 ],
										"numinlets" : 1,
										"numoutlets" : 0
									}
...
, 								{
									"box" : 									{
										...
										"text" : "out 1",
										"id" : "obj-4",
										"patching_rect" : [ 35.0, 261.0, 35.0, 22.0 ],
										"numinlets" : 1,
										"numoutlets" : 0
									}
...
,
					...
					"patching_rect" : [ 65.0, 888.0, 215.0, 23.0 ],
					"text" : "mc.gen~ @t apply_clipping",
					"textcolor" : [ 0.932326316833496, 0.86507248878479, 0.03703885897994, 1.0 ],
					"wrapper_uniquekey" : "u858010724"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 568.0, 482.0, 100.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 550.0, 888.0, 58.0, 23.0 ],
					"text" : "sel bang",
...
, 			{
				"box" : 				{
					...
					"id" : "obj-3",
					"ignoreclick" : 1,
					"jsarguments" : [ "the.mc.ef~" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 789.0, 137.0, 250.536514282226562, 114.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 874.0, 258.0, 165.107025146484375, 174.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.mc.ef~: (multichannelsignal/float) clipping top-level. If zero, no clipping will be applied",
					"id" : "obj-40",
					"index" : 5,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 501.5, 770.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.mc.ef~: (multichannelsignal/float) makeup gain in linear amplitude",
					"id" : "obj-39",
					"index" : 4,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 466.523824896131373, 475.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.mc.ef~: (multichannelsignal/float) ramp down in samples",
					"id" : "obj-38",
					"index" : 3,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 393.25, 475.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.mc.ef~: (multichannelsignal/float) ramp up in samples",
					"id" : "obj-26",
					"index" : 2,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 312.0, 475.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "" ],
					"patching_rect" : [ 389.0, 287.0, 366.0, 23.0 ],
					"text" : "routepass usebusymap bz busymapname bzname chans zero",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 36.0, 205.0, 337.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 786.0, 866.0, 98.0, 23.0 ],
					"text" : "print the.mc.ef~",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 763.0, 287.0, 71.0, 23.0 ],
					"text" : "route done",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 786.0, 815.5, 179.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 261.0, 662.0, 319.0, 23.0 ],
					"text" : "route clip postclip interval",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 276.5, 436.0, 263.5, 23.0 ],
					"text" : "route up down makeup",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 568.0, 138.0, 214.0, 23.0 ],
					"text" : "patcherargs 1 4000 4 1 100 1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 550.0, 962.0, 30.0, 23.0 ],
					"text" : "1, 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 550.0, 918.0, 63.0, 23.0 ],
					"text" : "t b 0",
...
, 			{
				"box" : 				{
					"comment" : "the.mc.ef~: (float) running peak value, reset by sending a bang to rightmost inlet",
					"id" : "obj-66",
					"index" : 3,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 550.0, 1087.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 261.0, 997.0, 219.0, 23.0 ],
					"text" : "mc.target",
...
, 								{
									"box" : 									{
										...
										"outlettype" : [ "" ],
										"id" : "obj-2",
										"patching_rect" : [ 439.0, 41.0, 28.0, 22.0 ],
										"numinlets" : 0,
										"numoutlets" : 1
									}
...
, 								{
									"box" : 									{
										...
										"fontname" : "<Monospaced>",
										"id" : "obj-3",
										"patching_rect" : [ 50.0, 125.0, 408.0, 198.0 ],
										"fontface" : 0,
										"numinlets" : 2,
										"numoutlets" : 1,
										"fontsize" : 12.0,
										"code" : "History peakamp(0);\r\n\r\npeakamp = (in1 > peakamp) ? in1 : peakamp;\r\nreset = change(in2)==0;\r\npeakamp *= reset;\r\n\r\nout1 = peakamp;"
									}
...
,
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 261.0, 1035.0, 308.0, 23.0 ],
					"text" : "mc.gen @t getlistpeaks @hot 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"wrapper_uniquekey" : "u536010763"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "setvalue", "int" ],
					"patching_rect" : [ 550.0, 997.0, 63.0, 23.0 ],
					"text" : "mc.target",
					"textcolor" : [ 0.996078, 0.207843, 0.690196, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"comment" : "the.ef~: (signal/float/bang) amplyify output, bang to reset peak value from rightmost outlet",
					"id" : "obj-25",
					"index" : 6,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 550.0, 770.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 261.0, 958.0, 219.0, 23.0 ],
					"text" : "mc.peakamp~ 100",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 261.0, 1087.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.mc.ef~: (signal) absolute ramped signal value",
					"id" : "obj-20",
					"index" : 1,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 65.0, 1087.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 195.0, 603.0, 263.5, 23.0 ],
					"text" : "mc.*~ 1",
					"textcolor" : [ 0.275282, 0.960371, 0.999055, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 195.0, 563.0, 182.0, 23.0 ],
					"text" : "mc.rampsmooth~",
					"textcolor" : [ 1.0, 0.984314, 0.870588, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 195.0, 482.0, 68.0, 23.0 ],
					"text" : "mc.times~",
					"textcolor" : [ 0.275282, 0.960371, 0.999055, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 195.0, 391.0, 65.0, 23.0 ],
					"text" : "mc.delta~",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 195.0, 351.0, 58.0, 23.0 ],
					"text" : "mc.abs~",
...
, 			{
				"box" : 				{
					"comment" : "the.mc.ef~: (multichannelsignal) signal to apply envelope following to",
					"id" : "obj-12",
					"index" : 1,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 36.0, 151.999991178512573, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 772.5, 262.0, 772.5, 262.0 ],
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 204.5, 447.5, 253.5, 447.5 ],
					"order" : 0,
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 204.5, 724.0, 74.5, 724.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 321.5, 527.5, 286.0, 527.5 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 593.700000000000045, 533.5, 367.5, 533.5 ],
					"source" : [ "obj-27", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-18", 1 ],
					"midpoints" : [ 577.5, 527.5, 286.0, 527.5 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 609.899999999999977, 553.5, 449.0, 553.5 ],
					"source" : [ "obj-27", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 642.299999999999955, 867.5, 470.5, 867.5 ],
					"source" : [ "obj-27", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 626.100000000000023, 729.5, 270.5, 729.5 ],
					"source" : [ "obj-27", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 658.5, 748.5, 101.5, 748.5 ],
					"source" : [ "obj-27", 5 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-23", 1 ],
					"midpoints" : [ 470.5, 949.0, 470.5, 949.0 ],
					"source" : [ "obj-32", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-46", 1 ],
					"midpoints" : [ 270.5, 729.0, 270.5, 729.0 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 570.5, 707.0, 722.5, 707.0 ],
					"source" : [ "obj-32", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-53", 0 ],
					"midpoints" : [ 370.5, 748.5, 101.5, 748.5 ],
					"source" : [ "obj-32", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 824.5, 358.0, 286.0, 358.0 ],
					"source" : [ "obj-34", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 45.5, 285.5, 204.5, 285.5 ],
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 363.5, 358.5, 286.0, 358.5 ],
					"order" : 1,
					"source" : [ "obj-37", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 363.5, 262.0, 398.5, 262.0 ],
					"order" : 0,
					"source" : [ "obj-37", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-18", 2 ],
					"midpoints" : [ 402.75, 533.5, 367.5, 533.5 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 1 ],
					"midpoints" : [ 476.023824896131373, 553.5, 449.0, 553.5 ],
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-46", 1 ],
					"midpoints" : [ 511.0, 844.0, 270.5, 844.0 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 270.5, 934.0, 270.5, 934.0 ],
					"source" : [ "obj-46", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 530.5, 642.5, 270.5, 642.5 ],
					"source" : [ "obj-6", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 687.666666666666742, 330.0, 204.5, 330.0 ],
					"source" : [ "obj-7", 5 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 629.833333333333371, 330.0, 204.5, 330.0 ],
					"source" : [ "obj-7", 4 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 572.0, 330.0, 204.5, 330.0 ],
					"source" : [ "obj-7", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 514.166666666666742, 330.0, 204.5, 330.0 ],
					"source" : [ "obj-7", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 456.333333333333371, 330.0, 204.5, 330.0 ],
					"source" : [ "obj-7", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 398.5, 330.0, 204.5, 330.0 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 745.5, 358.0, 286.0, 358.0 ],
					"source" : [ "obj-7", 6 ]
				}
