...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 274.5, 668.0, 92.5, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 443.5, 668.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 700.5, 275.0, 310.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 382.5, 508.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 700.5, 307.0, 310.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 376.5, 594.0, 310.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 443.5, 622.0, 310.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 376.5, 307.0, 310.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 376.5, 754.0, 659.0, 22.0 ],
					"text" : "jit.gl.gridshape @shape cylinder @scale 0.3 0.3 1. @color 0.7 0.7 0.7 1 @lighting_enable 1 @smooth_shading 1 @layer 3",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 242.0, 421.0, 249.523824896131373, 34.0 ],
					"text" : "build model scene here:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 242.0, 457.0, 1616.0, 11.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 242.0, 457.0, 17.0, 1037.0 ]
				}
...
, 			{
				"box" : 				{
					"border" : 0,
					"embedstate" : [ [ "font_size", 13 ], [ "scale", 1, 1 ], [ "help_grid", 0 ], [ "on_color", "color" ], [ "active", 1 ], [ "mode", 1 ], [ "panel_color", "bgcolor" ], [ "offset", 0, 0 ], [ "rounded", 0.3 ], [ "align", 1 ], [ "panel", 0 ], [ "outline_color", "bgcolor" ], [ "outline", 0 ], [ "circle", 0 ], [ "svg", "reload2.svg", "reload2.svg" ], [ "outline_size", 0.7 ], [ "font_name", "Lato" ], [ "svg_off_color", "locked_bgcolor" ], [ "text_offset", 0 ], [ "hover_color", "accentcolor" ], [ "text_color", "bgcolor" ] ],
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 28.0, 382.0, 64.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.0, 518.0, 36.0, 22.0 ],
					"text" : "defer",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "wclose" ],
					"patching_rect" : [ 89.0, 518.0, 52.0, 22.0 ],
					"text" : "t wclose",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.0, 467.0, 42.0, 22.0 ],
					"text" : "reload"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.0, 558.0, 89.0, 22.0 ],
					"text" : "prepend model"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 28.0, 210.0, 290.0, 22.0 ],
					"text" : "route window node",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 598.0, 113.0, 22.0 ],
					"text" : "s #1_custom.model",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 538.5, 508.0, 310.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 505.5, 558.0, 383.0, 22.0 ],
					"text" : "jit.gl.gridshape @shape cube @color 1 1 1 0.5 @layer -1 @cull_face 2",
					"textcolor" : [ 0.777871251106262, 0.62992262840271, 0.814014732837677, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 291.5, 275.0, 35.0, 22.0 ],
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 514.0, 275.0, 52.0, 84.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 86.0, 411.0, 153.0, 22.0 ],
									"text" : "loadmess rotatexyz -90 0 0",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 198.0, 327.0, 98.5, 44.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 198.0, 281.0, 22.0, 22.0 ],
									"text" : "t 0",
									"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 93.0, 327.0, 98.5, 44.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 93.0, 281.0, 22.0, 22.0 ],
									"text" : "t 1",
									"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 93.0, 249.0, 124.0, 22.0 ],
									"text" : "route #1_speakers",
									"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 93.0, 193.0, 76.0, 22.0 ],
									"text" : "getattr name",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 50.0, 139.0, 98.5, 44.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"text" : "zl lookup #0_speakers #1_speakers",
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 50.0, 459.0, 351.0, 22.0 ],
									"text" : "jit.world @visible 0 @name #0_speakers @fsaa 1 @floating 1",
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 95.5, 445.5, 59.5, 445.5 ],
									"source" : [ "obj-3", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 131.0, 231.5, 59.5, 231.5 ],
									"source" : [ "obj-38", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 102.5, 314.5, 207.5, 314.5 ],
									"order" : 0,
									"source" : [ "obj-40", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 102.5, 386.5, 59.5, 386.5 ],
									"source" : [ "obj-41", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-41", 0 ],
									"midpoints" : [ 207.5, 314.5, 102.5, 314.5 ],
									"order" : 1,
									"source" : [ "obj-42", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 207.5, 387.5, 59.5, 387.5 ],
									"source" : [ "obj-43", 0 ]
								}
...
,
					"patching_rect" : [ 28.0, 132.0, 64.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 28.0, 250.0, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.0, 171.0, 111.0, 22.0 ],
					"text" : "r #1_custom.model",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 291.5, 307.0, 69.0, 22.0 ],
					"text" : "jit.gl.handle",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 291.5, 84.0, 296.0, 89.0 ],
					"text" : "save as custom patcher and use it as model in patch mode in 'the.speaker.setup~'"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 535.0, 210.0, 190.0, 62.0 ],
					"text" : "all gl objects to draw to this node"
				}
...
, 			{
				"box" : 				{
					"border" : 0,
					"embedstate" : [ [ "justification", 0 ], [ "blob_size", 0.67 ], [ "fontsize", 12 ], [ "offcolor", "elementcolor" ], [ "textcolor", "bgcolor" ], [ "multi_line", 0 ], [ "fontname", "Lato" ], [ "off_alpha", 0.66 ], [ "layout", 2 ], [ "hovercolor", "accentcolor" ], [ "width", 43 ], [ "outline", 0 ], [ "bg_alpha", 0.36 ], [ "text", "operate locally" ], [ "orientation", 1 ], [ "oncolor", "color" ], [ "bg_width", 1 ] ],
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 28.0, 97.0, 129.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 291.5, 362.0, 836.0, 22.0 ],
					"text" : "jit.gl.node @drawto #1_speakers @blend_enable 1 @fsaa 1 @erase_color 0 0 0 0 @scale 1 1 0.6 @position 0 0 0.48 ",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.523824896131373, 7.999991178512573, 487.0, 59.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 301.0, 345.0, 301.0, 345.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 173.0, 343.5, 301.0, 343.5 ],
					"source" : [ "obj-16", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 37.5, 503.0, 98.5, 503.0 ],
					"order" : 0,
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 98.5, 550.0, 154.0, 550.0, 154.0, 239.0, 37.5, 239.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 386.0, 345.0, 301.0, 345.0 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 710.0, 345.0, 301.0, 345.0 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 37.5, 456.0, 37.5, 456.0 ],
					"source" : [ "obj-335", 0 ]
				}
