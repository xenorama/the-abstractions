...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"border" : 0,
					"embedstate" : [ [ "multi_line", 0 ], [ "fontname", "Lato" ], [ "oncolor", "color" ], [ "outline", 0 ], [ "textcolor", "bgcolor" ], [ "off_alpha", 0.66 ], [ "text", "operate locally" ], [ "layout", 2 ], [ "orientation", 1 ], [ "hovercolor", "accentcolor" ], [ "bg_alpha", 0.36 ], [ "offcolor", "elementcolor" ], [ "justification", 0 ], [ "width", 43 ], [ "bg_width", 1 ], [ "fontsize", 12 ], [ "blob_size", 0.67 ] ],
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 117.0, 201.0, 129.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 117.0, 160.0, 58.0, 22.0 ],
					"text" : "layout 3"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 265.0, 463.0, 98.5, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 265.0, 417.0, 22.0, 22.0 ],
					"text" : "t 0",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 160.0, 463.0, 98.5, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 160.0, 417.0, 22.0, 22.0 ],
					"text" : "t 1",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 160.0, 385.0, 124.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 160.0, 329.0, 76.0, 22.0 ],
					"text" : "getattr name",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 644.0, 126.0, 79.0, 22.0 ],
					"text" : "the.rgb.patch",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 117.0, 275.0, 98.5, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 117.0, 236.0, 200.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 440.0, 317.0, 389.0, 22.0 ],
					"text" : "jit.gl.node @name #1_custom @drawto #1_speakers @blend_enable 1",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 117.0, 541.0, 274.0, 22.0 ],
					"text" : "jit.world @visible 0 @name #0_speakers @fsaa 1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.523824896131373, 7.999991178512573, 473.0, 116.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 198.0, 367.5, 126.5, 367.5 ],
					"source" : [ "obj-38", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 169.5, 450.5, 274.5, 450.5 ],
					"order" : 0,
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 169.5, 522.5, 126.5, 522.5 ],
					"source" : [ "obj-41", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-41", 0 ],
					"midpoints" : [ 274.5, 450.5, 169.5, 450.5 ],
					"order" : 1,
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 274.5, 523.5, 126.5, 523.5 ],
					"source" : [ "obj-43", 0 ]
				}
