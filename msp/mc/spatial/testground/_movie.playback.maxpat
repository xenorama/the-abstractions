...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 1525.333333333333485, 748.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1692.333333333333485, 564.0, 74.0, 22.0 ],
					"text" : "sig~ 294440",
...
,
					"patching_rect" : [ 1525.5, 688.0, 36.0, 22.0 ],
					"text" : "gen~",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1692.333333333333485, 526.0, 47.0, 22.0 ],
					"text" : "* 1000.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 1692.333333333333485, 637.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 1692.333333333333485, 602.0, 77.0, 22.0 ],
					"text" : "mstosamps~",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1507.0, 227.0, 287.0, 89.0 ],
					"presentation_linecount" : 6,
					"text" : "dispose, read /Users/Oni/Projekte/Xenorama/XEN_Cloud/XENcloud/22-09_SNJ_Schuetz-Novalis-Jahr-Weissenfels/SNJ_03_WORK/SNJ_03__OUT-VISUAL/SNJ_SCENE3+4_LP_02-animatic-mit-soundtimeline04-ab-f4800.mp4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1692.333333333333485, 500.0, 32.0, 22.0 ],
					"text" : "/ 25.",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1734.666666666666515, 500.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1719.333333333333485, 758.0, 50.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1650.0, 440.0, 76.0, 22.0 ],
					"text" : "s #0_vid.info",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1364.0, 281.0, 74.0, 22.0 ],
					"text" : "r #0_vid.info",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1650.0, 407.0, 125.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 1650.0, 375.0, 146.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1364.0, 407.0, 201.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1364.0, 343.0, 305.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1124.0, 343.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1124.0, 375.0, 49.0, 22.0 ],
					"text" : "jit.world",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 391.0, 64.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 287.0, 202.0, 300.0, 22.0 ],
									"text" : "mc.sfplay~ 2 @audiofile hag_pinao-outro.wav @loop 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 206.0, 100.0, 85.0, 22.0 ],
									"text" : "harmonic 1 47"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 98.0, 270.0, 130.0, 130.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 79.0, 100.0, 108.0, 22.0 ],
...
,
					"patching_rect" : [ 801.0, 189.0, 137.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 389.0, 386.0, 31.0, 22.0 ],
					"text" : "sig~",
					"textcolor" : [ 0.211765, 0.898039, 0.576471, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 477.0, 205.0, 185.0, 22.0 ],
					"text" : "buffer~ hag hag_pinao-outro.wav",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 389.0, 346.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "jit_matrix", "" ],
					"patching_rect" : [ 541.0, 82.0, 79.0, 22.0 ],
					"text" : "the.rgb.patch",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 706.0, 353.0, 29.5, 22.0 ],
					"text" : "==",
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.670588, 0.019608, 0.015686, 1.0 ],
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 706.0, 386.0, 42.0, 22.0 ],
					"text" : "mute~",
					"textcolor" : [ 0.178321, 0.753803, 0.484099, 1.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 391.0, 190.0, 159.0, 22.0 ],
									"text" : "mcs.groove~ hag 2 @loop 1"
								}
...
,
					"patching_rect" : [ 706.0, 432.0, 137.0, 22.0 ],
					"saved_object_attributes" : 					{
						"accentcolor" : [ 0.482352941176471, 0.454901960784314, 0.450980392156863, 1.0 ],
						"bgcolor" : [ 0.258823529411765, 0.235294117647059, 0.223529411764706, 1.0 ],
						"color" : [ 1.0, 0.9843137264, 0.870588243, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 706.0, 523.0, 164.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 527.0, 583.5, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 527.0, 523.0, 164.0, 22.0 ],
					"text" : "mc.mixdown~ 2 @autogain 1",
					"textcolor" : [ 0.92549, 0.996078, 0.121569, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 271.0, 523.0, 130.0, 130.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 271.0, 291.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 271.0, 392.0, 42.0, 22.0 ],
					"text" : "mute~",
					"textcolor" : [ 0.178321, 0.753803, 0.484099, 1.0 ]
				}
...
,
					"patching_rect" : [ 271.0, 437.0, 137.0, 22.0 ],
					"saved_object_attributes" : 					{
						"accentcolor" : [ 0.482352941176471, 0.454901960784314, 0.450980392156863, 1.0 ],
						"bgcolor" : [ 0.258823529411765, 0.235294117647059, 0.223529411764706, 1.0 ],
						"color" : [ 1.0, 0.9843137264, 0.870588243, 1.0 ],
