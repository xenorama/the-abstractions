...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 402.0, 276.0, 115.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									"code" : "val = in1;\r\nx = 0;\r\ny = 0;\r\nz = 0;\r\n\r\nif (cell.x > 2) {\r\n\t\r\n\tranges = absdiff(nearestpix(in1,vec(0,0)),nearestpix(in1,vec(2,0)));\r\n\tout1 = (cell.x == 3) ? ranges : ranges/2;\r\n\t\r\n\t}\r\n\t\r\nelse out1 = in1;",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 12.0,
									"id" : "obj-7",
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 28.0, 111.0, 656.0, 286.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 28.0, 433.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 145.0, 376.25, 41.0, 22.0 ],
					"text" : "jit.gen",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 145.0, 335.5, 276.0, 22.0 ],
					"text" : "jit.concat",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1027.0, 643.0, 63.0, 22.0 ],
					"text" : "jit.op @op",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 145.0, 276.0, 234.0, 22.0 ],
					"text" : "jit.matrix 3 float32 3 1 @adapt 0 @interp 0",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 131.0, 125.0, 22.0 ],
					"text" : "colwidth 125, plane -1"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"hcellcolor" : [ 1.0, 0.72156862745098, 0.72156862745098, 1.0 ],
					"hscroll" : 0,
					"id" : "obj-44",
					...
					"numoutlets" : 4,
					"outlettype" : [ "list", "", "", "" ],
					"patching_rect" : [ 38.0, 547.0, 601.0, 82.0 ],
					"rows" : 4,
					"vscroll" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 145.0, 178.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 145.0, 422.0, 167.0, 40.0 ],
					"sync" : 1
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									"code" : "get_diff(v,m,iters,op){\r\n\tdiff_vec = vec(0,0,0);\r\n\tdiff_single = 0;\r\n\tfor (w=0;w<iters;w+=1) {\r\n\t\tnew = swiz(v,w);\r\n\t\told = swiz(m,w);\r\n\t\tcalc = (op == 0) ? new < old : new > old;\r\n\t\tdiff = calc ? new : old;\r\n\t\tdiff_single = concat(diff_single,diff);\r\n\t\t}\r\n\treturn swiz(diff_single,vec(1,2,3));\r\n\t}\r\n\r\nParam iters(3); // == planecount\r\n\r\nmin = vec(999999,999999,999999);\r\nmean = vec(0,0,0);\r\nmax = mean;\r\n\r\nif (cell.x < 3 && cell.y < 1){\r\n\tfor(i=0; i<dim.x; i+=1){\r\n\t\tfor(j=0; j<dim.y; j+=1){\r\n\t\t\tval = nearest(in1, (vec(i, j) - 0.5) / dim);\r\n\t\t\tif (cell.x == 0) min = get_diff(val,min,iters,0);\r\n\t\t\telse if (cell.x == 2) max = get_diff(val,max,iters,1);\r\n\t\t\telse mean += (val.x + val.y + val.z);\r\n\t\t}\r\n\t}\r\n\tif (cell.x == 0) out1 = min;\r\n\telse if (cell.x == 1) out1 = mean / (dim.x * dim.y);\r\n\telse if (cell.x == 2) out1 = max;\r\n}\r\n",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 12.0,
									"id" : "obj-2",
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 34.0, 71.0, 679.0, 534.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 34.0, 25.0, 28.0, 22.0 ],
									"text" : "in 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 34.0, 640.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 145.0, 229.0, 167.0, 22.0 ],
					"text" : "jit.gen @t get_edges @iters 3",
					"textcolor" : [ 0.626967370510101, 0.0, 0.016032937914133, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1534.0, 229.0, 29.5, 22.0 ],
					"text" : "!- 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1361.0, 324.0, 260.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1534.0, 195.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "jit_matrix", "" ],
					"patching_rect" : [ 1375.0, 54.0, 79.0, 22.0 ],
					"text" : "the.rgb.patch",
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"hcellcolor" : [ 0.556862745098039, 0.72156862745098, 0.925490196078431, 1.0 ],
					"hscroll" : 0,
					"id" : "obj-30",
					"maxclass" : "jit.cellblock",
					"numinlets" : 2,
					"numoutlets" : 4,
					"outlettype" : [ "list", "", "", "" ],
					"patching_rect" : [ 700.0, 704.0, 264.0, 74.0 ],
					"rows" : 4,
					"vscroll" : 0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"hcellcolor" : [ 0.56078431372549, 0.890196078431372, 0.623529411764706, 1.0 ],
					"hscroll" : 0,
					"id" : "obj-31",
					"maxclass" : "jit.cellblock",
					"numinlets" : 2,
					"numoutlets" : 4,
					"outlettype" : [ "list", "", "", "" ],
					"patching_rect" : [ 700.0, 616.0, 264.0, 74.0 ],
					"rows" : 4,
					"vscroll" : 0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 700.0, 502.0, 141.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "list", "", "", "" ],
					"patching_rect" : [ 700.0, 530.0, 264.0, 74.0 ],
					"rows" : 4,
					"vscroll" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "list", "", "", "" ],
					"patching_rect" : [ 1300.0, 708.0, 264.0, 74.0 ],
					"rows" : 4,
					"vscroll" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "list", "", "", "" ],
					"patching_rect" : [ 1300.0, 620.0, 264.0, 74.0 ],
					"rows" : 4,
					"vscroll" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "jit_matrix", "jit_matrix", "jit_matrix", "" ],
					"patching_rect" : [ 1300.0, 502.0, 141.0, 22.0 ],
					"text" : "jit.unpack 3 @jump 1 1 1",
					"textcolor" : [ 0.994953811168671, 0.768245160579681, 0.630638062953949, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "list", "", "", "" ],
					"patching_rect" : [ 1300.0, 534.0, 264.0, 74.0 ],
					"rows" : 4,
					"vscroll" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1471.0, 195.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1201.0, 285.0, 29.5, 22.0 ],
					"text" : "* 2.",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1471.0, 390.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1201.0, 324.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1052.0, 242.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1201.0, 440.0, 289.0, 22.0 ],
					"text" : "jit.- @val 1. @outputmode 2",
					"textcolor" : [ 0.913725, 0.737255, 0.062745, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1201.0, 390.0, 268.0, 22.0 ],
					"text" : "jit.normalize @global 1 @amp 2 @outputmode 2",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1201.0, 502.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1170.0, 117.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1170.0, 73.0, 58.0, 22.0 ],
					"text" : "loadbang",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1052.0, 274.0, 126.0, 22.0 ],
					"text" : "setcell2d 1 1 $1 -1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1009.0, 314.0, 53.0, 22.0 ],
					"text" : "jit.matrix",
					"textcolor" : [ 0.649909, 0.112638, 0.040011, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1096.0, 390.0, 73.0, 22.0 ],
					"text" : "jit.normalize",
					"textcolor" : [ 0.180420845746994, 0.209700703620911, 0.336140930652618, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1096.0, 502.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1009.0, 502.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1170.0, 195.0, 203.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1009.0, 124.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1009.0, 158.0, 63.0, 22.0 ],
					"text" : "qmetro 22",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1170.0, 163.0, 123.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1210.5, 481.5, 1309.5, 481.5 ],
					"order" : 0,
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1480.5, 268.0, 1210.5, 268.0 ],
					"order" : 1,
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 1370.5, 367.5, 1210.5, 367.5 ],
					"order" : 1,
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"midpoints" : [ 1370.5, 424.5, 1210.5, 424.5 ],
					"order" : 0,
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1543.5, 287.0, 1370.5, 287.0 ],
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 154.5, 263.0, 411.5, 263.0 ],
					"order" : 0,
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 1018.5, 362.5, 1210.5, 362.5 ],
					"order" : 0,
					"source" : [ "obj-9", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1018.5, 405.5, 709.5, 405.5 ],
					"order" : 3,
					"source" : [ "obj-9", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 1018.5, 361.5, 1105.5, 361.5 ],
					"order" : 1,
					"source" : [ "obj-9", 0 ]
				}
