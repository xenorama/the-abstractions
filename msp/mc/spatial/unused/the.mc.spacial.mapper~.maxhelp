...
, 							{
								"box" : 								{
									...
									"id" : "obj-9",
									"ignoreclick" : 1,
									"jsarguments" : [ "the.mc.spacial.mapper~" ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
...
, 							{
								"box" : 								{
									...
									"text" : "the.mc.spacial.mapper~ @setup circle @dimensions 3 @ef_params 0 6000 2000 @eftomat 1 @max_dist 1.4"
								}
