...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 728.0, 519.0, 143.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 576.0, 162.0, 76.0, 22.0 ],
					"text" : "rate~ 0.0625",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 838.0, 127.0, 167.0, 22.0 ],
					"text" : "setdomain 1024, setrange 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 933.0, 113.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1122.0, 446.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 847.0, 171.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1096.0, 334.0, 54.0, 22.0 ],
					"text" : "lineout 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1051.0, 246.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1051.0, 206.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1115.0, 525.0, 29.5, 22.0 ],
					"text" : "f"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 863.0, 463.0, 29.5, 22.0 ],
					"text" : "t b f",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1044.0, 488.0, 64.0, 22.0 ],
					"text" : "uzi 1024 0",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 914.0, 641.0, 32.0, 22.0 ],
					"text" : "print",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 863.0, 234.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 784.0, 641.0, 121.0, 22.0 ],
					"text" : "0. 0.99877"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 927.0, 511.0, 72.0, 22.0 ],
					"text" : "mc.makelist",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 922.0, 181.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"chans" : 4,
					"data" : [ 						{
							"addpoints" : [ 0.0, 1.0, 0, 1024.0, 0.0, 0 ]
						}
, 						{
							"addpoints" : [ 0.0, 0.0, 0, 553.290322580645125, 0.421052631578947, 0, 1024.0, 1.0, 0 ]
						}
, 						{
...
, 						{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 863.0, 310.0, 136.0, 100.0 ],
					"style" : "default"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 635.0, 50.0, 197.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 509.0, 80.0, 42.0, 22.0 ],
					"text" : "60000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 458.0, 8.0, 71.0, 22.0 ],
					"text" : "normalize 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 140.0, 256.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.0, 290.0, 65.0, 22.0 ],
					"text" : "eftomat $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 329.666666666666629, 364.0, 129.333333333333371, 10.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "jit_matrix", "" ],
					"patching_rect" : [ 285.0, 668.0, 79.0, 22.0 ],
					"text" : "the.rgb.patch",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 708.0, 162.0, 63.0, 22.0 ],
					"text" : "rate~ 0.33",
					"textcolor" : [ 0.937255, 0.796078, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 574.0, 206.5, 132.0, 22.0 ],
					"text" : "wave~ curve @interp 0",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 520.0, 651.0, 56.0, 22.0 ],
					"text" : "listfunnel",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 520.0, 619.0, 81.0, 22.0 ],
					"text" : "zl 1024 group",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "int" ],
					"patching_rect" : [ 701.0, 551.0, 64.0, 22.0 ],
					"text" : "uzi 1024 0",
					"textcolor" : [ 0.937255, 0.764706, 0.301961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 0.0, 0, 179.744680851063833, 0.586666666666667, 0, 860.595744680851112, 0.773333333333333, 0, 1024.0, 1.0, 0 ],
					"domain" : 1024.0,
					"id" : "obj-21",
					"maxclass" : "function",
					"numinlets" : 1,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 520.0, 441.0, 200.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 285.0, 615.0, 184.0, 22.0 ],
					"text" : "buffer~ curve -1 8 @samps 1024",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 440.0, 248.5, 33.0, 22.0 ],
					"text" : "+~ 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 708.0, 250.75, 36.0, 22.0 ],
					"text" : "-~ 45",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 458.0, 80.0, 41.0, 22.0 ],
					"text" : "sig~ 1",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 458.0, 112.0, 135.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 458.0, 40.0, 130.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 574.0, 248.5, 44.0, 22.0 ],
					"text" : "*~ 360",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 708.0, 206.5, 44.0, 22.0 ],
					"text" : "*~ 135",
					"textcolor" : [ 0.275282, 0.960371, 0.999055, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 440.0, 295.0, 287.0, 22.0 ],
					"text" : "mc.pack~ 3",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 109.0, 332.0, 350.0, 22.0 ],
					"text" : "the.mc.spatial.mapper~ tkr @polar 1 @dimensions 2 @filter 0.4",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 109.0, 615.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 109.0, 433.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 109.0, 395.0, 236.0, 22.0 ],
					"text" : "the.speaker.setup~ tkr @setup wms.model",
					"textcolor" : [ 0.258823529411765, 0.235294117647059, 0.223529411764706, 1.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 583.5, 147.5, 717.5, 147.5 ],
					"order" : 0,
					"source" : [ "obj-14", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 467.5, 232.5, 118.5, 232.5 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 755.5, 583.0, 803.5, 583.0, 803.5, 430.0, 529.5, 430.0 ],
					"source" : [ "obj-22", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-23", 0 ],
					"midpoints" : [ 733.0, 595.5, 529.5, 595.5 ],
					"source" : [ "obj-22", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-43", 0 ],
					"midpoints" : [ 1098.5, 600.0, 1218.5, 600.0, 1218.5, 299.0, 872.5, 299.0 ],
					"source" : [ "obj-54", 2 ]
				}
