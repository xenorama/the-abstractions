...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 909.5, 499.0, 69.0, 22.0 ],
					"text" : "t #1 i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 941.5, 568.5, 36.5, 22.0 ],
					"text" : "<"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 925.5, 608.5, 51.0, 22.0 ],
					"text" : "zl group"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 909.5, 535.5, 51.0, 22.0 ],
					"text" : "uzi #1 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 286.0, 543.0, 50.0, 22.0 ],
					"text" : "mc.*~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 73.0, 628.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 73.0, 674.0, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 504.0, 333.0, 193.0, 22.0 ],
					"text" : "routepass multichannelsignal bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 708.333333333333485, 543.0, 79.0, 22.0 ],
					"text" : "qmetro"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 708.333333333333485, 499.0, 29.5, 22.0 ],
					"text" : "!="
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 800.0, 910.0, 288.0, 7.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 103.228632478633244, 912.0, 218.0, 7.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 800.0, 910.0, 288.0, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 103.228632478633244, 912.0, 218.0, 35.0 ],
					"text" : "int (0-100)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 835.0, 878.0, 218.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 138.228632478633244, 880.0, 218.0, 21.0 ],
					"text" : "CPU usage in per cent"
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.mc.bzmap~: (0-100) CPU-usage in percent when banged in rightmost inlet or when @interval is set to nonzero (ms)",
					"id" : "obj-38",
					"index" : 2,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 800.0, 875.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 800.0, 627.75, 77.0, 22.0 ],
					"text" : "adstatus cpu"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 800.0, 543.0, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 176.5, 499.0, 109.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 176.5, 459.5, 29.5, 22.0 ],
					"text" : "* 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 463.333333333333371, 543.0, 47.0, 22.0 ],
					"text" : "zl iter 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 545.0, 584.75, 67.0, 22.0 ],
					"text" : "prepend fill"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 545.000000000000114, 475.0, 36.0, 22.0 ],
					"text" : "== 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 73.0, 923.0, 288.0, 7.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 73.0, 923.0, 288.0, 35.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 108.0, 891.0, 218.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 123.228632478633244, 865.0, 218.0, 21.0 ],
					"text" : "multichannel signal of boolean values"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 504.0, 181.0, 257.0, 7.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 504.0, 146.0, 257.0, 35.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 27.357157732759333, 181.0, 428.376007080078125, 7.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 27.357157732759333, 146.0, 428.376007080078125, 35.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 538.0, 190.0, 252.0, 107.0 ],
					"presentation" : 1,
					"presentation_linecount" : 7,
					"presentation_rect" : [ 114.5, 459.0, 252.0, 107.0 ],
					"text" : "(list): set busymap state\n\nmessages:\n• map (list)\n• voice (list)\n• mute (int)\n• bang for cpu usage"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 27.357157732759333, 190.0, 457.309508933907352, 165.0 ],
					"presentation" : 1,
					"presentation_linecount" : 17,
					"presentation_rect" : [ 568.0, 90.0, 294.0, 251.0 ],
					"text" : "args:\n#1 (int) = maximum number of channels to host\n#2 (symbol) = busymapname\n\nattrs:\n@manual (bool) = when set to '1' will use an incomnig multichannelsignal as busymap\n@map (list) = apply busymap state as voice list of non-zeros\n@voice (list) = voice-index (zero-based) + busy state (0/1), multiples allowed\n@mute (int) = single non-zero value toggles mute for all voices (0 = busy)\n@threshold (float) = normalised value to exceed in buffer to turn voice busy\n@cpumonitor (int) = interval in ms to query cpu usage, 0 = no notification"
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.mc.bzmap~: (multichannelsignal) set voice busy state when @manual 1; (list) set voice busy states; (bang) query CPU-usage",
					"id" : "obj-6",
					"index" : 1,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 504.0, 192.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 8,
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 300.0, 443.5, 590.666666666666742, 22.0 ],
					"text" : "route manual map voice mute threshold cpumonitor int"
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.mc.bzmap~: (multichannelsignal) voice busymap as boolean indicators",
					"id" : "obj-17",
					"index" : 1,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 73.0, 888.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 112.0, 411.5, 63.0, 22.0 ],
					"text" : "unpack i s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 112.0, 543.0, 65.0, 22.0 ],
					"text" : "prepend hi"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 112.0, 499.0, 29.5, 22.0 ],
					"text" : "- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 112.0, 375.0, 207.0, 22.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 381.666666666666686, 543.0, 56.0, 22.0 ],
					"text" : "listfunnel"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 381.666666666666686, 627.75, 103.0, 22.0 ],
					"text" : "peek~ #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 112.0, 586.0, 89.0, 22.0 ],
					"text" : "mc.range~ #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 73.0, 725.5, 42.0, 22.0 ],
					"text" : "mc.>~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 545.0, 627.75, 175.0, 22.0 ],
					"text" : "buffer~ #2 @samps #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 112.0, 627.75, 125.0, 22.0 ],
					"text" : "mc.index~ #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 73.0, 806.88288289308548, 242.0, 22.0 ],
					"text" : "mc.sig~ 1 @bzname #2 @chans #1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 73.0, 767.0, 330.0, 22.0 ],
					"text" : "mc.noteallocator~ @direct 1 @voices #1 @name #2"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "provide a buffer-based named busymap",
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 636.166666666666742, 710.0, 105.5, 710.0 ],
					"source" : [ "obj-19", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 309.5, 491.25, 82.5, 491.25 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 717.833333333333485, 483.75, 777.833333333333485, 483.75 ],
					"order" : 0,
					"source" : [ "obj-19", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 799.5, 481.75, 919.0, 481.75 ],
					"source" : [ "obj-19", 6 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 0 ],
					"midpoints" : [ 687.5, 418.75, 309.5, 418.75 ],
					"source" : [ "obj-21", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 513.5, 405.0, 295.5, 405.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 600.5, 385.5, 809.5, 385.5 ],
					"source" : [ "obj-21", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 472.833333333333371, 594.0, 391.166666666666686, 594.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-22", 0 ],
					"midpoints" : [ 186.0, 526.5, 472.833333333333371, 526.5 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 295.5, 660.0, 160.5, 660.0 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"midpoints" : [ 717.833333333333485, 595.875, 809.5, 595.875 ],
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-16", 0 ],
					"midpoints" : [ 935.0, 683.5, 367.083333333333371, 683.5, 367.083333333333371, 532.0, 391.166666666666686, 532.0 ],
					"source" : [ "obj-66", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 554.500000000000114, 519.5, 326.5, 519.5 ],
					"order" : 1,
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 121.5, 446.0, 186.0, 446.0 ],
					"order" : 0,
					"source" : [ "obj-9", 0 ]
				}
