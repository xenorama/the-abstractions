...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 278.666666666666629, 99.0, 58.0, 22.0 ],
					"text" : "loadbang",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 278.666666666666629, 457.5, 62.0, 22.0 ],
					"text" : "mc.+~ 0.5",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 52.666666666666629, 410.5, 60.0, 22.0 ],
					"text" : "mc.*~ 0.5",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 52.666666666666629, 381.0, 81.0, 22.0 ],
					"text" : "mc.sah~ 0.75",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 52.666666666666629, 333.0, 121.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 594.0, 101.0, 79.0, 22.0 ],
					"text" : "the.rgb.patch",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 278.666666666666629, 131.0, 74.0, 22.0 ],
					"text" : "deviate 8 10"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 645.0, 374.0, 50.0, 22.0 ]
				}

			}
, 			{
				"box" : 				{
					"bgcolor" : [ 0.166965126991272, 0.189444616436958, 0.212612926959991, 1.0 ],
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 567.0, 442.5, 97.0, 22.0 ],
					"text" : "mc.maximum~ 1",
					"textcolor" : [ 0.733773767948151, 0.84550940990448, 0.521441698074341, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 278.666666666666629, 336.5, 62.0, 22.0 ],
					"text" : "mc.+~ 0.5",
					"textcolor" : [ 0.996023, 0.809997, 0.403347, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 278.666666666666629, 303.5, 60.0, 22.0 ],
					"text" : "mc.*~ 0.5",
					"textcolor" : [ 0.275282, 0.960371, 0.999055, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 348.166666666666629, 194.0, 94.0, 22.0 ],
					"text" : "deviate 128 256"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 348.166666666666629, 226.0, 114.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 278.666666666666629, 266.0, 158.0, 22.0 ],
					"text" : "the.mc.perlin~ 36 4 @sign 0",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 278.666666666666629, 374.0, 365.0, 22.0 ],
					"text" : "mc.separate~ 6 6 6 6 6 6",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 221.0, 501.0, 365.0, 22.0 ],
					"text" : "the.mc.yafr.s~",
					"textcolor" : [ 0.258823529411765, 0.235294117647059, 0.223529411764706, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 221.0, 202.0, 65.0, 22.0 ],
					"text" : "mc.dup~ 6",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 221.0, 735.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 221.0, 589.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 221.0, 130.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 221.0, 164.0, 258.0, 22.0 ],
...
, 			{
				...
				"bootpath" : "~/Documents/Max 8/Packages/the-abstractions/install_dependencies/attr_wrappers",
				"patcherrelativepath" : "../../../install_dependencies/attr_wrappers",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
