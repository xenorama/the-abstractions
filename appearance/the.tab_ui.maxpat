...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 838.0, 660.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
,
					"patching_rect" : [ 956.0, 847.0, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 956.0, 847.0, 128.0, 128.0 ],
					"varname" : "source",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 676.0, 654.0, 95.0, 22.0 ],
					"text" : "light light source"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 698.0, 783.0, 144.0, 147.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 698.0, 717.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 698.0, 686.0, 125.0, 22.0 ],
					"text" : "dictionary tab_objects"
				}
...
,
					...
					"patching_rect" : [ 698.0, 751.0, 154.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 461.5, 759.0, 50.0, 35.0 ],
					"text" : "bfg noise"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 492.5, 636.5, 59.0, 22.0 ],
					"text" : "dump, $1"
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 492.5, 673.0, 89.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"precision" : 6
					}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 621.5, 27.0, 24.0, 24.0 ]
				}

			}
, 			{
				"box" : 				{
					"attr" : "hide_patchers_by_tab",
					"id" : "obj-68",
					"maxclass" : "attrui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 621.5, 61.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 23.0, 924.0, 412.0, 117.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 142.523824896131373, 146.0, 412.0, 117.0 ],
					"varname" : "performance",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 78.0, 359.0, 70.0, 22.0 ],
					"text" : "loadmess 1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 204.0, 184.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 921.0, 148.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 921.0, 114.0, 100.0, 22.0 ],
					"text" : "loadmess 0",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 921.0, 184.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 859.0, 430.0, 184.0, 49.0 ],
					"text" : "gen @expr out1=fold(phasor(0.46)*2\\,0\\,1)*12+4 @active 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.25, 304.333337783813477, 36.0, 22.0 ],
					"text" : "defer",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 847.0, 346.0, 187.0, 49.0 ],
					"text" : "gen @expr out1=fold(phasor(0.56)*2\\,0\\,1)*32 @active 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 793.0, 591.0, 194.0, 49.0 ],
					"text" : "gen @expr out1=fold(phasor(0.7)*2\\,0\\,1)*15 @active 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 219.5, 616.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 621.5, 517.0, 24.0, 24.0 ]
				}

			}
, 			{
				"box" : 				{
					"attr" : "autoscale_height",
					"id" : "obj-2",
					"maxclass" : "attrui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 621.5, 551.0, 155.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 302.5, 61.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 302.5, 91.0, 155.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 77.0, 114.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 652.00001335144043, 351.333337783813477, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 652.00001335144043, 383.333337783813477, 155.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 691.5, 439.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 490.0, 78.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 691.5, 471.0, 155.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 838.0, 265.0, 132.0, 22.0 ],
					"text" : "preset default, bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 785.0, 216.0, 132.0, 22.0 ],
					"text" : "preset tapsrgb, bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 730.0, 91.0, 132.0, 22.0 ],
					"text" : "preset xenorama, bang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 96.666663467884064, 235.666670024394989, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 652.00001335144043, 272.333337783813477, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 652.00001335144043, 304.333337783813477, 155.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 764.0, 170.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 77.0, 146.0, 155.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 490.0, 110.0, 155.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 30.25, 126.0, 33.0, 42.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.25, 179.0, 35.0, 22.0 ],
					"text" : "$1, 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 30.25, 211.0, 55.0, 22.0 ],
					"text" : "filewatch",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.25, 466.0, 355.0, 22.0 ],
					"text" : "tabs performance light weblinks, rounded 12, line 3, style 0, 1"
				}
...
,
					"patching_rect" : [ 939.0, 698.0, 128.0, 128.0 ],
					"varname" : "dummypatch",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 230.0, 640.0, 89.0, 22.0 ],
					"text" : "storagewindow"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 168.0, 616.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 208.0, 664.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 297.0, 666.0, 166.0, 22.0 ],
					"text" : "dummy dummypatch::dummy"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 103.0, 527.0, 29.5, 22.0 ],
					"text" : "8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 89.0, 551.0, 29.5, 22.0 ],
					"text" : "4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 119.0, 592.0, 45.0, 22.0 ],
					"text" : "store 8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 119.0, 654.0, 73.0, 22.0 ],
					"saved_object_attributes" : 					{
						"client_rect" : [ 100, 100, 500, 600 ],
						"parameter_enable" : 0,
						"parameter_mappable" : 0,
						"storage_rect" : [ 32, 741, 632, 1041 ]
					}
,
					"text" : "pattrstorage",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 119.0, 698.0, 197.0, 22.0 ],
					"text" : "the.pattr.path.change",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 400.0, 114.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 4.0, 505.0, 200.0, 24.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 6.0, 505.0, 200.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 441.0, 192.0, 85.0, 22.0 ],
									"text" : "presentation 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 400.0, 242.0, 67.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 100.0, 272.0, 8.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 6.0, 7.0, 272.0, 8.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 100.0, 269.0, 34.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 6.0, 7.0, 269.0, 34.0 ],
									"text" : "light source"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 50.0, 139.0, 200.0, 24.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 6.0, 46.0, 200.0, 24.0 ]
								}
...
,
					"patching_rect" : [ 559.0, 832.0, 378.0, 324.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 142.523824896131373, 146.0, 412.0, 324.0 ],
					"varname" : "light",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 269.0, 123.0, 155.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 204.0, 123.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 204.0, 155.0, 155.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 204.0, 184.0, 527.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 625.0, 146.0, 99.0, 22.0 ],
					"text" : "1. 0.773 0.455 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 496.0, 146.0, 112.0, 22.0 ],
					"text" : "0.408 0.38 0.376 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 730.0, 123.0, 122.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 377.523824896131373, 832.0, 142.0, 322.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 138.523824896131373, 146.0, 142.0, 322.0 ],
					"varname" : "weblinks"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 544.0, 373.0, 56.0, 22.0 ],
...
, 			{
				"box" : 				{
					"border" : 0,
					"embedstate" : [ [ "dictionary", "tab_objects" ], [ "rounded", 12 ], [ "tab_width", 120 ], [ "tab_height", 50 ], [ "font_size", 14 ], [ "panel_alpha", 0.1 ], [ "style", 0 ], [ "tab_offset", 0 ], [ "line", 3 ], [ "tabs", "performance", "light", "weblinks" ], [ "hide_objs_by_tab", 1 ], [ "fontname", "Lato" ], [ "autoscale_height", 0 ] ],
					"filename" : "the.tab.js",
					"id" : "obj-1",
					"maxclass" : "jsui",
					"numinlets" : 2,
					...
					"outlettype" : [ "", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 219.5, 250.0, 565.0, 357.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.523824896131373, 128.0, 565.0, 358.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 128.5, 729.0, 105.0, 729.0, 105.0, 645.0, 128.5, 645.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-44::obj-598" : [ "cpu", "cpu", 0 ],
			"obj-44::obj-629" : [ "fps", "fps", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
...
, 			{
				"name" : "the.pattr.path.change.maxpat",
