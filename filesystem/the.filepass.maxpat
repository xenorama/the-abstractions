...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 30.0, 281.0, 141.0, 22.0 ],
					"text" : "zl 1 reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 268.75, 375.0, 55.0, 22.0 ],
					"text" : "strippath"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 397.75, 480.999991178512573, 110.0, 21.0 ],
					"text" : "full path: not found"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 268.75, 480.999991178512573, 54.0, 21.0 ],
					"text" : "filename"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 268.75, 443.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 166.75, 480.999991178512573, 52.0, 21.0 ],
					"text" : "path/"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.0, 482.999991178512573, 52.0, 21.0 ],
					"text" : "full path"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 397.75, 445.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 166.75, 443.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 148.0, 375.0, 94.0, 22.0 ],
					"text" : "regexp (.+\\\\/).+$"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.0, 445.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 30.0, 236.0, 74.0, 22.0 ],
					"text" : "sel notfound"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 193.0, 77.0, 22.0 ],
					"text" : "absolutepath"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 126.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-32",
					"ignoreclick" : 1,
					"jsarguments" : [ "the.filepass" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.523824896131373, 7.999991178512573, 424.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "check and pass a file path if valid"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 1 ],
					"midpoints" : [ 39.5, 177.0, 161.5, 177.0 ],
					"order" : 0,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 39.5, 415.0, 407.25, 415.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 94.5, 350.5, 278.25, 350.5 ],
					"order" : 0,
					"source" : [ "obj-4", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 94.5, 351.5, 157.5, 351.5 ],
					"order" : 1,
					"source" : [ "obj-4", 1 ]
				}
