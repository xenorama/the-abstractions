...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1023.400000000000091, 182.374984741210938, 129.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-51",
					"items" : [ "the.layouts.apply.js", ",", "the.obj.colors.json", ",", "the.object.aliases.json", ",", "the.rgb.layouts.json", ",", "the.single.obj.color.js" ],
					"maxclass" : "chooser",
					"multiselect" : 0,
					"numinlets" : 1,
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 997.0, 53.0, 151.0, 118.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 324.0, 437.0, 184.0, 22.0 ],
					"text" : "routepass grab purge_obj_colors",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1042.0, 621.6666259765625, 83.0, 22.0 ],
					"text" : "r #0_reload",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1042.0, 653.6666259765625, 61.0, 22.0 ],
					"text" : "reloaddict"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1023.400000000000091, 215.749969482421875, 129.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 153.0, 653.6666259765625, 95.0, 22.0 ],
					"style" : "No Style",
					"text" : "routepass grab",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 153.0, 593.6666259765625, 107.0, 22.0 ],
					"style" : "No Style",
					"text" : "r #0_rgb.patch",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.8333740234375, 478.0, 229.0, 35.0 ],
					"text" : "pack loadunique the.obj.colors.ui.maxpat #0 custom",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.8333740234375, 528.0, 55.0, 22.0 ],
					"style" : "No Style",
					"text" : "pcontrol",
					"textcolor" : [ 1.0, 0.984314, 0.870588, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-38", 0 ],
					"midpoints" : [ 162.5, 718.6666259765625, 494.5001220703125, 718.6666259765625 ],
					"source" : [ "obj-7", 0 ]
				}
...
,
		...
		"color" : [ 0.937255, 0.763913, 0.302615, 1.0 ],
		"textcolor" : [ 1.0, 0.984314, 0.870588, 1.0 ],
		"lightcolor" : [ 1.0, 0.984314, 0.870588, 1.0 ],
		"patchlinecolor" : [ 1.0, 0.984314, 0.870588, 0.741017 ],
