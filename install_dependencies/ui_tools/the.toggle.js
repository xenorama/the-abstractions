...
{ hover = 0; mgraphics.redraw(); }
onclick.local = 1;

function onresize(w,h)
{ hover = 0; box_meas(); forcesize(); mgraphics.redraw(); }
onresize.local = 1;
...
{ hover = 0; box_width = x-px; box_height = y-py; forcesize(); mgraphics.redraw(); }
p_resize.local = 1;
...
function msg_int(v) { val = v != 0; output(); }

function set(i){ val = i; notifyclients(); mgraphics.redraw(); }

function bang(){ val = 1-val; output(); }
