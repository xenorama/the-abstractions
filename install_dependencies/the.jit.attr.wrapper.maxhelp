...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 350.0, 104.0, 22.0 ],
					"text" : "the.jit.attr.wrapper"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 10.0, 243.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 226.0, 160.0, 146.0, 23.0 ],
									"text" : "patcherargs @scale 0.4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 213.0, 372.0, 50.0, 23.0 ],
									"text" : "done"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 533.75, 311.0, 172.0, 23.0 ],
									"text" : "jit.world unknown @visible 0"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 49.0, 160.0, 138.0, 21.0 ],
									"text" : "enter a renderer name"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 379.5, 243.0, 236.5, 36.0 ],
									"text" : "@pass 1 passes on filtered messages to rightmost outlet (next object) as well"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 281.0, 210.0, 50.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 281.0, 243.0, 56.0, 23.0 ],
									"text" : "other $1"
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-15",
									"ignoreclick" : 1,
									"jsarguments" : [ "the.jit.attr.wrapper" ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 269.0, 311.0, 185.978515625, 39.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 630.0, 425.0, 88.0, 54.0 ],
									"text" : "all other attributes/messages"
								}
...
, 							{
								"box" : 								{
									...
									"orientation" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 316.5, 425.0, 119.0, 46.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 49.0, 183.0, 100.0, 51.0 ],
									"text" : "unknown"
								}
...
, 							{
								"box" : 								{
									...
									"orientation" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 349.0, 120.0, 46.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"fontsize" : 12.0,
									"id" : "obj-17",
									"items" : [ "anything", ",", "compile", ",", "exportcode", ",", "full_source_code", ",", "getparamdefault", ",", "getparamdescription", ",", "getparamlist", ",", "getparamtype", ",", "getparamval", ",", "open", ",", "param", ",", "sendinput", ",", "sendoutput", ",", "sendshader", ",", "wclose", ",", "bang", ",", "draw", ",", "drawimmediate", ",", "drawraw", ",", "exportattrs", ",", "exportsummary", ",", "getattributes", ",", "getstate", ",", "importattrs", ",", "jit_gl_texture", ",", "jit_matrix", ",", "summary", ",", "activeinput", ",", "label", ",", "adapt", ",", "basic", ",", "default", ",", "style", ",", "colormode", ",", "enumvals", ",", "depth", ",", "invisible", ",", "obsolete", ",", "dim", ",", "dimscale", ",", "dirty", ",", "displaylist", ",", "edges", ",", "exportfolder", ",", "category", ",", "file", ",", "gen", ",", "inputs", ",", "out_name", ",", "outputs", ",", "introduced", ",", "rect", ",", "rectangle", ",", "thru", ",", "shape", ",", "subdiv", ",", "t", ",", "texrect", ",", "title", ",", "type", ",", "wrap", ",", "antialias", ",", "automatic", ",", "aux_color", ",", "blend", ",", "blend_enable", ",", "blend_mode", ",", "capture", ",", "depth_clear", ",", "depth_enable", ",", "depth_write", ",", "dest_dim", ",", "drawto", ",", "enable", ",", "gl_color", ",", "layer", ",", "material", ",", "name", ",", "shader", ",", "smooth_shading", ",", "tex_map", ",", "tex_plane_s", ",", "tex_plane_t", ",", "texanchor", ",", "texrotate", ",", "texture", ",", "texzoom", ",", "getactiveinput", ",", "getlabel", ",", "getadapt", ",", "getbasic", ",", "getdefault", ",", "getstyle", ",", "getcolormode", ",", "getenumvals", ",", "getdepth", ",", "getinvisible", ",", "getobsolete", ",", "getdim", ",", "getdimscale", ",", "getdirty", ",", "getdisplaylist", ",", "getedges", ",", "getexportfolder", ",", "getcategory", ",", "getfile", ",", "getgen", ",", "getinputs", ",", "getout_name", ",", "getoutputs", ",", "getintroduced", ",", "getrect", ",", "getrectangle", ",", "getthru", ",", "getshape", ",", "getsubdiv", ",", "gett", ",", "gettexrect", ",", "gettitle", ",", "gettype", ",", "getwrap", ",", "getantialias", ",", "getautomatic", ",", "getaux_color", ",", "getblend", ",", "getblend_enable", ",", "getblend_mode", ",", "getcapture", ",", "getdepth_clear", ",", "getdepth_enable", ",", "getdepth_write", ",", "getdest_dim", ",", "getdrawto", ",", "getenable", ",", "getgl_color", ",", "getlayer", ",", "getmaterial", ",", "getname", ",", "getshader", ",", "getsmooth_shading", ",", "gettex_map", ",", "gettex_plane_s", ",", "gettex_plane_t", ",", "gettexanchor", ",", "gettexrotate", ",", "gettexture", ",", "gettexzoom" ],
									"maxclass" : "chooser",
									"multiselect" : 0,
									"numinlets" : 1,
									"numoutlets" : 6,
									"outlettype" : [ "", "", "", "", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 146.5, 425.0, 144.0, 203.0 ]
								}
...
, 							{
								"box" : 								{
									"id" : "obj-16",
									"items" : [ "anything", ",", "compile", ",", "destroy", ",", "open", ",", "param", ",", "wclose", ",", "bang", ",", "clear", ",", "exportattrs", ",", "exportsummary", ",", "getattributes", ",", "getstate", ",", "importattrs", ",", "jit_matrix", ",", "outputmatrix", ",", "summary", ",", "dirty", ",", "gen", ",", "default", ",", "label", ",", "precision", ",", "enumvals", ",", "style", ",", "t", ",", "title", ",", "outputmode", ",", "adapt", ",", "out_name", ",", "type", ",", "dim", ",", "planecount", ",", "getdirty", ",", "getgen", ",", "getdefault", ",", "getlabel", ",", "getprecision", ",", "getenumvals", ",", "getstyle", ",", "gett", ",", "gettitle", ",", "getoutputmode", ",", "getadapt", ",", "getout_name", ",", "gettype", ",", "getdim", ",", "getplanecount" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 494.0, 504.0, 100.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 545.0, 439.0, 77.0, 23.0 ],
									"text" : "done"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 163.0, 211.0, 50.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 163.0, 243.0, 95.0, 23.0 ],
									"text" : "outputmode $1"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 113.0, 60.0, 94.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 60.0, 45.0, 22.0 ],
													"text" : "* scale"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 50.0, 106.0, 35.0, 22.0 ],
													"text" : "out 1"
												}
...
,
									"patching_rect" : [ 385.0, 504.0, 107.0, 23.0 ],
									"text" : "jit.pix @scale 0.2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "jit_matrix", "", "" ],
									"patching_rect" : [ 385.0, 372.0, 237.0, 38.0 ],
									"text" : "the.jit.attr.wrapper jit.pix @pass 0 @custom scale",
									"varname" : "the.jit.attr.wrapper"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 49.0, 243.0, 66.0, 23.0 ],
									"text" : "drawto $2"
								}
...
,
									"patching_rect" : [ 49.0, 425.0, 52.0, 23.0 ],
									"text" : "jit.gl.pix"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "jit_gl_texture", "", "" ],
									"patching_rect" : [ 49.0, 311.0, 214.0, 23.0 ],
									"text" : "the.jit.attr.wrapper jit.gl.pix @pass 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 501.5, 10.0, 242.0, 38.0 ],
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									"destination" : [ "obj-4", 0 ],
									"midpoints" : [ 24.5, 409.0, 58.5, 409.0 ],
									"source" : [ "obj-1", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-7", 0 ],
									"midpoints" : [ 172.5, 288.0, 58.5, 288.0 ],
									"source" : [ "obj-13", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-7", 0 ],
									"midpoints" : [ 362.5, 288.5, 58.5, 288.5 ],
									"source" : [ "obj-18", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-7", 0 ],
									"midpoints" : [ 290.5, 288.0, 58.5, 288.0 ],
									"source" : [ "obj-19", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-7", 0 ],
									"midpoints" : [ 19.5, 289.5, 58.5, 289.5 ],
									"source" : [ "obj-20", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 326.0, 489.0, 394.5, 489.0 ],
									"source" : [ "obj-28", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-3", 0 ],
									"midpoints" : [ 253.5, 360.5, 394.5, 360.5 ],
									"order" : 0,
									"source" : [ "obj-7", 2 ]
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 396.34405517578125, 57.599853515625 ]
				}
