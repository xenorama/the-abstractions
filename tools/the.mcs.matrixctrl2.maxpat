...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 658.164950013160706, 645.76288890838623, 29.5, 22.0 ],
					"text" : "1n"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 485.0, 966.0, 97.0, 22.0 ],
					"text" : "deviate 5 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 62.0, 953.0, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 608.0, 387.0, 61.0, 22.0 ],
					"text" : "chans 8 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 394.0, 1341.0, 125.0, 22.0 ],
					"text" : "loadmess rawfloat 0.6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 419.0, 982.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 616.0, 582.0, 61.0, 22.0 ],
					"text" : "dspstate~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 707.5, 649.886600017547607, 29.5, 22.0 ],
					"text" : "8n"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 633.0, 1073.0, 116.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 688.0, 954.5, 42.0, 22.0 ],
					"text" : "t 0.5 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 616.0, 859.0, 29.5, 22.0 ],
					"text" : "0 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 611.0, 949.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 688.0, 1004.0, 149.0, 22.0 ],
					"text" : "expr random(45\\,100)*0.01"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 616.0, 661.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 616.0, 821.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 616.0, 789.0, 121.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 649.0, 719.0, 56.0, 22.0 ],
					"text" : "metro 8n"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 490.0, 895.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 301.0, 1409.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 301.0, 1240.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 301.0, 1204.0, 164.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 419.0, 1014.0, 85.0, 22.0 ],
					"text" : "harmonic 1 70"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 419.0, 1046.0, 120.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 509.0, 443.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 509.0, 475.0, 131.0, 22.0 ],
					"text" : "randomize $1 0.1 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 469.0, 475.0, 29.5, 22.0 ],
					"text" : "init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 426.0, 475.0, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 515.0, 189.0, 61.0, 22.0 ],
					"text" : "chans 2 4"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 173.0, 155.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 173.0, 121.0, 200.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					"border" : 0,
					"embedstate" : [ [ "oncolor", "color" ], [ "outline", 0 ], [ "blob_size", 0.67 ], [ "multi_line", 0 ], [ "orientation", 1 ], [ "offcolor", "elementcolor" ], [ "off_alpha", 0.66 ], [ "textcolor", "bgcolor" ], [ "width", 43 ], [ "justification", 0 ], [ "layout", 1 ], [ "hovercolor", "accentcolor" ], [ "fontsize", 12 ], [ "bg_alpha", 0.24 ], [ "fontname", "Lato" ], [ "bg_width", 0 ] ],
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 853.0, 369.0, 64.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 714.0, 481.0, 40.0, 22.0 ],
					"restore" : [ "dictionary", "albuin" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 665.0, 70.0, 246.0, 22.0 ],
					"text" : "replace inputs::2::maps 0 0 0 0 0 0 0, bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 665.0, 11.0, 263.0, 22.0 ],
					"text" : "replace inputs::3::maps 0 1 0 0.5 0 0 0.66, bang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 875.0, 219.0, 100.0, 40.0 ],
					"pattrstorage" : "matrixctrl_presets"
				}

			}
, 			{
				"box" : 				{
					"autorestore" : "matrixctrl_presets.json",
					"id" : "obj-33",
					"linecount" : 3,
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 875.0, 154.0, 97.0, 49.0 ],
					"saved_object_attributes" : 					{
...
,
					"text" : "pattrstorage matrixctrl_presets @savemode 2",
					"varname" : "matrixctrl_presets"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 804.0, 112.0, 40.0, 22.0 ],
					"restore" : [ 						{
							"num_ins" : 7,
							"num_outs" : 7,
							"inputs" : 							{
...
,
								"4" : 								{
									"maps" : [ 0, 0, 0, 0, 0.798942912269768, 0, 0 ],
									"enabled" : 1
								}
,
								"5" : 								{
...
,
								"4" : 								{
									"enabled" : 1,
									"maps" : [ 0, 0, 0, 0, 0.798942912269768, 0 ]
								}
,
								"5" : 								{
									"enabled" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 646.0, 43.999991178512573, 252.0, 22.0 ],
					"text" : "replace num_ins 3, replace num_outs 5, bang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 603.0, 42.999991178512573, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 294.0, 838.0, 50.5, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "dictionary", "", "", "" ],
					"patching_rect" : [ 603.0, 128.0, 125.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "dictionary", "", "", "" ],
					"patching_rect" : [ 294.0, 873.0, 125.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "dictionary", "", "", "" ],
					"patching_rect" : [ 721.0, 155.0, 50.5, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 721.0, 109.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 636.0, 232.0, 208.0, 22.0 ],
					"text" : "dictionary u927011369"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 494.0, 96.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 494.0, 128.0, 67.0, 22.0 ],
					"text" : "chans $1 7"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 389.0, 789.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 711.0, 406.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.0, 994.0, 82.0, 22.0 ],
					"text" : "applyvalues 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 117.0, 1204.0, 130.0, 130.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 71.0, 1026.0, 108.0, 22.0 ],
					"text" : "mc.sig~ @chans 9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 117.0, 1118.0, 94.0, 22.0 ],
					"text" : "mcs.matrix~ 9 7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 371.0, 209.0, 39.0, 22.0 ],
					"text" : "purge"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 254.0, 873.0, 35.0, 22.0 ],
					"text" : "2 3 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 307.0, 177.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 307.0, 209.0, 57.0, 22.0 ],
					"text" : "chans $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 427.0, 209.0, 51.0, 22.0 ],
					"text" : "chans 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 537.0, 255.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 537.0, 287.0, 83.0, 22.0 ],
					"text" : "remap 7 3 $1"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 214.0, 934.0, 114.0, 114.0 ],
					"rows" : 7
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 149.0, 922.0, 50.0, 22.0 ],
					"text" : "6 6 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 163.0, 232.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 99.0, 751.0, 100.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 255.0, 208.0, 22.0 ],
					"text" : "dictionary u192007274"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 636.0, 287.0, 208.0, 22.0 ],
					"text" : "dictionary albuin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 327.0, 301.0, 83.0, 22.0 ],
					"text" : "dictionary fool"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 778.0, 596.0, 369.0, 353.0 ]
				}
...
, 			{
				"box" : 				{
					"border" : 0,
					"embedstate" : [ [ "align", 0 ] ],
					"filename" : "the.mcs.matrixctrl.js",
					"id" : "obj-1",
					"jsarguments" : [ "albuin" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 255.0, 539.0, 304.0, 190.618555545806885 ],
					"varname" : "jsui"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.523824896131373, 7.999991178512573, 462.0, 116.0 ]
				}
