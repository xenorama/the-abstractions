...
, 			{
				"box" : 				{
					...
					"color" : [ 0.462745098039216, 0.258823529411765, 0.305882352941176, 1.0 ],
					"id" : "obj-33",
					"linecount" : 3,
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 875.0, 154.0, 86.0, 49.0 ],
...
,
					"text" : "pattrstorage matrixctrl @savemode 2",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 328.0, 628.0, 50.5, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "dictionary", "", "", "" ],
					"patching_rect" : [ 328.0, 663.0, 125.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 423.0, 579.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 784.0, 82.0, 22.0 ],
					"text" : "applyvalues 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 151.0, 994.0, 130.0, 130.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 105.0, 816.0, 108.0, 22.0 ],
					"text" : "mc.sig~ @chans 9",
					"textcolor" : [ 1.0, 0.803921568627451, 0.541176470588235, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 151.0, 908.0, 94.0, 22.0 ],
					"text" : "mcs.matrix~ 9 9",
					"textcolor" : [ 1.0, 0.803921568627451, 0.541176470588235, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 288.0, 663.0, 35.0, 22.0 ],
					"text" : "2 3 1"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 248.0, 724.0, 114.0, 114.0 ],
					"rows" : 7
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 183.0, 712.0, 50.0, 22.0 ],
					"text" : "6 6 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 151.0, 550.0, 100.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 542.0, 605.0, 369.0, 353.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 327.0, 351.0, 234.0, 136.0 ]
				}
