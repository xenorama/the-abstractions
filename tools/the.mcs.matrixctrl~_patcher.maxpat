...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 579.0, 74.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 60.0, 74.0, 163.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 276.5, 16.0, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 430.0, 74.0, 88.0, 22.0 ],
					"text" : "prepend chans"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 430.0, 42.0, 72.0, 22.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 442.0, 510.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 573.0, 514.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 650.0, 177.0, 34.0, 34.0 ],
					"rows" : 2,
					"varname" : "matrixctrl"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 509.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 60.0, 418.0, 190.0, 22.0 ],
					"text" : "mcs.matrix~ 2 2 @ramp 0",
					"varname" : "mcs.matrix~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 276.5, 74.0, 88.0, 22.0 ],
					"restore" : [ 						{
							"inputs" : 							{
								"2" : 								{
									"enabled" : 1,
...
,
								"3" : 								{
									"enabled" : 1,
									"maps" : [ "<undefined>", "<undefined>", "<undefined>" ],
									"gain" : 1
								}
,
								"0" : 								{
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 276.5, 42.0, 107.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					"border" : 0,
					"embedstate" : [ [ "scale_patchcord_alpha", 1 ], [ "outputs_always_active", 1 ], [ "max_patchcord_size", 0.67 ], [ "autogain", 1 ], [ "mix", 0 ], [ "jit_matrix_adapt", 1 ], [ "patchcord_style", 1 ], [ "align", 0 ], [ "scale_patchcord_size", 1 ] ],
					"filename" : "the.mcs.matrixctrl.js",
					"id" : "obj-16",
					"jsarguments" : [ "#0_routings" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 311.0, 177.0, 281.0, 166.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 281.0, 166.0 ],
					"varname" : "jsui"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 213.5, 136.0, 320.5, 136.0 ],
					"source" : [ "obj-10", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-16", 0 ],
					"midpoints" : [ 439.5, 136.0, 320.5, 136.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-16", 0 ],
					"midpoints" : [ 588.5, 136.0, 320.5, 136.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 320.5, 380.0, 69.5, 380.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 451.5, 381.0, 625.5, 381.0, 625.5, 160.0, 659.5, 160.0 ],
					"order" : 0,
					"source" : [ "obj-16", 1 ]
				}
