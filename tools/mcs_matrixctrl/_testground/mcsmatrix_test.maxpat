...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 396.5, 701.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 396.5, 555.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 607.0, 377.0, 100.0, 40.0 ],
					"pattrstorage" : "mcsmatrixtest"
				}

			}
, 			{
				"box" : 				{
					"autorestore" : "mcsmatrixtest.json",
					"id" : "obj-3",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 607.0, 338.0, 231.0, 22.0 ],
...
,
					"text" : "pattrstorage mcsmatrixtest @savemode 2",
					"varname" : "mcsmatrixtest"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 471.0, 260.0, 67.0, 22.0 ],
					"text" : "chans 10 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 385.0, 260.0, 71.0, 22.0 ],
					"text" : "init"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 529.0, 192.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 366.0, 96.0, 61.0, 22.0 ],
					"text" : "dspstate~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 366.0, 128.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 366.0, 160.0, 85.0, 22.0 ],
					"text" : "harmonic 1 90"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 366.0, 192.0, 126.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 594.0, 130.0, 130.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 225.0, 192.0, 125.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"lockedsize" : 0,
					"maxclass" : "bpatcher",
					"name" : "the.mcs.matrixctrl~.maxpat",
					"numinlets" : 1,
					"numoutlets" : 3,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "multichannelsignal", "", "" ],
					"patching_rect" : [ 225.0, 323.0, 299.0, 185.0 ],
					"varname" : "the.mcs.matrixctrl~",
					"viewvisibility" : 1
				}
