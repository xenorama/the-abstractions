...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 685.0, 348.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 565.0, 283.5, 75.0, 22.0 ],
					"text" : "route unique",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 468.0, 251.5, 116.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 615.0, 200.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"color" : [ 0.495701611042023, 0.888011813163757, 0.655858397483826, 1.0 ],
					"id" : "obj-26",
					"linecount" : 2,
					"maxclass" : "newobj",
					"numinlets" : 2,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 615.0, 232.0, 202.0, 35.0 ],
					"text" : "livid.cntrlr.btn.group 16-23 @midi 1 32",
					"textcolor" : [ 0.931169152259827, 0.439943850040436, 0.558998107910156, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 645.0, 155.0, 79.0, 22.0 ],
					"text" : "the.rgb.patch",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 685.0, 388.0, 166.0, 22.0 ],
					"text" : "jit.gl.node @lighting_enable 1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 151.0, 609.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 633.0, 609.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 633.0, 641.0, 228.0, 22.0 ],
					"text" : "jit.gl.gridshape @scale 0.6 @shape torus",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 151.0, 641.0, 457.0, 22.0 ],
					"text" : "jit.gl.gridshape @scale 0.3 @position -0.5 0 0 @shape cylinder @rotatexyz 45 45 45",
					"textcolor" : [ 0.777871251106262, 0.62992262840271, 0.814014732837677, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 468.0, 81.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 396.0, 115.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 396.0, 147.0, 61.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 524.0, 147.0, 44.0, 22.0 ],
					"text" : "unsolo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 468.0, 147.0, 47.0, 22.0 ],
					"text" : "solo $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 468.0, 344.0, 186.0, 157.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 468.0, 212.0, 107.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "the.gl.selector.js",
						"parameter_enable" : 0
					}
,
					"text" : "js the.gl.selector.js",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 151.0, 518.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 379.0, 518.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 379.0, 550.0, 227.0, 22.0 ],
					"text" : "jit.gl.gridshape @scale 0.3 @shape cube",
					"textcolor" : [ 0.777871251106262, 0.62992262840271, 0.814014732837677, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 151.0, 550.0, 149.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 115.0, 245.0, 111.0, 22.0 ],
...
, 			{
				"name" : "livid.cntrlr.btn.group.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/the-abstractions/midi/livid",
				"patcherrelativepath" : "../../midi/livid",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "livid.cntrlr.button.group.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/the-abstractions/midi/livid",
				"patcherrelativepath" : "../../midi/livid",
				"type" : "JSON",
				"implicit" : 1
...
, 			{
				"name" : "the.gl.selector.js",
				"bootpath" : "~/Documents/Max 8/Packages/the-abstractions/jitter/js",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
