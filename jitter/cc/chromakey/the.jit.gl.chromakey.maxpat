...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 882.0, 417.0, 66.0, 22.0 ],
					"text" : "route done"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 492.0, 382.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 346.0, 294.0, 141.0, 22.0 ],
					"text" : "route mode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 346.0, 417.0, 87.0, 22.0 ],
					"text" : "clear, $1 $2 $3"
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 346.0, 377.0, 89.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 346.0, 467.0, 169.0, 22.0 ],
					"text" : "router 2 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 929.0, 492.0, 139.0, 22.0 ],
					"text" : "print the.jit.gl.chromakey"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 929.0, 457.0, 171.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 664.0, 417.0, 133.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 346.0, 503.0, 337.0, 22.0 ],
...
, 			{
				"box" : 				{
					"comment" : "the.jit.gl.chromakey: (jit_gl_texture) replace alpha",
					"id" : "obj-1",
					"index" : 2,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 664.0, 162.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"orientation" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 694.0, 305.0, 213.5, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 191.0, 202.0, 65.0, 22.0 ],
					"text" : "zl 3 slice 3"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 468.0, 417.0, 171.0, 22.0 ],
					"text" : "jit.gl.pix @gen the.chromamap"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 468.0, 327.0, 198.0, 22.0 ],
					"text" : "the.jit.attr.wrapper jit.gl.pix @pass 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 191.0, 162.0, 376.0, 22.0 ],
					"text" : "patcherargs 0 0 0 @tolerance 1 @opacity 0 @luminance 0 @mode 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 100.0, 262.0, 265.0, 22.0 ],
					"text" : "routepass rgb tolerance opacity luminance"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 47.0, 202.0, 71.5, 22.0 ],
					"text" : "typeroute~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 543.5, 597.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 346.0, 592.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.jit.gl.chromakey: (anything) jit_gl_texture to be chroma-mapped, patcher attributes",
					"id" : "obj-8",
					"index" : 1,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 47.0, 162.0, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 703.5, 367.0, 477.5, 367.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 455.5, 557.5, 355.5, 557.5 ],
					"source" : [ "obj-12", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"midpoints" : [ 405.5, 557.5, 355.5, 557.5 ],
					"source" : [ "obj-12", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 294.0, 367.0, 477.5, 367.0 ],
					"source" : [ "obj-25", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 232.5, 367.0, 477.5, 367.0 ],
					"source" : [ "obj-25", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 171.0, 367.0, 477.5, 367.0 ],
					"source" : [ "obj-25", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 109.5, 367.0, 477.5, 367.0 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"midpoints" : [ 557.5, 236.5, 109.5, 236.5 ],
					"source" : [ "obj-26", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"midpoints" : [ 355.5, 557.5, 355.5, 557.5 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 656.5, 387.5, 891.5, 387.5 ],
					"source" : [ "obj-4", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 200.5, 252.5, 703.5, 252.5 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 553.5, 452.5, 505.5, 452.5 ],
					"order" : 1,
					"source" : [ "obj-7", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 477.5, 452.5, 430.5, 452.5 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 553.5, 458.5, 553.0, 458.5 ],
					"order" : 0,
					"source" : [ "obj-7", 1 ]
				}
