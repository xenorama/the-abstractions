...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 147.0, 521.0, 29.5, 22.0 ],
					"text" : "!- 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 147.0, 553.0, 183.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 72.0, 729.0, 128.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 278.0, 314.0, 227.333333333333314, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 71.5, 665.0, 111.0, 49.0 ],
					"text" : "xray.jit.quicksort @recursions 0 @summode 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 119.0, 349.0, 150.0, 22.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 367.0, 14.0, 28.0, 22.0 ],
									"text" : "in 2",
									"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									"code" : "Param replace(-1);\r\n\r\nif (in2.x == -1) out1 = replace;\r\nelse out1 = in1;",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 12.0,
									"id" : "obj-3",
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 58.0, 336.0, 143.0 ]
								}
...
,
					"patching_rect" : [ 71.5, 553.0, 66.0, 22.0 ],
					"text" : "jit.gen",
...
, 							{
								"box" : 								{
									"code" : "Param tolerance(0.00001);\r\n\r\nval = in1;\r\nvalid = 1;\r\n\r\nif (dim.y == 0) {\r\nfor(v=0;v<cell.x;v+=1){\r\n\tc = nearestpix(in1,vec(v,cell.y));\r\n\tif (!length(absdiff(c,val))) {\r\n\t\tvalid = 0;\r\n\t\tbreak;\r\n\t\t}\r\n\t}\r\n}\r\nelse if (dim.y > 0) {\r\n\tcount = cell.y*dim.x+cell.x;\r\n\trow = floor(count / dim.x);\r\n\tcolumn = count % dim.x;\r\n\tfor (v=0;v<count;v+=1){\r\n\t\trow = floor(v / dim.x);\r\n\t\tcolumn = v % dim.x;\r\n\t\tc = nearestpix(in1,vec(column,row));\r\n\t\tif (length(absdiff(c,val)) < tolerance) {\r\n\t\t\tvalid = -1;\r\n\t\t\tbreak;\r\n\t\t}\r\n\t}\r\n}\r\n\r\nout1 = valid;",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 12.0,
									"id" : "obj-3",
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 79.0, 546.0, 523.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 639.0, 130.0, 22.0 ],
									"text" : "out 1 xray.jit.cellcoords",
									"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
								}
...
,
					"patching_rect" : [ 118.5, 458.0, 146.0, 22.0 ],
					"text" : "jit.gen @t filter_duplicates",
					"textcolor" : [ 0.626967370510101, 0.0, 0.016032937914133, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 72.0, 381.0, 225.0, 22.0 ],
					"text" : "gate 2 2",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 215.666666666666686, 211.0, 289.666666666666629, 22.0 ],
					"text" : "route mode replace sort tolerance done",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 107.666666666666686, 154.999991178512573, 360.0, 22.0 ],
					"text" : "patcherargs @mode 0 @replace -1 @sort 0 @tolerance 0.000001",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 378.066666666666663, 381.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 558.0, 783.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 592.0, 553.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 278.0, 783.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 278.0, 263.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 278.0, 594.0, 119.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 378.066666666666663, 553.0, 100.0, 22.0 ],
...
,
					"patching_rect" : [ 378.066666666666663, 458.0, 146.0, 22.0 ],
					"text" : "jit.gen @t filter_duplicates",
					"textcolor" : [ 0.626967370510101, 0.0, 0.016032937914133, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.523824896131373, 7.999991178512573, 513.0, 116.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 387.566666666666663, 430.0, 128.0, 430.0 ],
					"order" : 1,
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 458.166666666666686, 193.499995589256287, 225.166666666666686, 193.499995589256287 ],
					"source" : [ "obj-16", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 225.166666666666686, 243.5, 81.5, 243.5 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 279.300000000000011, 253.5, 128.5, 253.5 ],
					"source" : [ "obj-17", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 333.433333333333337, 510.5, 156.5, 510.5 ],
					"source" : [ "obj-17", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"midpoints" : [ 81.5, 430.0, 128.0, 430.0 ],
					"order" : 0,
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 287.5, 430.0, 387.566666666666663, 430.0 ],
					"order" : 0,
					"source" : [ "obj-18", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 128.0, 495.5, 601.5, 495.5 ],
					"order" : 0,
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"midpoints" : [ 495.833333333333314, 346.0, 522.333333333333371, 346.0, 522.333333333333371, 200.0, 225.166666666666686, 200.0 ],
					"source" : [ "obj-26", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 287.5, 347.5, 287.5, 347.5 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 81.5, 768.0, 287.5, 768.0 ],
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-24", 0 ],
					"midpoints" : [ 156.5, 584.0, 81.0, 584.0 ],
					"order" : 1,
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-31", 0 ],
					"midpoints" : [ 156.5, 584.0, 81.5, 584.0 ],
					"order" : 0,
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-24", 0 ],
					"midpoints" : [ 287.5, 640.0, 81.0, 640.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 387.566666666666663, 495.5, 567.5, 495.5 ],
					"order" : 1,
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 387.566666666666663, 495.5, 601.5, 495.5 ],
					"order" : 0,
					"source" : [ "obj-8", 0 ]
				}
