...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 233.0, 200.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1334.0, 688.0, 313.181818181818244, 265.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1405.0, 395.0, 313.181818181818244, 265.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 919.0, 260.0, 245.0, 22.0 ],
					"presentation_linecount" : 3,
					"text" : "jit.gl.pix @gen the.normalmap @type float32"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 755.0, 226.0, 325.0, 22.0 ],
					"text" : "jit.gl.texture @flip 0 @dim 256 256 @adapt 0 @type float32"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1074.0, 395.0, 313.181818181818244, 265.0 ],
					"sync" : 1
				}
...
, 							{
								"box" : 								{
									"code" : "bumpFromDepth(height,amt,resolution){\r\n\tstep = vec(1,1) / resolution;\r\n\ttexel = cell/resolution;\r\n\tdxy = height - vec(\r\n\t\tsample(in1,vec(texel.x+step.x,texel.y)),\r\n\t\tsample(in1,vec(texel.x,texel.y+step.y))\r\n\t);\r\n\treturn normalize(concat(dxy * amt / step,1));\r\n\t}\r\n\r\nParam scale(1);\r\n\r\nout1 = concat((bumpFromDepth(in1.x,scale,dim) * 0.5) + 0.5,1);",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 12.0,
									"id" : "obj-3",
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 70.0, 537.0, 254.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 730.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 755.0, 260.0, 126.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 755.0, 161.0, 83.0, 22.0 ],
					"text" : "read $1, bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 755.0, 197.0, 147.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									"code" : "getHeight(coords) {\n  return sample(in1,vec(coords.x,coords.y)).r;\n}\n\nbumpFromDepth(amt) {\n  step = vec(1,1) / dim;\n    \n  height = in1.r;\n    \n  dxy = (vec(height,height) - vec(sample(in1,vec(norm.x + step.x, 0.)),getHeight(vec(0.,norm.y+step.y))));\n    \n  // return concat(normalize(concat(dxy * vec(scale,scale) / step, 1.)), height);\r\n  return normalize(concat(dxy * amt / step, 1.));\n}\n\r\n// Param scale(1);\r\n\n//void mainImage(out vec4 fragColor, in vec2 fragCoord)\n//{\nuv = norm;\n// normal = concat((bumpFromDepth(scale).rgb * 0.5) + 0.5, 1.);\r\nnormal = concat(vec(1,0,1), 1);\r\nout1 = normal;\n//}",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 12.0,
									"id" : "obj-5",
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 875.0, 64.0, 733.0, 625.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 64.0, 537.0, 254.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 176.0, 718.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 478.0, 674.0, 41.0, 22.0 ],
					"text" : "jit.gen"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 740.0, 395.0, 313.181818181818244, 265.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 238.0, 439.0, 201.0, 22.0 ],
					"text" : "jit.matrix 4 float32 256 256 @adapt0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 298.571428571428555, 518.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 454.0, 181.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 266.0, 181.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 724.0, 656.0, 128.0, 22.0 ],
					"text" : "read env_01.exr, bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 724.0, 688.0, 64.0, 22.0 ],
					"text" : "jit.openexr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 435.0, 382.0, 55.0, 22.0 ],
					"text" : "read env"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 270.571428571428555, 608.0, 397.0, 22.0 ],
					"text" : "jit.matrix 4 float32 512 512 @planemap 1 1 1 @planecount 3 @adapt 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 270.571428571428555, 665.0, 159.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 765.0, 563.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 683.0, 563.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 601.0, 563.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 519.0, 563.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 519.0, 531.0, 347.0, 22.0 ],
					"text" : "jit.unpack"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 740.0, 695.0, 313.181818181818244, 258.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 454.0, 466.0, 126.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 247.0, 284.0, 100.0, 22.0 ],
									"text" : "+ 0.3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 247.0, 243.0, 33.0, 22.0 ],
									"text" : "* 0.7"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 334.0, 193.0, 26.0, 22.0 ],
									"text" : "!- 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 334.0, 149.0, 53.0, 22.0 ],
									"text" : "swiz rgb"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 317.0, 415.0, 35.0, 22.0 ],
									"text" : "out 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 317.0, 325.0, 75.0, 22.0 ],
									"text" : "concat 1 rgb"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 247.0, 193.0, 26.0, 22.0 ],
									"text" : "!- 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 247.0, 149.0, 41.0, 22.0 ],
									"text" : "swiz y"
								}
...
,
					"patching_rect" : [ 238.0, 512.0, 41.0, 22.0 ],
					"text" : "jit.gen"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 238.0, 476.5, 128.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 238.0, 405.0, 53.0, 22.0 ],
					"text" : "jit.matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 238.0, 363.0, 124.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 238.0, 311.0, 33.0, 42.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 579.5, 712.0, 69.0, 22.0 ],
					"text" : "jit.gl.handle"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 266.0, 753.0, 91.0, 22.0 ],
					"text" : "get_gl3_shader"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 238.0, 712.0, 247.0, 22.0 ],
					"text" : "jit.gl.pbr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 238.0, 795.0, 346.0, 22.0 ],
					"text" : "jit.gl.gridshape @shape plane @color 1 1 1 1 @blend_enable 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 589.0, 216.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 681.0, 225.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 632.0, 292.0, 55.0, 22.0 ],
					"text" : "pak 1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 632.0, 324.0, 148.0, 22.0 ],
					"text" : "prepend param texRepeat"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 20.0, 20.0, 137.0, 22.0 ],
									"text" : "vec norm.x norm.y 0.5 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 20.0, 71.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 332.0, 286.0, 172.0, 22.0 ],
					"text" : "jit.gl.pix @dim 16 16 @adapt 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 233.0, 234.0, 372.0, 22.0 ],
					"text" : "jit.world shd @enable 1 @size 300 300 @erase_color 0.2 0.1 0.05 1"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Projekte/Xenorama/XEN_Cloud/XENcloud/03_TOOLS/XEN_MAX-MSP/KST_kunsthaus-sans-titre/code",
				"patcherrelativepath" : "../../../../../../Projekte/Xenorama/XEN_Cloud/XENcloud/03_TOOLS/XEN_MAX-MSP/KST_kunsthaus-sans-titre/code",
				"type" : "gJIT",
				"implicit" : 1
			}
, 			{
