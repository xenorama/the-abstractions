...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 305.0, 14.0, 118.0, 22.0 ],
...
,
					"patching_rect" : [ 689.5, 353.0, 41.0, 22.0 ],
					"text" : "jit.gen"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 891.0, 297.0, 38.0, 20.0 ],
					"text" : "alpha"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 517.0, 221.0, 57.0, 22.0 ],
					"text" : "universal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 517.0, 189.0, 155.0, 22.0 ],
					"text" : "jit.gl.mesh blend_enable $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 529.0, 14.0, 150.0, 20.0 ],
					"text" : "transparency"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 496.0, 44.0, 40.0, 22.0 ],
					"text" : "t b i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 506.5, 95.0, 29.5, 22.0 ],
					"text" : "!- 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 506.5, 137.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 172.0, 478.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 365.0, 358.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 808.5, 297.0, 76.0, 69.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 808.5, 265.0, 69.0, 22.0 ],
					"text" : "jit.unpack 1"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 150.0, 228.0, 87.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 176.0, 298.0, 208.0, 22.0 ],
									"text" : "concat x y zw"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 176.0, 70.0, 28.0, 22.0 ],
									"text" : "in 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 176.0, 355.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"midpoints" : [ 185.5, 120.0, 374.5, 120.0 ],
									"order" : 0,
									"source" : [ "obj-1", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-8", 1 ],
									"midpoints" : [ 185.5, 197.0, 280.0, 197.0 ],
									"order" : 0,
									"source" : [ "obj-3", 0 ]
								}
...
,
					"patching_rect" : [ 689.5, 189.0, 129.0, 22.0 ],
					"text" : "jit.gen @outputmode 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 720.0, 265.0, 76.0, 69.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 689.5, 12.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 808.5, 390.0, 91.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 689.5, 390.0, 92.5, 22.0 ],
					"text" : "jit.gl.pbr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 688.5, 478.0, 139.0, 62.0 ],
					"text" : "jit.gl.mesh @draw_mode triangles @position 0.6 0 @scale 0.4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 689.5, 44.0, 170.0, 22.0 ],
					"text" : "importmovie duckCM.tiff, bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 689.5, 95.0, 53.0, 22.0 ],
					"text" : "jit.matrix"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 217.0, 187.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 217.0, 390.0, 92.5, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 365.0, 478.0, 307.0, 62.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 217.0, 221.0, 171.0, 22.0 ],
					"text" : "jit.world pbr-model @floating 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 217.0, 478.0, 138.0, 62.0 ],
					"text" : "jit.gl.mesh @draw_mode triangles @position -0.6 0 @scale 0.4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 365.0, 390.0, 240.0, 22.0 ],
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 374.5, 444.5, 374.5, 444.5 ],
					"order" : 1,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 374.5, 444.5, 181.5, 444.5 ],
					"order" : 3,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 374.5, 442.0, 698.0, 442.0 ],
					"order" : 0,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 374.5, 444.5, 226.5, 444.5 ],
					"order" : 2,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 516.0, 173.5, 699.0, 173.5 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 699.0, 332.0, 226.5, 332.0 ],
					"order" : 3,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 699.0, 237.5, 818.0, 237.5 ],
					"order" : 0,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 699.0, 237.5, 729.5, 237.5 ],
					"order" : 1,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"midpoints" : [ 505.5, 80.0, 699.0, 80.0 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 8 ],
					"midpoints" : [ 818.0, 459.5, 345.5, 459.5 ],
					"order" : 1,
					"source" : [ "obj-29", 0 ]
				}
