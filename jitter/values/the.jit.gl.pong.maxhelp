...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 350.0, 80.0, 22.0 ],
					"text" : "the.jit.gl.pong"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 203.0, 292.0, 177.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 543.0, 327.0, 34.0, 23.0 ],
									"text" : "pvar"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 543.0, 294.0, 98.0, 23.0 ],
									"text" : "setname $1, $2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 543.0, 246.0, 138.0, 38.0 ],
									"text" : "boundmode_menu 6, min 0.2, max 0.66"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 543.0, 213.0, 62.0, 23.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 256.25, 368.0, 59.0, 23.0 ],
									"text" : "mode $1"
								}
...
, 							{
								"box" : 								{
									"id" : "obj-24",
									"items" : [ "ignore", ",", "pass", ",", "<separator>", ",", "wrap", ",", "modulo", ",", "<separator>", ",", "fold", ",", "palindrome", ",", "<separator>", ",", "clamp", ",", "clip" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 203.0, 328.0, 125.5, 23.0 ],
									"varname" : "boundmode_menu"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 418.0, 213.0, 20.0, 140.0 ],
									"size" : 1.0,
									"varname" : "max"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 387.0, 213.0, 20.0, 140.0 ],
									"size" : 1.0,
									"varname" : "min"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 356.0, 368.0, 81.0, 23.0 ],
									"text" : "pak range f f"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 51.0, 447.0, 260.0, 23.0 ],
									"text" : "the.jit.gl.pong @range 0.2 0.66 @mode fold"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 109.5, 495.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "1",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 352.0, 328.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "2",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-8",
									"ignoreclick" : 1,
									"jsarguments" : [ "the.jit.gl.pong" ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 311.0, 447.0, 232.785018920898438, 39.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 444.0, 328.0, 75.0, 25.0 ],
									"text" : "min/max"
								}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									"destination" : [ "obj-6", 0 ],
									"midpoints" : [ 265.75, 418.5, 60.5, 418.5 ],
									"source" : [ "obj-1", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"hidden" : 1,
									"midpoints" : [ 212.5, 354.0, 189.0, 354.0, 189.0, 288.0, 212.5, 288.0 ],
									"source" : [ "obj-24", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-6", 0 ],
									"midpoints" : [ 365.5, 418.0, 60.5, 418.0 ],
									"source" : [ "obj-4", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 290.72003173828125, 57.599853515625 ]
				}
