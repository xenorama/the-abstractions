...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 513.0, 239.0, 185.978515625, 39.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 619.5, 515.0, 87.0, 22.0 ],
					"text" : "prepend range"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 751.5, 374.0, 107.0, 22.0 ],
					"text" : "print the.jit.gl.pong",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 751.5, 329.0, 150.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 619.5, 479.0, 178.0, 22.0 ],
					"text" : "pak 0. 1.",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"comment" : "the.jit.gl.pong: (float) High input range",
					"hint" : "",
					"id" : "obj-13",
					"index" : 0,
					"maxclass" : "inlet",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 778.5, 410.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.jit.gl.pong: (float) Low input range",
					"hint" : "",
					"id" : "obj-12",
					"index" : 0,
					"maxclass" : "inlet",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 733.5, 410.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 198.023824896131373, 239.0, 29.5, 22.0 ],
					"text" : "$1"
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 487.5, 359.0, 89.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"orientation" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 198.023824896131373, 292.0, 136.476175103868627, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 198.023824896131373, 163.0, 72.0, 22.0 ],
					"text" : "patcherargs",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"comment" : "the.jit.gl.pong: (jit_gl_texture) processed output as per mode and range settings",
					"hint" : "",
					"id" : "obj-10",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 349.5, 714.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.jit.gl.pong: dumpout",
					"hint" : "",
					"id" : "obj-9",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 565.5, 714.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 487.5, 589.0, 90.0, 22.0 ],
					"text" : "prepend param"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 487.5, 418.0, 119.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 487.5, 297.0, 283.0, 22.0 ],
...
, 			{
				"box" : 				{
					"comment" : "the.jit.gl.pong: (jit_gl_texture, anything) Texture input and messages to jit.gl.slab",
					"hint" : "",
					"id" : "obj-2",
					"index" : 0,
					"maxclass" : "inlet",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 349.5, 239.0, 157.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 349.5, 656.0, 235.0, 22.0 ],
					"text" : "jit.gl.slab @file the.pong.jxs",
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 260.523824896131373, 218.0, 359.0, 218.0 ],
					"source" : [ "obj-11", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 743.0, 459.0, 629.0, 459.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 207.523824896131373, 369.5, 359.0, 369.5 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 629.0, 560.5, 497.0, 560.5 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 497.0, 633.0, 359.0, 633.0 ],
					"source" : [ "obj-5", 0 ]
				}
