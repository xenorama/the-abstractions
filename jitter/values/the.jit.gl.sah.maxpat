...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 39.0, 286.0, 29.5, 22.0 ],
					"text" : "!- 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 39.0, 318.0, 77.0, 22.0 ],
					"text" : "gate 2 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 39.0, 254.0, 77.0, 22.0 ],
					"text" : "route bypass"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 282.75, 511.0, 48.0, 22.0 ],
					"text" : "zl 2 reg"
				}
...
,
					"patching_rect" : [ 258.0, 836.0, 211.5, 22.0 ],
					"text" : "jit.gl.pix @t applyMask"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 471.5, 359.0, 72.0, 22.0 ],
					"text" : "$1 $1 $1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 471.5, 435.0, 70.0, 22.0 ],
					"text" : "jit.gl.texture"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 471.5, 397.0, 123.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 450.5, 285.0, 71.5, 22.0 ],
					"text" : "typeroute~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 383.5, 319.0, 59.0, 22.0 ],
					"text" : "route lum"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 604.75, 560.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 604.75, 592.0, 123.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 562.75, 682.0, 175.0, 22.0 ],
					"text" : "jit.gl.texture @name #0_prev"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 383.5, 463.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 450.5, 535.0, 137.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 383.5, 500.0, 86.0, 22.0 ],
					"text" : "gate 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 123.0, 201.0, 244.0, 22.0 ],
					"text" : "patcherargs @thresh 0.5 @freeze 1 @lum 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 226.0, 285.0, 229.0, 22.0 ],
					"text" : "routepass jit_gl_texture freeze thresh lum"
				}
...
, 			{
				"box" : 				{
					...
					"orientation" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 123.0, 604.000008821487427, 75.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"orientation" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 145.0, 660.0, 75.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.0, 835.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 414.5, 230.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 39.0, 205.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 450.5, 592.0, 131.25, 22.0 ],
					"text" : "t l b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 338.25, 682.0, 130.0, 22.0 ],
					"text" : "jit_gl_texture #0_out"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 226.0, 591.0, 97.5, 22.0 ],
					"text" : "t l b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 282.75, 799.0, 169.0, 22.0 ],
					"text" : "jit.gl.texture @name #0_out"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 226.0, 741.0, 355.75, 22.0 ],
					"text" : "jit.gl.pix @gen the.sah"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 393.0, 574.0, 460.0, 574.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 1 ],
					"midpoints" : [ 512.5, 484.0, 460.0, 484.0 ],
					"source" : [ "obj-20", 5 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 1 ],
					"midpoints" : [ 481.0, 483.0, 460.0, 483.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 1,
					"hidden" : 1,
					"midpoints" : [ 235.5, 797.0, 267.5, 797.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 347.75, 773.0, 756.0, 773.0, 756.0, 671.0, 572.25, 671.0 ],
					"source" : [ "obj-3", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 235.5, 779.0, 292.25, 779.0 ],
					"order" : 0,
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 154.5, 721.500004410743713, 235.5, 721.500004410743713 ],
					"source" : [ "obj-49", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 132.5, 721.500004410743713, 235.5, 721.500004410743713 ],
					"source" : [ "obj-50", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 340.5, 636.0, 235.5, 636.0 ],
					"source" : [ "obj-53", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 288.0, 418.0, 213.0, 418.0, 213.0, 640.0, 235.5, 640.0 ],
					"source" : [ "obj-53", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-53", 0 ],
					"midpoints" : [ 357.5, 271.5, 235.5, 271.5 ],
					"source" : [ "obj-54", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 314.0, 659.0, 347.75, 659.0 ],
					"source" : [ "obj-9", 1 ]
				}
