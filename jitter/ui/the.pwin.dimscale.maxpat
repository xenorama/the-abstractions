...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 39.523824896131373, 431.0, 85.0, 22.0 ],
					"text" : "zl reg 640 480"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 491.800000000000011, 648.0, 72.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 39.523824896131373, 697.5, 53.0, 22.0 ],
					"text" : "prepend"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.523824896131373, 747.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 131.523824896131373, 586.25, 50.0, 22.0 ],
					"text" : "$1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 39.523824896131373, 635.0, 111.0, 35.0 ],
					"text" : "vexpr int($f1 * $f2) @maxsize 2",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 131.523824896131373, 554.5, 103.476175103868627, 22.0 ],
					"text" : "!/ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 131.523824896131373, 522.5, 37.0, 22.0 ],
					"text" : "zl nth",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 39.523824896131373, 466.5, 111.0, 22.0 ],
					"text" : "t l l",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 449.199999999999989, 353.5, 38.0, 22.0 ],
					"text" : "t b i 2",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "int", "int" ],
					"patching_rect" : [ 206.0, 353.5, 38.0, 22.0 ],
					"text" : "t b i 1",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "" ],
					"patching_rect" : [ 364.0, 277.0, 274.600000000000023, 22.0 ],
					"text" : "route int x y prepend dim done",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 206.0, 277.0, 47.0, 22.0 ],
					"text" : "unpack",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 206.0, 218.0, 177.0, 22.0 ],
					"text" : "patcherargs 120 @dim 640 480",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 404.523824896131373, 163.0, 30.0, 30.0 ]
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 414.023824896131373, 258.0, 373.5, 258.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 416.100000000000023, 327.25, 215.5, 327.25 ],
					"source" : [ "obj-14", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 373.5, 327.25, 215.5, 327.25 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 629.100000000000023, 314.25, 49.023824896131373, 314.25 ],
					"source" : [ "obj-14", 6 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 1 ],
					"midpoints" : [ 543.899999999999977, 387.5, 115.023824896131373, 387.5 ],
					"source" : [ "obj-14", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 234.5, 448.5, 159.023824896131373, 448.5 ],
					"source" : [ "obj-15", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 225.0, 460.0, 225.5, 460.0 ],
					"source" : [ "obj-15", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 215.5, 402.75, 49.023824896131373, 402.75 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-24", 1 ],
					"midpoints" : [ 477.699999999999989, 448.5, 159.023824896131373, 448.5 ],
					"source" : [ "obj-16", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-27", 1 ],
					"midpoints" : [ 468.199999999999989, 460.0, 225.5, 460.0 ],
					"source" : [ "obj-16", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 458.699999999999989, 402.75, 49.023824896131373, 402.75 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 501.300000000000011, 683.25, 49.023824896131373, 683.25 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 215.5, 327.25, 215.5, 327.25 ],
					"source" : [ "obj-9", 0 ]
				}
