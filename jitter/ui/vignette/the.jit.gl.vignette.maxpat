...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 265.5, 385.5, 110.0, 22.0 ],
					"text" : "rgb locked_bgcolor"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 394.499999999999943, 557.25, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 383.999999999999943, 465.0, 29.5, 22.0 ],
					"text" : "t l 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 334.999999999999943, 465.0, 29.5, 22.0 ],
					"text" : "t l 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 633.0, 261.0, 121.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 633.0, 310.5, 148.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "parentpatcher.bgcolor.js",
						"parameter_enable" : 0
					}
,
					"text" : "js parentpatcher.bgcolor.js"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 642.5, 515.5, 29.5, 22.0 ],
					"text" : "set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 627.5, 481.5, 35.0, 22.0 ],
					"text" : "set 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 627.5, 449.5, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 627.5, 417.5, 33.0, 22.0 ],
					"text" : "== 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 627.5, 385.5, 47.0, 22.0 ],
					"text" : "zl 4 len"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 597.0, 353.5, 49.5, 22.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"orientation" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 432.999999999999886, 621.5, 69.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 41.0, 713.5, 163.0, 35.0 ],
					"text" : "jit.gl.pix @gen the.vignette @edge 0.8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 41.0, 559.25, 184.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"orientation" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 286.0, 621.5, 69.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"orientation" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 237.0, 621.5, 47.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 597.0, 620.5, 73.0, 22.0 ],
					"text" : "prepend rgb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 597.0, 576.25, 49.0, 22.0 ],
					"text" : "append"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1075.799999999999955, 179.5, 155.0, 22.0 ],
					"text" : "sprintf get styledefaults::%s"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 184.0, 245.0, 107.5, 22.0 ],
					"text" : "typeroute~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "" ],
					"patching_rect" : [ 237.0, 432.5, 312.999999999999886, 22.0 ],
					"text" : "route edge amount rgba rgb circular done"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 184.0, 206.0, 72.0, 22.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 219.0, 805.5, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 41.0, 206.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1057.5, 503.0, 55.0, 22.0 ],
					"text" : "zl slice 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1037.5, 358.5, 171.0, 22.0 ],
					"text" : "loadmess read maxcolors.json"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1037.5, 422.5, 79.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 219.0, 713.5, 146.0, 35.0 ],
					"text" : "jit.pix @gen the.vignette @edge 0.8"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-32",
					"ignoreclick" : 1,
					"jsarguments" : [ "the.jit.gl.vignette", 75 ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.523824896131373, 7.999991178512573, 505.0, 168.000008821487427 ]
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 264.300000000000011, 300.25, 642.5, 300.25 ],
					"source" : [ "obj-1", 4 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 282.0, 289.625, 606.5, 289.625 ],
					"source" : [ "obj-1", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 50.5, 401.75, 246.5, 401.75 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 540.499999999999886, 538.875, 50.5, 538.875 ],
					"order" : 1,
					"source" : [ "obj-13", 6 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 540.499999999999886, 597.0, 50.5, 597.0 ],
					"order" : 0,
					"source" : [ "obj-13", 6 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 642.5, 343.0, 606.5, 343.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 606.5, 689.0, 228.5, 689.0 ],
					"order" : 0,
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"midpoints" : [ 606.5, 689.0, 50.5, 689.0 ],
					"order" : 1,
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 442.499999999999886, 689.0, 228.5, 689.0 ],
					"order" : 0,
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"midpoints" : [ 442.499999999999886, 689.0, 50.5, 689.0 ],
					"order" : 1,
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 246.5, 689.0, 228.5, 689.0 ],
					"order" : 0,
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"midpoints" : [ 246.5, 689.0, 50.5, 689.0 ],
					"order" : 1,
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 295.5, 689.0, 228.5, 689.0 ],
					"order" : 0,
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"midpoints" : [ 295.5, 689.0, 50.5, 689.0 ],
					"order" : 1,
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 133.0, 646.875, 228.5, 646.875 ],
					"source" : [ "obj-33", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 50.5, 776.5, 228.5, 776.5 ],
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 344.499999999999943, 508.0, 173.75, 508.0, 173.75, 238.0, 193.5, 238.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 354.999999999999943, 527.625, 403.999999999999943, 527.625 ],
					"source" : [ "obj-38", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 393.499999999999943, 517.5, 150.5, 517.5, 150.5, 234.0, 193.5, 234.0 ],
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 403.999999999999943, 610.25, 578.25, 610.25, 578.25, 250.0, 642.5, 250.0 ],
					"source" : [ "obj-41", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 1085.299999999999955, 396.5, 1047.0, 396.5 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 606.5, 609.375, 606.5, 609.375 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 1047.0, 401.0, 1047.0, 401.0 ],
					"source" : [ "obj-78", 0 ]
				}
