...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 764.0, 533.0, 91.0, 22.0 ],
					"text" : "routepass done",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 764.0, 640.0, 168.0, 22.0 ],
					"text" : "print the.jit.gl.material.vtfmaps",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 764.0, 592.5, 171.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 628.0, 640.0, 112.0, 22.0 ],
					"text" : "prepend heightmap"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 308.0, 640.0, 99.0, 22.0 ],
					"text" : "prepend normals"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 628.0, 480.0, 155.0, 35.0 ],
					"text" : "the.jit.attr.wrapper jit.gl.pix @custom amp @pass 0",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 662.0, 164.0, 129.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 662.0, 132.0, 129.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 662.0, 95.0, 77.0, 22.0 ],
					"text" : "absolutepath",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 662.0, 60.0, 133.0, 22.0 ],
					"text" : "the.normalmap.rect.glsl"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 458.0, 284.0, 185.978515625, 39.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 342.0, 225.0, 201.523824896131373, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 628.0, 711.0, 30.0, 30.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 174.0, 167.0, 67.0, 22.0 ],
									"text" : "clear, 0 1 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 62.0, 167.0, 101.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 62.0, 135.0, 243.0, 22.0 ],
									"text" : "sel 0 1",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 62.0, 73.0, 52.0, 22.0 ],
									"text" : "route int",
									"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 62.0, 103.0, 47.0, 22.0 ],
									"text" : "clip 0 1",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 62.0, 224.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-25", 0 ],
									"midpoints" : [ 183.5, 206.0, 71.5, 206.0 ],
									"source" : [ "obj-19", 0 ]
								}
...
,
					"patching_rect" : [ 432.0, 378.0, 55.0, 22.0 ],
...
,
					"patching_rect" : [ 77.666666666666657, 499.0, 250.0, 22.0 ],
					"text" : "jit.gl.pix @type float32 @amp 1 @rectangle 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 432.0, 342.0, 215.0, 22.0 ],
					"text" : "route link sendnormals sendheightmap",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 342.0, 164.0, 256.0, 22.0 ],
					"text" : "patcherargs @amp 1 @scale 1 @link 1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 39.0, 427.0, 135.0, 22.0 ],
					"text" : "router 1 3",
					"textcolor" : [ 1.0, 0.984314, 0.870588, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 628.0, 384.0, 88.0, 22.0 ],
					"text" : "routepass amp",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 509.0, 711.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.0, 711.0, 30.0, 30.0 ]
				}
...
,
					"patching_rect" : [ 509.0, 586.0, 138.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 155.0, 225.0, 151.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 39.0, 579.0, 288.0, 22.0 ],
					"text" : "jit.gl.slab @file the.normalmap.rect.jxs @type float32",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 287.0, 284.0, 164.0, 35.0 ],
					"text" : "the.jit.attr.wrapper jit.gl.slab @custom scale @pass 0",
					"textcolor" : [ 0.132197, 0.140542, 0.152779, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 155.0, 168.0, 30.0, 30.0 ]
				}
...
,
					"text" : "provide a heightmap and normalmap for\njit.gl.material @heightmap_mode vtf",
					"textcolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "by Tim Heinze, www.xenorama.com, © 2021 MIT License"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.523824896131373, 7.999991178512573, 538.0, 64.0 ],
					"text" : "the.jit.gl.material.vtfmaps"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 637.5, 462.0, 87.166666666666657, 462.0 ],
					"order" : 1,
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 125.833333333333329, 483.5, 518.5, 483.5 ],
					"source" : [ "obj-11", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 87.166666666666657, 483.5, 518.5, 483.5 ],
					"order" : 0,
					"source" : [ "obj-11", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 588.5, 259.5, 296.5, 259.5 ],
					"source" : [ "obj-12", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 506.833333333333314, 374.0, 274.666666666666629, 374.0, 274.666666666666629, 273.0, 296.5, 273.0 ],
					"source" : [ "obj-13", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 0 ],
					"midpoints" : [ 572.166666666666629, 421.5, 637.5, 421.5 ],
					"source" : [ "obj-13", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 637.5, 679.5, 637.5, 679.5 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 87.166666666666657, 549.5, 48.5, 549.5 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 441.5, 412.0, 48.5, 412.0 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 845.5, 573.25, 773.5, 573.25 ],
					"source" : [ "obj-27", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 296.5, 549.0, 48.5, 549.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 637.5, 552.5, 518.5, 552.5 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 317.5, 680.0, 637.5, 680.0 ],
					"source" : [ "obj-6", 0 ]
				}
