...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 688.5, 349.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 688.5, 381.0, 271.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 698.0, 440.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 698.0, 474.0, 113.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 529.0, 651.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 569.0, 483.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 624.0, 531.0, 121.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 624.0, 573.0, 53.0, 22.0 ],
					"text" : "jit.matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 647.0, 507.0, 42.0, 22.0 ],
					"text" : "expr 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 624.0, 605.0, 143.0, 22.0 ],
					"text" : "jit.expr @expr 0.1 0.1 0.1",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 624.0, 641.5, 172.0, 35.0 ],
					"text" : "jit.gl.buffer @type vertex_attr0 @outname velocity @texbuf 1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 531.0, 435.0, 276.0, 22.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 229.0, 198.0, 41.0, 22.0 ],
									"text" : "swiz y"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 176.0, 181.0, 41.0, 22.0 ],
									"text" : "swiz x"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 176.0, 253.0, 67.0, 22.0 ],
									"text" : "vec 0 0 0 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 176.0, 149.0, 87.0, 22.0 ],
									"text" : "Param pos 0 0"
								}
...
,
					"patching_rect" : [ 501.0, 467.0, 49.0, 22.0 ],
					"text" : "jit.gl.pix",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 115.0, 496.0, 91.0, 22.0 ],
					"text" : "get_gl3_shader"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 596.0, 262.0, 228.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 596.0, 198.0, 110.0, 22.0 ],
					"text" : "scale 0. 1. 0.3 0.01",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 515.0, 262.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 515.0, 230.0, 49.0, 22.0 ],
					"text" : "+ 0.003",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 515.0, 198.0, 40.0, 22.0 ],
					"text" : "* 0.01",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 515.0, 160.999991178512573, 125.0, 22.0 ],
					"text" : "the.perlin 0.5 @sign 0",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 303.0, 517.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 303.0, 489.0, 57.0, 22.0 ],
					"text" : "r pbs_init",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 302.0, 188.999995589256287, 59.0, 22.0 ],
					"text" : "s pbs_init",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 302.0, 160.999991178512573, 43.0, 22.0 ],
					"text" : "sel init",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 245.0, 593.0, 295.0, 22.0 ],
					"text" : "jit.gl.mesh @shader pos @texture pos_morph",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 245.0, 668.0, 252.0, 22.0 ],
					"text" : "jit.gl.pass @fxname bloom-hq @threshold 0.7",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 245.0, 317.0, 180.0, 22.0 ],
					"text" : "jit.gl.texture @dim 8 8 @adapt 0",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "jit_matrix", "" ],
					"patching_rect" : [ 617.0, 53.0, 122.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 266.0, 280.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 266.0, 248.0, 91.0, 22.0 ],
					"text" : "accum 0.007",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 245.0, 352.0, 388.0, 22.0 ],
					"text" : "jit.gl.bfg @dim 8 8 @adapt 0 @colorize 1 @basis noise.voronoi.smooth",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 270.0, 448.0, 180.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 245.0, 633.0, 246.0, 22.0 ],
					"text" : "jit.gl.shader pbs @name pos @file gsPos.jxs",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 303.0, 546.0, 468.0, 22.0 ],
					"text" : "jit.gl.gridshape @scale 0.3 @color 1 1 1 1 @dim 17 17 @matrixoutput 2 @automatic 0",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 188.0, 125.999991178512573, 133.0, 22.0 ],
					"text" : "jit.world pbs @enable 1",
