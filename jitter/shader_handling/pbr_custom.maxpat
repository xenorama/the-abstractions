...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 178.0, 857.0, 92.5, 22.0 ],
					"text" : "jit.gl.pbr"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 578.0, 746.0, 163.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 490.5, 554.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 344.0, 183.28447738972784, 217.0, 22.0 ],
					"text" : "loadmess symbol env_01.exr @defer 1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 363.0, 572.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 267.25, 627.0, 43.0, 22.0 ],
					"text" : "sel init",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 161.81500000000301, 725.644329896907266, 351.0, 22.0 ],
					"text" : "jit.gl.mesh @cull_face 1 @blend_enable 1 @shader pbr_custom",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 686.797000000000708, 860.0, 173.0, 22.0 ],
					"text" : "jit.gl.texture @name reflections",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 270.81500000000301, 785.644329896907266, 476.981999999997697, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 786.0, 746.0, 67.0, 22.0 ],
					"text" : "universal 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 786.0, 714.0, 264.0, 22.0 ],
					"text" : "jit.gl.texture adapt 0, jit.gl.texture dim 1024 1024"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 57.81500000000301, 564.288659793814531, 179.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 367.0, 478.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.5, 366.0, 83.0, 22.0 ],
					"text" : "read $1, bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 686.797000000000708, 827.0, 145.0, 22.0 ],
					"text" : "jit.gl.texture @name integ",
					"textcolor" : [ 0.810308635234833, 0.620984792709351, 0.233699977397919, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 465.5, 435.203882217407227, 138.0, 22.0 ],
					"text" : "jit.gl.texture @name env",
					"textcolor" : [ 0.810308635234833, 0.620984792709351, 0.233699977397919, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 465.5, 404.0, 64.0, 22.0 ],
					"text" : "jit.openexr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 605.0, 78.0, 142.797000000000708, 22.0 ],
					"text" : "buddy",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 728.0, 248.0, 52.0, 22.0 ],
					"text" : "route int",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 667.0, 248.0, 52.0, 22.0 ],
					"text" : "route int",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 618.297000000000708, 248.0, 52.0, 22.0 ],
					"text" : "route int",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 986.5, 241.0, 32.0, 22.0 ],
					"text" : "print",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 478.0, 124.0, 22.0, 22.0 ],
					"text" : "t 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 478.0, 74.0, 54.0, 22.0 ],
					"text" : "deferlow",
					"textcolor" : [ 1.0, 0.984314, 0.870588, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 344.0, 159.28447738972784, 214.0, 22.0 ],
					"text" : "loadmess symbol Marble012 @defer 1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1288.5, 215.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1321.0, -157.0, 58.0, 22.0 ],
					"text" : "loadbang",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 678.0, 311.0, 49.0, 49.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 490.5, 497.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 787.5, 246.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1082.5, 233.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1087.0, 377.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 993.0, 377.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 944.0, 640.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1005.797000000000708, 311.0, 79.0, 22.0 ],
					"text" : "jit_matrix $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 903.797000000000708, 241.0, 79.0, 22.0 ],
					"text" : "jit_matrix $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 325.0, 625.0, 300.0, 22.0 ],
					"text" : "texture albedo normals roughness env reflections integ"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 225.5, 428.0, 338.0, 22.0 ],
					"text" : "jit.gl.shader @name pbr_custom @file pbr_opacity_shader.jxs",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 1035.0, 570.0, 175.0, 22.0 ],
					"text" : "jit.gl.texture @name roughness",
					"textcolor" : [ 0.810308635234833, 0.620984792709351, 0.233699977397919, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 977.0, 516.0, 161.0, 22.0 ],
					"text" : "jit.gl.texture @name normals",
					"textcolor" : [ 0.810308635234833, 0.620984792709351, 0.233699977397919, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 803.0, 516.0, 151.0, 22.0 ],
					"text" : "jit.gl.texture @name height",
					"textcolor" : [ 0.810308635234833, 0.620984792709351, 0.233699977397919, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 604.797000000000708, 516.0, 155.0, 22.0 ],
					"text" : "jit.gl.texture @name albedo",
					"textcolor" : [ 0.810308635234833, 0.620984792709351, 0.233699977397919, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1209.0, 468.412619948387146, 32.0, 22.0 ],
					"text" : "print",
					"textcolor" : [ 1.0, 0.984314, 0.870588, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1072.0, -294.0, 95.0, 22.0 ],
					"restore" : [ 1024.0, 0.0, 1.0, 0.0, 0.715257731958764, 0, 0.0, 1024.0, 1.0, 0, -0.755, "curve" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 1418.0, -296.677835051546367, 31.5, 22.0 ],
					"text" : "t b i",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1318.0, 33.0, 31.0, 22.0 ],
					"text" : "!- 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1431.0, -251.355670103092734, 29.5, 22.0 ],
					"text" : "+ 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1282.0, -3.355670103092734, 55.0, 22.0 ],
					"text" : "gate 2 1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1418.0, -334.0, 100.0, 20.0 ],
					"text" : "invert",
					"texton" : "ivert"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 728.797000000000708, 468.412619948387146, 134.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 743.711667000005264, 302.601941108703613, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 743.711667000005264, 331.601941108703613, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 632.297000000000708, 287.0, 38.0, 22.0 ],
					"text" : "defer",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1226.5, 112.0, 80.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1251.0, 61.0, 60.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 1251.0, -78.5, 29.5, 22.0 ],
					"text" : "t i i",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1251.0, 33.0, 50.0, 22.0 ],
					"text" : "pack i f",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1202.0, -109.0, 68.0, 22.0 ],
					"text" : "uzi 1024 0",
...
, 			{
				"box" : 				{
					"addpoints_with_curve" : [ 0.0, 0.715257731958764, 0, 0.0, 1024.0, 1.0, 0, -0.755 ],
					"domain" : 1024.0,
					"id" : "obj-42",
					"maxclass" : "function",
					"mode" : 1,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 1021.0, -232.355670103092734, 200.0, 100.0 ],
					"varname" : "function"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 904.0, 67.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 972.0, 56.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 972.0, 85.0, 61.0, 22.0 ],
					"text" : "active $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 904.0, 177.0, 23.0, 22.0 ],
					"text" : "t b",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 904.0, 96.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 904.0, 124.0, 296.0, 22.0 ],
					"text" : "gen @active 0 @expr out1=phasor(in1) @interval 100",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 622.797000000000708, 345.53882971405983, 57.0, 22.0 ],
					"text" : "jit.matrix",
					"textcolor" : [ 0.649909, 0.112638, 0.040011, 1.0 ]
				}
...
,
					"patching_rect" : [ 604.797000000000708, 425.203882217407227, 143.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 610.797000000000708, 207.601941108703613, 143.0, 22.0 ],
					"text" : "bondo 3 20 n",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 728.797000000000708, 139.0, 79.0, 22.0 ],
					"text" : "jit_matrix $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 604.797000000000708, 139.0, 79.0, 22.0 ],
					"text" : "jit_matrix $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 604.797000000000708, 26.0, 515.0, 22.0 ],
					"text" : "routepass albedo_texture heightmap_texture normals_texture roughness_texture",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 413.0, 215.0, 124.0, 141.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 161.81500000000301, 500.644329896907266, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 193.224166750000535, 159.28447738972784, 96.55166649999893, 39.0 ],
...
,
					"patching_rect" : [ 715.462000000003854, 581.644329896907152, 161.0, 22.0 ],
					"saved_object_attributes" : 					{
						"color" : [ 1.0, 0.71, 0.196, 1.0 ],
						"description" : "",
						"digest" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 715.462000000003854, 606.644329896907266, 300.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 225.5, 202.931045220544263, 94.5, 22.0 ],
					"text_width" : 70.5
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 213.0, 274.284477389727783, 55.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 267.25, 659.0, 415.0, 22.0 ],
					"text" : "jit.gl.gridshape @shape torus @dim 100 100 @matrixoutput 1 @automatic 0",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 267.25, 539.288659793814531, 37.0, 22.0 ],
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 267.25, 564.288659793814531, 74.0, 22.0 ],
					"text" : "jit.gl.handle",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 196.0, 202.931045220544263, 24.0, 24.0 ]
				}
...
,
					...
					"patching_rect" : [ 196.0, 241.931045220544263, 53.0, 22.0 ],
					"text" : "jit.world",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 169.315000000000055, 163.28447738972784, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 241.0, 203.431045220544263, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1030.5, -28.927835051546367, 1327.5, -28.927835051546367 ],
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1271.0, -45.5, 1297.75, -45.5, 1297.75, -246.855670103092734, 1030.5, -246.855670103092734 ],
					"source" : [ "obj-47", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-42", 0 ],
					"midpoints" : [ 1119.5, -252.177835051546367, 1030.5, -252.177835051546367 ],
					"source" : [ "obj-64", 1 ]
				}
