...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 585.0, 57.0, 117.137008666992188, 99.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 585.0, 8.0, 232.785018920898438, 39.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 109.0, 514.567027926445007, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 109.0, 490.567027926445007, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 718.0, 637.567027926445007, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 718.0, 482.567027926445007, 134.0, 22.0 ],
					"text" : "loadmess the.imgseq.js",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 76.0, 301.474219381809235, 65.0, 22.0 ],
					"text" : "zl 1 slice 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 718.0, 546.567027926445007, 35.0, 22.0 ],
					"text" : "$1, 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 718.0, 514.567027926445007, 77.0, 22.0 ],
					"text" : "absolutepath",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 718.0, 586.567027926445007, 55.0, 22.0 ],
					"text" : "filewatch",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 482.5, 377.0, 119.0, 22.0 ],
					"text" : "route load pattrmode",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 76.0, 335.948438763618469, 92.0, 22.0 ],
					"text" : "prepend drawto"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-74",
					"items" : [ "begin_capture", ",", "bind", ",", "end_capture", ",", "read", ",", "subtex_matrix", ",", "tomatrix", ",", "unbind", ",", "bang", ",", "draw", ",", "drawimmediate", ",", "drawraw", ",", "exportattrs", ",", "exportsummary", ",", "getattributes", ",", "getstate", ",", "importattrs", ",", "jit_gl_texture", ",", "jit_matrix", ",", "summary", ",", "adapt", ",", "basic", ",", "label", ",", "style", ",", "anisotropy", ",", "apply", ",", "enumvals", ",", "autoclear", ",", "autoscale", ",", "blendcolor", ",", "bordercolor", ",", "capture_buffer", ",", "capture_depthbits", ",", "capture_source", ",", "colormode", ",", "compare_func", ",", "compare_mode", ",", "compress", ",", "correction", ",", "debug", ",", "invisible", ",", "obsolete", ",", "defaultimage", ",", "dim", ",", "dstdimend", ",", "dstdimstart", ",", "erase_color", ",", "file", ",", "filter", ",", "flip", ",", "function", ",", "mipmap", ",", "mode", ",", "offset", ",", "operand", ",", "priority", ",", "rectangle", ",", "thru", ",", "source", ",", "srcdimend", ",", "srcdimstart", ",", "texgen", ",", "texture_mode", ",", "type", ",", "usedstdim", ",", "usesrcdim", ",", "weight", ",", "wrap", ",", "automatic", ",", "dest_dim", ",", "drawto", ",", "enable", ",", "layer", ",", "material", ",", "name", ",", "shader", ",", "getadapt", ",", "getbasic", ",", "getlabel", ",", "getstyle", ",", "getanisotropy", ",", "getapply", ",", "getenumvals", ",", "getautoclear", ",", "getautoscale", ",", "getblendcolor", ",", "getbordercolor", ",", "getcapture_buffer", ",", "getcapture_depthbits", ",", "getcapture_source", ",", "getcolormode", ",", "getcompare_func", ",", "getcompare_mode", ",", "getcompress", ",", "getcorrection", ",", "getdebug", ",", "getinvisible", ",", "getobsolete", ",", "getdefaultimage", ",", "getdim", ",", "getdstdimend", ",", "getdstdimstart", ",", "geterase_color", ",", "getfile", ",", "getfilter", ",", "getflip", ",", "getfunction", ",", "getmipmap", ",", "getmode", ",", "getoffset", ",", "getoperand", ",", "getpriority", ",", "getrectangle", ",", "getthru", ",", "getsource", ",", "getsrcdimend", ",", "getsrcdimstart", ",", "gettexgen", ",", "gettexture_mode", ",", "gettype", ",", "getusedstdim", ",", "getusesrcdim", ",", "getweight", ",", "getwrap", ",", "getautomatic", ",", "getdest_dim", ",", "getdrawto", ",", "getenable", ",", "getlayer", ",", "getmaterial", ",", "getname", ",", "getshader" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 382.5, 377.0, 76.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 282.5, 335.948438763618469, 219.0, 22.0 ],
					"text" : "the.jit.attr.wrapper jit.gl.texture @pass 0",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 482.500000000000227, 586.567027926445007, 52.0, 22.0 ],
					"text" : "route int",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 532.5, 450.067027926445007, 29.5, 22.0 ],
					"text" : "==",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 532.5, 490.567027926445007, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 532.5, 409.567027926445007, 47.0, 22.0 ],
					"text" : "clip 0 1",
...
, 			{
				"box" : 				{
					"comment" : "the.jit.gl.imgseq: dumpout",
					"id" : "obj-45",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 283.0, 747.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 515.500000000000227, 637.567027926445007, 85.0, 22.0 ],
					"text" : "seqSample $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 76.0, 697.0, 226.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "the.imgseq.js",
						"parameter_enable" : 0
					}
,
					"text" : "js the.imgseq.js",
...
, 			{
				"box" : 				{
					"comment" : "the.jit.gl.imgseq: (jit_gl_texture) outputs current frame of seuence as texture",
					"id" : "obj-87",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 76.0, 747.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.jit.gl.imgseq: (anything) send a bang to iterate through sequence of images, numbers recall frames (0-based), send methods to internal jit_gl_texture and set behavioural attributes",
					"id" : "obj-85",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 316.999999999999773, 259.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 76.0, 267.0, 226.0, 22.0 ],
					"text" : "patcherargs @pattrmode 1 @direction 0",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 482.5, 544.567027926445007, 120.0, 22.0 ],
					"restore" : [ "Macintosh HD:/Users/Oni/Documents/Max 8/Projects/21-10_LSI_Lichstrom-Ingolstadt/media/img_seq/LSI_01_FLUIDUM_03_to-material/LSI_fluidum_03_to-material_0861.jpg" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
					}
,
					"text" : "pattr imgseq_sample",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"varname" : "imgseq_sample"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.523824896131373, 7.999991178512573, 572.0, 195.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 727.5, 624.567027926445007, 525.000000000000227, 624.567027926445007 ],
					"order" : 1,
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 542.0, 530.567027926445007, 492.0, 530.567027926445007 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"midpoints" : [ 592.0, 440.5, 85.5, 440.5 ],
					"source" : [ "obj-35", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 292.5, 311.974219381809235, 292.0, 311.974219381809235 ],
					"source" : [ "obj-78", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"midpoints" : [ 525.000000000000227, 672.783513963222504, 85.5, 672.783513963222504 ],
					"source" : [ "obj-9", 0 ]
				}
