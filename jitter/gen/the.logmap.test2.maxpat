...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 454.0, 686.75, 137.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 454.0, 653.5, 100.0, 22.0 ],
					"text" : "jit.clip @max 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 454.0, 723.0, 278.0, 22.0 ],
					"text" : "jit.expr @expr (in[0]*0.8+0.2)*(in[0]>abs(snorm[1]))"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 454.0, 762.0, 207.0, 39.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 454.0, 616.0, 211.0, 22.0 ],
					"text" : "jit.matrix 1 float32 1024 100 @interp 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 145.0, 207.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 223.0, 662.0, 192.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 223.0, 599.0, 214.0, 22.0 ],
					"text" : "jit.expr @expr snorm[0] in[0].p[0]*2-1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 223.0, 635.0, 186.0, 17.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 223.0, 557.0, 117.0, 22.0 ],
					"text" : "jit.pack 2 @jump 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 687.0, 649.0, 207.0, 72.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 687.0, 616.0, 172.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 454.0, 522.5, 115.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 454.0, 567.0, 207.0, 39.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 721.0, 486.25, 127.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 687.0, 522.5, 115.0, 22.0 ],
					"text" : "jit.gen @gen the.log"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 687.0, 567.0, 207.0, 39.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 687.0, 355.0, 42.0, 22.0 ],
					"text" : "edge~",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 687.0, 323.0, 29.5, 22.0 ],
					"text" : "<~",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 687.0, 291.0, 42.0, 22.0 ],
					"text" : "delta~",
					"textcolor" : [ 0.992157, 0.65098, 0.109804, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 687.0, 450.0, 189.0, 22.0 ],
					"text" : "jit.matrix #0_mat 1 float32 1024",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 454.0, 240.0, 64.5, 22.0 ],
					"text" : "cartopol~",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 454.0, 291.0, 201.0, 22.0 ],
					"text" : "jit.poke~ #0_mat",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 454.0, 194.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 184.0, 418.0, 207.0, 39.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 184.0, 309.5, 30.0, 22.0 ],
					"text" : "*~ 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 184.0, 355.0, 207.0, 22.0 ],
					"text" : "pfft~ kqg_pft_single.frame 2048 2 0 1"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 554.5, 260.0, 696.5, 260.0 ],
					"order" : 0,
					"source" : [ "obj-11", 2 ]
				}
...
, 			{
				"name" : "kqg_pft_single.frame.maxpat",
				"bootpath" : "~/Documents/Max 8/Xenorama/XEN_Performances/22-10_KQG-Kreativquartier-Grundsteinlegung",
				"patcherrelativepath" : "../../../../Xenorama/XEN_Performances/22-10_KQG-Kreativquartier-Grundsteinlegung",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "the.logmap.genjit",
				"bootpath" : "~/Documents/Max 8/Xenorama/XEN_Animation/XVD_abstractions",
				"patcherrelativepath" : "../../../../Xenorama/XEN_Animation/XVD_abstractions",
				"type" : "gJIT",
				"implicit" : 1
			}
, 			{
