...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 170.0, 402.0, 39.0, 22.0 ],
									"text" : "0.007"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 170.0, 370.0, 31.0, 22.0 ],
									"text" : "qlim"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 170.0, 338.0, 34.0, 22.0 ],
									"text" : "sel 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 338.0, 32.0, 22.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 63.0, 299.0, 49.0, 22.0 ],
									"text" : "+ 0.001"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 63.0, 267.0, 47.0, 22.0 ],
									"text" : "* 0.1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 63.0, 235.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 63.0, 203.0, 81.0, 22.0 ],
									"text" : "snapshot~ 20"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 63.0, 155.0, 71.5, 22.0 ],
									"text" : "the.mc.ef~"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 63.0, 100.0, 45.0, 45.0 ]
								}
...
,
					"patching_rect" : [ 115.023824896131373, 188.0, 82.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 115.023824896131373, 154.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 190.023824896131373, 269.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 190.023824896131373, 306.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 621.0, 46.0, 79.0, 22.0 ],
					"text" : "the.rgb.patch",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 481.0, 385.35262780784808, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 396.0, 495.35262780784808, 104.0, 22.0 ],
					"text" : "expr $f1 * $f2 + 1.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 396.0, 299.0, 172.0, 22.0 ],
					"text" : "the.perlin 1 @sign 0 @active 1",
					"textcolor" : [ 0.95866322517395, 0.46076425909996, 0.670340538024902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 396.0, 538.0, 67.0, 22.0 ],
					"text" : "slide $1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 465.0, 636.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 115.023824896131373, 224.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 621.0, 805.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 621.0, 760.0, 96.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 621.0, 614.0, 96.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 546.0, 429.35262780784808, 56.0, 22.0 ],
					"sig" : 45.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 680.915787318770299, 130.0, 130.0 ]
				}
...
,
							...
							"boxes" : [ 								{
									"box" : 									{
										"maxclass" : "newobj",
										"text" : "out 2",
										"patching_rect" : [ 307.692317962646484, 313.730778634548187, 35.0, 22.0 ],
										"numinlets" : 1,
...
, 								{
									"box" : 									{
										"maxclass" : "newobj",
										"text" : "* dim(concat)",
										"patching_rect" : [ 307.692317962646484, 281.730778634548187, 79.0, 22.0 ],
										"numinlets" : 1,
										"numoutlets" : 1,
...
, 								{
									"box" : 									{
										"maxclass" : "newobj",
										"text" : "dcblock",
										"patching_rect" : [ 200.038462340831757, 283.5, 49.0, 22.0 ],
										"numinlets" : 1,
...
, 								{
									"box" : 									{
										"maxclass" : "newobj",
										"text" : "buffer concat",
										"patching_rect" : [ 305.0, 149.0, 78.0, 22.0 ],
										"numinlets" : 0,
										"bgcolor" : [ 0.258823529411765, 0.235294117647059, 0.223529411764706, 1.0 ],
										"numoutlets" : 2,
										"textcolor" : [ 1.0, 0.772549019607843, 0.454901960784314, 1.0 ],
...
, 								{
									"box" : 									{
										...
										"patching_rect" : [ 305.0, 14.0, 111.0, 22.0 ],
										"numinlets" : 0,
										"bgcolor" : [ 0.196078, 0.223529, 0.25098, 1.0 ],
										"numoutlets" : 1,
										"textcolor" : [ 0.862745, 0.870588, 0.878431, 1.0 ],
...
, 								{
									"box" : 									{
										"maxclass" : "newobj",
										"text" : "wave concat",
										"patching_rect" : [ 176.0, 149.0, 75.0, 22.0 ],
										"numinlets" : 4,
										"bgcolor" : [ 0.258823529411765, 0.235294117647059, 0.223529411764706, 1.0 ],
										"numoutlets" : 2,
										"textcolor" : [ 1.0, 0.772549019607843, 0.454901960784314, 1.0 ],
...
,
					...
					"patching_rect" : [ 546.0, 541.70525561569616, 55.0, 22.0 ],
					"text" : "mc.gen~",
					"textcolor" : [ 0.932326316833496, 0.86507248878479, 0.03703885897994, 1.0 ],
					"wrapper_uniquekey" : "u404004219"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 31.023824896131373, 582.5, 240.0, 22.0 ],
					"text" : "jit.gen @gen the.func.overlap @overlap 0.3",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 546.0, 495.35262780784808, 129.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 298.023824896131373, 224.0, 85.0, 22.0 ],
					"text" : "buffer~ concat",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 31.023824896131373, 406.5, 235.0, 22.0 ],
					"text" : "the.jit.bfg.normalize @basis noise.gradient",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 31.023824896131373, 439.0, 246.0, 134.70525561569616 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 31.023824896131373, 374.0, 352.0, 22.0 ],
					"text" : "jit.bfg 1 float32 128 8 1 @basis noise.gradient @scale 2 4",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.023824896131373, 331.0, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 89.023824896131373, 261.0, 45.0, 22.0 ],
					"text" : "f 0.007"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 60.023824896131373, 299.0, 77.0, 22.0 ],
					"text" : "accum 0.007",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 31.023824896131373, 224.0, 77.0, 22.0 ],
					"text" : "b 3",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 31.023824896131373, 154.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 31.023824896131373, 188.0, 63.0, 22.0 ],
					"text" : "qmetro 22",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 31.023824896131373, 879.70525561569616, 246.0, 16.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 31.023824896131373, 862.747361956311011, 246.0, 16.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 31.023824896131373, 845.789468296925861, 246.0, 16.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 31.023824896131373, 828.831574637540712, 246.0, 16.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 31.023824896131373, 811.873680978155562, 246.0, 16.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 31.023824896131373, 794.915787318770299, 246.0, 16.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 31.023824896131373, 777.957893659385149, 246.0, 16.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 31.023824896131373, 761.0, 246.0, 16.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 31.023824896131373, 728.0, 202.0, 22.0 ],
					"text" : "jit.unpack 8",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 31.023824896131373, 668.0, 246.0, 50.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 31.023824896131373, 619.5, 194.0, 22.0 ],
					"text" : "the.jit.hitopla 8 float32 2048 concat",
					"textcolor" : [ 0.258823529411765, 0.235294117647059, 0.223529411764706, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.523824896131373, 7.999991178512573, 533.0, 116.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 591.5, 599.35262780784808, 515.0, 599.35262780784808 ],
					"order" : 0,
					"source" : [ "obj-37", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 591.5, 599.35262780784808, 474.5, 599.35262780784808 ],
					"order" : 1,
					"source" : [ "obj-37", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 474.5, 668.0, 595.5, 668.0, 595.5, 603.0, 630.5, 603.0 ],
					"order" : 0,
					"source" : [ "obj-45", 0 ]
				}
...
, 			{
				...
				"bootpath" : "~/Documents/Max 8/Packages/the-abstractions/msp/perlin",
				"patcherrelativepath" : "../../msp/perlin",
				"type" : "GenX",
				"implicit" : 1
			}
, 			{
				"name" : "the.ef.gendsp",
				"bootpath" : "~/Documents/Max 8/Packages/the-abstractions/msp/gen",
				"patcherrelativepath" : "../../msp/gen",
				"type" : "gDSP",
				"implicit" : 1
			}
, 			{
				"name" : "the.func.overlap.genjit",
				"bootpath" : "~/Documents/Max 8/Packages/the-abstractions/msp/bfg~",
				"patcherrelativepath" : "../../msp/bfg~",
				"type" : "gJIT",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "the.jit.hitopla.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/the-abstractions/jitter/gen",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				...
				"bootpath" : "~/Documents/Max 8/Packages/the-abstractions/msp/ef",
				"patcherrelativepath" : "../../msp/ef",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
