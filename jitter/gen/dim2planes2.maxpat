...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1717.0, 399.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 1569.0, 101.0, 29.5, 22.0 ],
					"text" : "t i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1560.0, 253.0, 31.0, 22.0 ],
					"text" : "qlim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1569.0, 221.0, 42.0, 22.0 ],
					"text" : "gate 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1569.0, 189.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1569.0, 157.0, 29.5, 22.0 ],
					"text" : "<"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1347.0, 414.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1412.0, 480.0, 41.0, 22.0 ],
					"text" : "buddy"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1576.0, 522.0, 189.0, 22.0 ],
					"text" : "script disconnect cut $1 concat $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1551.0, 480.0, 44.0, 22.0 ],
					"text" : "uzi 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1551.0, 426.0, 44.0, 22.0 ],
					"text" : "bucket"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1264.0, 471.0, 108.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1264.0, 503.0, 85.0, 22.0 ],
					"text" : "buffer~ concat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1378.0, 382.0, 31.0, 22.0 ],
					"text" : "qlim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1437.0, 562.0, 174.0, 22.0 ],
					"text" : "script connect cut $1 concat $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "int" ],
					"patching_rect" : [ 1412.0, 520.0, 44.0, 22.0 ],
					"text" : "uzi 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1412.0, 195.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1460.0, 407.0, 54.5, 22.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1460.0, 375.0, 195.0, 22.0 ],
					"text" : "script replace $1 newex 0 0 400 12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1460.0, 343.0, 55.0, 22.0 ],
					"text" : "zl slice 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 3180.0, 352.0, 137.0, 64.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1460.0, 311.0, 240.0, 22.0 ],
					"text" : "cut jit.scissors @rows $1, concat jit.pack $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 1412.0, 227.0, 67.0, 22.0 ],
					"text" : "t i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1460.0, 649.0, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 900.0, 112.0, 29.5, 22.0 ],
					"text" : "$2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 523.0, 312.0, 191.0, 22.0 ],
					"text" : "jit.matrix 3 float32 32 12 @adapt 0",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 676.0, 54.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 847.0, 79.0, 35.0, 22.0 ],
					"text" : "set 3"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 900.0, 144.0, 219.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 727.0, 85.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 685.0, 117.0, 61.0, 22.0 ],
					"text" : "pak 256 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 685.0, 149.0, 61.0, 22.0 ],
					"text" : "dim $1 $2"
				}
...
,
						...
						"rect" : [ -1844.0, 145.0, 1385.0, 576.0 ],
						"bglocked" : 0,
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 1006.0, 464.0, 35.0, 22.0 ],
									"text" : "out 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 49.0, 45.0, 28.0, 22.0 ],
									"text" : "in 1"
								}
...
, 							{
								"box" : 								{
									"code" : "//Param coeff(0.34);\r\n\r\ncoeff = (dim.y == 3) ? 0.4 : 1/(dim.y-1);\r\nypos = cell.y * coeff;\r\n\r\nout1 = nearest(in1,vec(norm.x,ypos));\r\nout2 = coeff;\n",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 12.0,
									"id" : "obj-3",
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 49.0, 95.0, 1258.0, 344.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 49.0, 471.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 415.0, 458.0, 41.0, 22.0 ],
					"text" : "jit.gen",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_matrix", "jit_matrix", "" ],
					"patching_rect" : [ 1200.0, 630.0, 97.0, 22.0 ],
					"text" : "jit.buffer~ concat"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 639.0, 188.0, 246.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "list", "", "", "" ],
					"patching_rect" : [ 914.0, 687.0, 200.0, 200.0 ],
					"rows" : 5
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 670.023824896131373, 262.0, 201.0, 22.0 ]
				}
...
, 							{
								"box" : 								{
									"code" : "p1(vc,ypos,num_planes,coeff) { return (num_planes > 1) ? concat(sample(in1,vec(norm.x,ypos)).x,p2(ypos+coeff,num_planes,coeff)) : sample(in1,vec(norm.x,ypos)).x; }\np2(vc,ypos,num_planes,coeff) { return (num_planes > 2) ? concat(sample(in1,vec(norm.x,ypos)).x,p3(ypos+coeff,num_planes,coeff)) : sample(in1,vec(norm.x,ypos)).x; }\np3(vc,ypos,num_planes,coeff) { return (num_planes > 3) ? concat(sample(in1,vec(norm.x,ypos)).x,p4(ypos+coeff,num_planes,coeff)) : sample(in1,vec(norm.x,ypos)).x; }\np4(vc,ypos,num_planes,coeff) { return (num_planes > 4) ? concat(sample(in1,vec(norm.x,ypos)).x,p5(ypos+coeff,num_planes,coeff)) : sample(in1,vec(norm.x,ypos)).x; }\np5(vc,ypos,num_planes,coeff) { return (num_planes > 5) ? concat(sample(in1,vec(norm.x,ypos)).x,p6(ypos+coeff,num_planes,coeff)) : sample(in1,vec(norm.x,ypos)).x; }\np6(vc,ypos,num_planes,coeff) { return (num_planes > 6) ? -1 : sample(in1,vec(norm.x,ypos)); }\n\n\nplanes = dim.y; // row = planes\n\nif (cell.y == 0) { // populate first row\n\tvc = in1.x; // declare first plane of final vector\n\tx = cell.x; // h position\n\t\n\t//out1 = vc; // output vector with as many planes as row\n\tcoeff = 1/planes; // ypos = coeff \n\tout1 = p1(vc,coeff,planes,coeff);\n\t}\n",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 12.0,
									"id" : "obj-3",
...
,
					"patching_rect" : [ 592.0, 453.0, 41.0, 22.0 ],
					"text" : "jit.gen",
					"textcolor" : [ 0.626967370510101, 0.0, 0.016032937914133, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 703.523824896131373, 651.0, 52.0, 22.0 ],
					"text" : "plane -1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "list", "", "", "" ],
					"patching_rect" : [ 690.0, 691.0, 200.0, 200.0 ],
					"rows" : 5
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 523.0, 784.0, 138.0, 17.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 523.0, 761.0, 138.0, 17.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 523.0, 738.0, 138.0, 17.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 523.0, 706.0, 115.0, 22.0 ],
					"text" : "jit.unpack",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 54.523824896131373, 609.0, 138.0, 18.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 54.523824896131373, 567.0, 83.0, 22.0 ],
					"text" : "jit.pack 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 703.523824896131373, 609.0, 138.0, 18.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 703.523824896131373, 567.0, 400.0, 22.0 ],
					"text" : "jit.pack 3",
					"varname" : "concat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 703.523824896131373, 531.0, 138.0, 17.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 703.523824896131373, 508.0, 138.0, 17.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 703.523824896131373, 485.0, 138.0, 17.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 703.523824896131373, 453.0, 400.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "jit_matrix", "" ],
					"patching_rect" : [ 564.0, 101.0, 79.0, 22.0 ],
					"text" : "the.rgb.patch",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 523.0, 609.0, 137.0, 64.0 ],
					"sync" : 1
				}
...
, 							{
								"box" : 								{
									"code" : "planes = dim.y;\n\nif (cell.y == 0) {\n  p0 = in1.x;\n  p1 = (planes > 1) ? nearestpix(in1,vec(cell.x,1)).x : 0;\n  p2 = (planes > 2) ? nearestpix(in1,vec(cell.x,2)).x : 0;\n  p3 = (planes > 3) ? nearestpix(in1,vec(cell.x,3)).x : 0;\n  p4 = (planes > 4) ? nearestpix(in1,vec(cell.x,4)).x : 0;\n  p5 = (planes > 5) ? nearestpix(in1,vec(cell.x,5)).x : 0;\n  p6 = (planes > 6) ? nearestpix(in1,vec(cell.x,6)).x : 0;\n  p7 = (planes > 7) ? nearestpix(in1,vec(cell.x,7)).x : 0;\n  p8 = (planes > 8) ? nearestpix(in1,vec(cell.x,8)).x : 0;\n  p9 = (planes > 9) ? nearestpix(in1,vec(cell.x,9)).x : 0;\n  p10 = (planes > 10) ? nearestpix(in1,vec(cell.x,10)).x : 0;\n  p11 = (planes > 11) ? nearestpix(in1,vec(cell.x,11)).x : 0;\n  p12 = (planes > 12) ? nearestpix(in1,vec(cell.x,12)).x : 0;\n  \n  out1 = concat(p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12);\n}\n",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 12.0,
									"id" : "obj-3",
...
,
					"patching_rect" : [ 523.0, 453.0, 41.0, 22.0 ],
					"text" : "jit.gen",
					"textcolor" : [ 0.626967370510101, 0.0, 0.016032937914133, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 523.0, 174.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 523.0, 208.0, 63.0, 22.0 ],
					"text" : "qmetro 34",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 523.0, 356.0, 137.0, 64.0 ],
					"sync" : 1
				}
...
, 							{
								"box" : 								{
									"code" : "if \t\t(cell.y == 0) out1 = sin(norm.x*TWOPI) * 0.5 + 0.5;\r\nelse if (cell.y == 1) out1 = norm.x;\r\nelse if (cell.y == 2) out1 = cell.x % 2;\r\nelse if (cell.y == dim.y-1) out1 = 1-norm.x;\r\nelse out1 = norm.y * norm.x;",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 12.0,
									"id" : "obj-3",
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 69.0, 574.0, 355.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 450.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 523.0, 272.0, 41.0, 22.0 ],
					"text" : "jit.gen",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 523.0, 240.0, 136.0, 22.0 ],
					"text" : "jit.matrix 3 float32 32 12",
					"textcolor" : [ 0.649909, 0.112638, 0.040011, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 465.0, 1402.0, 138.0, 17.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 465.0, 1379.0, 138.0, 17.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 465.0, 1356.0, 138.0, 17.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "jit_matrix", "jit_matrix", "jit_matrix", "jit_matrix", "" ],
					"patching_rect" : [ 465.0, 1324.0, 115.0, 22.0 ],
					"text" : "jit.unpack",
					"textcolor" : [ 0.994953811168671, 0.768245160579681, 0.630638062953949, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 465.0, 1237.0, 137.0, 64.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 465.0, 1195.0, 218.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 465.0, 1121.0, 137.0, 64.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 465.0, 1046.0, 56.0, 22.0 ],
					"text" : "jit.pack 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1048.0, 554.0, 137.0, 64.0 ],
					"sync" : 1
				}
...
, 							{
								"box" : 								{
									"code" : "accum(val,max){\r\n\tif (val < max) return accum(val+0.25,max);\r\n\telse return val;\r\n\t}\r\n\t\r\nParam max(0.8);\r\n\r\nout1 = accum(in1,max);",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 12.0,
									"id" : "obj-3",
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 49.0, 95.0, 486.0, 303.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 49.0, 430.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 1048.0, 453.0, 41.0, 22.0 ],
					"text" : "jit.gen",
					"textcolor" : [ 0.626967370510101, 0.0, 0.016032937914133, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1048.0, 206.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1048.0, 240.0, 63.0, 22.0 ],
					"text" : "qmetro 34",
					"textcolor" : [ 0.9862, 0.056231, 0.376418, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1048.0, 345.0, 137.0, 64.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1048.0, 304.0, 191.0, 22.0 ],
					"text" : "jit.expr @expr (1-norm[1])*norm[0]",
					"textcolor" : [ 0.875393390655518, 0.724709153175354, 0.033259350806475, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1048.0, 272.0, 123.0, 22.0 ],
					"text" : "jit.matrix 3 float32 8 3",
					"textcolor" : [ 0.649909, 0.112638, 0.040011, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 249.0, 609.0, 137.0, 64.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 249.0, 784.0, 138.0, 17.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 249.0, 761.0, 138.0, 17.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 249.0, 738.0, 138.0, 17.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "jit_matrix", "jit_matrix", "jit_matrix", "jit_matrix", "" ],
					"patching_rect" : [ 249.0, 706.0, 115.0, 22.0 ],
					"text" : "jit.unpack",
					"textcolor" : [ 0.994953811168671, 0.768245160579681, 0.630638062953949, 1.0 ]
				}
...
, 							{
								"box" : 								{
									"code" : "planes = dim.y; // rows = planes\r\n\r\nif (cell.y == 0) { // populate first row\r\n\tvc = in1.x; // declare first plane of final vector\r\n\tx = cell.x; // h position\r\n\tfor (p = 1; p < planes; p += 1){ // iterate through rows\r\n\t\tsc = nearestpix(in1,vec(x,p)).x; // sample pixel in row\r\n\t\t\t\r\n\t\t\tvc = concat(vc,sc); // concatenate previous pixel vector and new pixel\r\n\t\t\t/*\r\n\t\t\tparent value 'vc' is not updated upon\r\n\t\t\tevery new concatenation in for-loop but always takes\r\n\t\t\tfirst declaration (in1.x)\r\n\t\t\t*/ \r\n\t\t\r\n\t\t}\r\n\tout1 = vc; // output vector with as many planes as rows\r\n\t}\r\n",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 12.0,
									"id" : "obj-3",
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 49.0, 95.0, 673.0, 318.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 49.0, 443.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 249.0, 453.0, 41.0, 22.0 ],
					"text" : "jit.gen",
					"textcolor" : [ 0.626967370510101, 0.0, 0.016032937914133, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 54.523824896131373, 531.0, 138.0, 17.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 54.523824896131373, 508.0, 138.0, 17.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 54.523824896131373, 485.0, 138.0, 17.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "jit_matrix", "jit_matrix", "jit_matrix", "" ],
					"patching_rect" : [ 54.523824896131373, 453.0, 115.0, 22.0 ],
					"text" : "jit.scissors @rows 3",
					"textcolor" : [ 0.995829463005066, 0.801701784133911, 0.03745524585247, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 249.0, 206.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 249.0, 240.0, 63.0, 22.0 ],
					"text" : "qmetro 34",
					"textcolor" : [ 0.9862, 0.056231, 0.376418, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 249.0, 345.0, 137.0, 64.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 249.0, 304.0, 191.0, 22.0 ],
					"text" : "jit.expr @expr (1-norm[1])*norm[0]",
					"textcolor" : [ 0.875393390655518, 0.724709153175354, 0.033259350806475, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 249.0, 272.0, 123.0, 22.0 ],
					"text" : "jit.matrix 3 float32 8 3",
					"textcolor" : [ 0.649909, 0.112638, 0.040011, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 258.5, 430.5, 64.023824896131373, 430.5 ],
					"order" : 1,
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 532.5, 430.5, 713.023824896131373, 430.5 ],
					"source" : [ "obj-36", 0 ]
				}
