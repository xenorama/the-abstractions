...
,
		"classnamespace" : "box",
		"rect" : [ 1227.0, 173.0, 1135.0, 732.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 410.0, 162.0, 79.0, 22.0 ],
					"text" : "the.rgb.patch",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 498.766356885433197, 479.0, 172.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 814.0, 116.0, 20.0, 140.0 ],
					"size" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 576.766356885433197, 313.364485800266266, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 594.0, 107.0, 50.0, 22.0 ],
					"text" : "*~ 100",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 594.0, 215.5, 133.0, 22.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 646.0, 73.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 646.0, 107.0, 56.0, 22.0 ],
					"text" : "qmetro 2",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 594.0, 175.0, 56.0, 22.0 ],
					"text" : "jit.catch~",
					"textcolor" : [ 0.88665235042572, 0.538778126239777, 0.999266922473907, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 594.0, 73.0, 35.0, 22.0 ],
					"text" : "adc~",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 775.0, 414.364485800266266, 133.0, 22.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 498.766356885433197, 514.364485800266266, 220.457943201065063, 78.401869535446167 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 498.766356885433197, 449.364485800266266, 133.0, 22.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 498.766356885433197, 414.364485800266266, 115.0, 22.0 ],
					"text" : "jit.gen @gen the.log",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 724.0, 514.364485800266266, 220.457943201065063, 78.401869535446167 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 724.0, 481.364485800266266, 172.0, 22.0 ],
					"text" : "jit.graph @mode 3 @rangelo 0",
					"textcolor" : [ 0.593257784843445, 0.715749382972717, 0.598733067512512, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 724.0, 449.364485800266266, 133.0, 22.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 963.0, 267.25, 87.0, 22.0 ],
					"text" : "scale -70 0 0 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 963.0, 220.5, 57.0, 22.0 ],
					"text" : "clip -70 0",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 963.0, 81.0, 28.0, 22.0 ],
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.150574013590813, 0.146529719233513, 0.224678486585617, 1.0 ],
					"color" : [ 0.685467779636383, 0.590841293334961, 0.940064787864685, 1.0 ],
					"id" : "obj-29",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 963.0, 175.0, 113.0, 22.0 ],
					"text" : "expr 20 * log10(in1)",
					"textcolor" : [ 0.618129551410675, 0.887157440185547, 0.622910499572754, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 963.0, 444.0, 35.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 176.0, 241.25, 87.0, 22.0 ],
									"text" : "scale -70 0 0 1",
									"textcolor" : [ 0.054902, 0.341176, 0.498039, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 176.0, 194.5, 57.0, 22.0 ],
									"text" : "clip -70 0",
									"textcolor" : [ 0.207843, 0.243137, 0.392157, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 176.0, 55.0, 28.0, 22.0 ],
									"text" : "in 1",
									"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 176.0, 149.0, 113.0, 22.0 ],
									"text" : "expr 20 * log10(in1)",
...
,
					"patching_rect" : [ 724.0, 414.364485800266266, 41.0, 22.0 ],
					"text" : "jit.gen",
					"textcolor" : [ 0.626967370510101, 0.0, 0.016032937914133, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 724.0, 242.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 724.0, 327.0, 127.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 724.0, 295.0, 133.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 442.523824896131373, 393.0, 20.0, 140.0 ],
					"size" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 470.0, 393.0, 20.0, 140.0 ],
					"size" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 111.0, 108.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 156.0, 444.0, 63.0, 22.0 ],
					"text" : "peek~ win",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 432.0, 229.0, 148.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 232.0, 193.0, 45.0, 22.0 ],
					"text" : "/ 1024.",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 111.0, 142.0, 64.0, 22.0 ],
					"text" : "uzi 1024 0",
					"textcolor" : [ 0.937255, 0.764706, 0.301961, 1.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 176.0, 149.0, 115.0, 22.0 ],
									"text" : "expr pow(10\\,in1/20)",
									"textcolor" : [ 0.862745, 0.870588, 0.878431, 1.0 ]
								}
...
,
					"patching_rect" : [ 432.0, 310.0, 89.0, 22.0 ],
					"text" : "gen @active 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 232.0, 229.0, 111.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 232.0, 382.0, 100.0, 22.0 ]
				}
...
,
					"patching_rect" : [ 232.0, 283.0, 32.0, 22.0 ],
					"text" : "gen",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
