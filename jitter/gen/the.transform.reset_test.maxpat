...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1007.0, 324.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1007.0, 358.0, 119.0, 22.0 ],
					"text" : "zl lookup none linear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1007.0, 390.0, 111.0, 22.0 ],
					"text" : "sendoutput filter $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 598.0, 59.0, 200.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1089.0, 93.0, 83.0, 22.0 ],
					"text" : "loadmess 100",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 465.0, 269.0, 67.0, 22.0 ],
					"text" : "getattr size",
					"textcolor" : [ 0.65098, 0.666667, 0.662745, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 634.0, 93.0, 248.0, 24.0 ],
					"tabs" : [ "erase", "mirror", "wrap", "clamp" ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 634.0, 134.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.0, 675.5, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1089.0, 246.5, 59.0, 22.0 ],
					"text" : "route dim",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1089.0, 125.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1089.0, 157.0, 68.0, 22.0 ],
					"text" : "dim 100 $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 465.0, 311.0, 221.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"hint" : "displays autocolors highlighting the dimensions to be rendered, in comparison to a square. The movie will be scaled to this box in its aspect ratio.",
					"id" : "obj-37",
					"maxclass" : "jit.pwindow",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 885.5, 545.0, 150.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 798.5, 448.5, 150.0, 21.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 885.5, 485.5, 214.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 885.5, 450.5, 127.0, 22.0 ],
					"text" : "the.pwin.dimscale 150",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 732.5, 706.5, 150.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 547.5, 445.5, 150.0, 21.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 144.0, 575.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.0, 609.0, 57.0, 22.0 ],
					"text" : "active $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 598.0, 168.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 143.0, 710.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 144.0, 641.0, 115.0, 22.0 ],
					"text" : "the.perlin 1 @sign 0",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 465.0, 389.5, 214.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.0, 358.5, 127.0, 22.0 ],
					"text" : "the.pwin.dimscale 150",
					"textcolor" : [ 0.258823529411765, 0.235294117647059, 0.223529411764706, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 733.0, 545.0, 150.0, 112.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 754.5, 477.5, 150.0, 112.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 733.0, 369.5, 198.0, 49.0 ],
					"text" : "jit.gl.pix @gen the.transform.reset @renderer 640 480 @mode 0 @repeat 0 @offset 0.5",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 733.0, 289.0, 207.0, 22.0 ],
					"text" : "jit.gl.texture @dim 100 100 @adapt 0",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 733.0, 211.5, 149.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 733.0, 246.5, 340.0, 22.0 ],
					"text" : "jit.expr @expr 1 (hypot(snorm[0]\\,snorm[1])<1) norm[1] norm[0]",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 260.0, 365.0, 100.0, 22.0 ],
					"text" : "jit.world bogus",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 260.0, 269.0, 61.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 301.0, 403.0, 80.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.523824896131373, 7.999991178512573, 564.0, 116.0 ]
				}
...
, 			{
				"name" : "the.pwin.dimscale.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/the-abstractions/jitter/ui/pwindow",
				"patcherrelativepath" : "../ui/pwindow",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "the.transform.reset.genjit",
