...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 456.310673356056213, 528.155332565307617, 245.0, 22.0 ],
					"text" : "sendnode blend_enable 1, sendnode layer 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 268.5, 210.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 766.019406974315643, 443.0, 115.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 766.019406974315643, 359.223296046257019, 119.0, 49.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 592.0, 278.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 86.805827438831329, 578.679611504077911, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 174.75727915763855, 455.320381641387939, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 174.75727915763855, 489.320381641387939, 102.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 350.485432088375092, 571.805817842483521, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 430.0, 654.368931293487549, 111.0, 22.0 ],
					"text" : "jit.gl.layer @layer 3"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 191.475723803043365, 328.203883588314056, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 430.0, 443.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 247.0, 627.184465646743774, 59.0, 22.0 ],
					"text" : "jit.gl.layer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 734.834949553012848, 297.922333717346191, 69.0, 22.0 ],
					"text" : "jit.gl.handle"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 383.495140373706818, 612.621350824832916, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 275.631070077419281, 638.834950923919678, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 317.475723803043365, 440.75727504491806, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 317.475723803043365, 474.75727504491806, 102.0, 22.0 ],
					"text" : "output_texture $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 268.5, 244.0, 59.0, 22.0 ],
					"text" : "visible $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 517.0, 143.0, 70.0, 22.0 ],
					"text" : "jit.gl.shader"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 232.0, 244.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 247.0, 568.0, 95.0, 22.0 ],
					"text" : "the.jit.gl.warping"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "dictionary" ],
					"patching_rect" : [ 430.0, 568.0, 388.0, 22.0 ],
					"text" : "the.jit.gl.warping @file kst.bottom.json @name torus @output_texture 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 430.0, 475.0, 332.0, 22.0 ],
					"text" : "jit.gl.node @name unwarp @capture 1 @erase_color 0 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 596.0, 500.0, 92.5, 22.0 ],
					"text" : "jit.gl.pbr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 596.0, 594.0, 302.0, 35.0 ],
					"text" : "jit.gl.gridshape @scale 0.3 @position -0.7 0 0 @shape torus"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 247.0, 367.0, 319.0, 22.0 ],
					"text" : "jit.gl.node @name warp @capture 1 @erase_color 0 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 592.0, 367.0, 92.5, 22.0 ],
					"text" : "jit.gl.pbr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 592.0, 422.165049076080322, 149.0, 22.0 ],
					"text" : "jit.gl.gridshape @scale 0.3"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 232.0, 278.0, 133.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 517.0, 113.0, 50.0, 22.0 ],
					"text" : "link $1"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "the.jit.gl.warping.maxpat",
				"bootpath" : "~/Projekte/Xenorama/XEN_Cloud/XENcloud/03_TOOLS/XEN_MAX-MSP/KST_kunsthaus-sans-titre/patchers",
				"patcherrelativepath" : "../../../../../../Projekte/Xenorama/XEN_Cloud/XENcloud/03_TOOLS/XEN_MAX-MSP/KST_kunsthaus-sans-titre/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "the.warp.dim.inherit.js",
				"bootpath" : "~/Documents/Max 8/Packages/the-abstractions/jitter/warping",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
