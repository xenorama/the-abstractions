...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 642.0, 254.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 642.0, 286.0, 133.0, 22.0 ],
					"text" : "camera_position 0 2 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 444.0, 440.0, 79.0, 22.0 ],
					"text" : "getupper_left"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 417.0, 527.0, 268.0, 22.0 ],
					"text" : "cornerpin upper_left 0.44 0."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 249.0, 493.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 420.0, 487.0, 445.0, 22.0 ],
					"text" : "the.jit.gl.camerapos i2p @sendcamera position 0 2 4 @sendcamera lookat 0.1 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 299.0, 174.0, 245.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 420.0, 233.0, 33.0, 42.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 420.0, 286.0, 49.0, 22.0 ],
					"text" : "read $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 266.0, 209.0, 245.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 420.0, 394.0, 320.0, 22.0 ],
					"text" : "jit.gl.texture @name calligraphy @dim 1450 750 @adapt 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 166.0, 339.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 166.0, 371.0, 69.0, 22.0 ],
					"text" : "jit.world i2p"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "the.jit.gl.camerapos.maxpat",
