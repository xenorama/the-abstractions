...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"comment" : "jit.gl.text.multiple: (jit_matrix) char-matrix containing text data (textmode 'charcode') or line references (textmode 'coll' with @source set to coll-name)",
					"id" : "obj-16",
					"index" : 2,
					"maxclass" : "inlet",
					"numinlets" : 0,
					...
					"patching_rect" : [ 292.5, 458.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "done" ],
					"patching_rect" : [ 247.0, 297.0, 42.0, 22.0 ],
					"text" : "t done"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 247.0, 244.0, 83.0, 22.0 ],
					"text" : "route bang",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 368.0, 596.0, 54.0, 22.0 ],
					"text" : "deferlow",
...
, 			{
				"box" : 				{
					"comment" : "jit.gl.text.multiple: (jit_matrix) reserved for matrixoutput",
					"id" : "obj-13",
					"index" : 1,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 217.0, 640.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "jit.gl.text.multiple: dumpout; 'bang' send once initiated",
					"id" : "obj-8",
					"index" : 2,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 368.0, 640.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 333.0, 458.0, 36.0, 22.0 ],
					"text" : "defer",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 368.0, 500.0, 50.0, 22.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "jit.gl.text.multiple: (int) maximum number of hosted jit.gl.text objects",
					"id" : "obj-12",
					"index" : 3,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 368.0, 174.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 126.0, 384.0, 52.0, 22.0 ],
					"text" : "route int",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 72.0, 384.0, 52.0, 22.0 ],
					"text" : "route int",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 72.0, 337.0, 127.0, 22.0 ],
					"text" : "unjoin 2 @outsize 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 458.0, 61.0, 22.0 ],
					"text" : "drawto $1"
				}
...
, 			{
				"box" : 				{
					"comment" : "jit.gl.text.multiple: (jit_matrix, anything) attributes and control jit_matrices for chosen glparams",
					"id" : "obj-4",
					"index" : 1,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 247.0, 174.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 72.0, 297.0, 164.0, 22.0 ],
					"text" : "patcherargs @textsource coll",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 217.0, 546.0, 170.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "the.gl.text.obj.js",
						"parameter_enable" : 0
					}
,
					"text" : "js the.gl.text.obj.js",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.523824896131373, 7.999991178512573, 521.0, 147.214953184127808 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 81.5, 435.5, 342.5, 435.5 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 135.5, 436.5, 342.5, 436.5 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 256.5, 404.0, 226.5, 404.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 320.5, 403.5, 226.5, 403.5 ],
					"source" : [ "obj-3", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 342.5, 489.5, 377.5, 489.5 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 114.5, 502.0, 226.5, 502.0 ],
					"source" : [ "obj-6", 0 ]
				}
