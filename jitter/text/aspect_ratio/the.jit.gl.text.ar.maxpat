...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"orientation" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 230.0, 353.427183747291565, 104.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 295.0, 311.427183747291565, 101.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 660.0, 587.0, 113.0, 22.0 ],
					"text" : "print the.jit.gl.text.ar",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 660.0, 486.0, 46.0, 22.0 ],
					"text" : "route ?",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"orientation" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 353.427183747291565, 51.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 165.0, 270.427183747291565, 149.0, 22.0 ],
					"text" : "route notify preserve_size",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"comment" : "the.jit.gl.text.ar: (anything) patcher attributes and methods",
					"id" : "obj-5",
					"index" : 1,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 192.427183747291565, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.jit.gl.text.ar: dumpout / status",
					"id" : "obj-4",
					"index" : 3,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 687.0, 539.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.jit.gl.text.ar: (list) connect to jit.gl.node when rendering to jit.gl.cornerpin or jit.gl.videoplane (@capture 1)",
					"id" : "obj-3",
					"index" : 2,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 518.5, 538.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.jit.gl.text.ar: (list) connect to jit.gl.node when rendering directly to parent (@capture 0)",
					"id" : "obj-2",
					"index" : 1,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 377.0, 538.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 212.0, 192.427183747291565, 187.0, 22.0 ],
					"text" : "patcherargs @active 1 @inherit 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 377.0, 440.427183747291565, 325.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "the.gl.text.ar.js",
						"parameter_enable" : 0
					}
,
					"text" : "js the.gl.text.ar.js #1 #2 #3 #4 #5 ",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.523824896131373, 180.427183747291565, 142.0, 322.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.523824896131373, 7.999991178512573, 609.077670395374298, 163.504854142665863 ]
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 389.5, 241.927183747291565, 174.5, 241.927183747291565 ],
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 669.5, 547.0, 669.5, 547.0 ],
					"source" : [ "obj-14", 0 ]
				}
