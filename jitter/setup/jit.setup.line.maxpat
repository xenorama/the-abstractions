...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 308.0, 148.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 234.0, 288.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 234.0, 320.0, 75.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 403.0, 224.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 403.0, 256.0, 305.0, 22.0 ],
					"presentation_linecount" : 3,
					"text" : "gen @expr out1=phasor(maximum(in1\\,0.25)) @active 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 458.0, 320.0, 75.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 378.0, 288.0, 44.0, 22.0 ],
					"text" : "f"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 538.0, 320.0, 75.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 378.0, 320.0, 75.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 354.0, 445.0, 201.0, 22.0 ],
...
, 							{
								"box" : 								{
									"code" : "Param bypass(0);\r\nParam size(0.1);\r\nParam pos(0.);\r\nParam axis(0);\r\n\r\nif (bypass) out1 = in1;\r\nelse {\r\n\tout1 = (axis)\r\n \t\t? absdiff(norm.y,pos) < size\r\n\t\t: absdiff(norm.x,pos) < size;;\r\n\t}\r\n",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 12.0,
									"id" : "obj-3",
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 38.0, 67.0, 363.0, 222.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 38.0, 316.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 354.0, 409.0, 159.0, 22.0 ],
					"text" : "jit.gl.pix @axis 0 @size 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 308.0, 182.0, 111.0, 22.0 ],
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 363.5, 226.0, 387.5, 226.0 ],
					"order" : 0,
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 467.5, 382.5, 363.5, 382.5 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 243.5, 386.0, 363.5, 386.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 387.5, 382.5, 363.5, 382.5 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 547.5, 382.5, 363.5, 382.5 ],
					"source" : [ "obj-6", 0 ]
				}
